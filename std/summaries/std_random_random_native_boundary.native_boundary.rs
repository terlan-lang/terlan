...
pub const SOURCE_MODULE: &str = "std.random.Random";
pub const NATIVE_MODULE: &str = "std_random_random_native_boundary";
...
pub const OPERATIONS: &[(&str, &str, usize)] = &[
    ("seed", "std.random.random.seed", 1),
    ("entropy", "std.random.random.entropy", 0),
    ("int", "std.random.random.int", 1),
    ("bounded_int", "std.random.random.bounded_int", 3),
    ("float", "std.random.random.float", 1),
    ("bool", "std.random.random.bool", 1),
    ("choice", "std.random.random.choice", 2),
    ("shuffle", "std.random.random.shuffle", 2),
    ("sample", "std.random.random.sample", 3),
];
        ...
        match command {
            ...
            NativeBoundaryCommand::Call { request_id, operation, args, reply } => {
                let result = match validate_args(&resources, &args) {
                    Ok(()) => match operation {
                        "std.random.random.seed" => native_unimplemented_operation(operation),
                        "std.random.random.entropy" => native_unimplemented_operation(operation),
                        "std.random.random.int" => native_unimplemented_operation(operation),
                        "std.random.random.bounded_int" => native_unimplemented_operation(operation),
                        "std.random.random.float" => native_unimplemented_operation(operation),
                        "std.random.random.bool" => native_unimplemented_operation(operation),
                        "std.random.random.choice" => native_unimplemented_operation(operation),
                        "std.random.random.shuffle" => native_unimplemented_operation(operation),
                        "std.random.random.sample" => native_unimplemented_operation(operation),
