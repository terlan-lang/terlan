...
pub const SOURCE_MODULE: &str = "std.native.collections.Vector";
pub const NATIVE_MODULE: &str = "std_native_collections_vector_native_boundary";
...
pub const OPERATIONS: &[(&str, &str, usize)] = &[
    ...
    ("get_optional_values", "std.native.collections.vector.get", 2),
    ("set_at", "std.native.collections.vector.set_at", 3),
    ("swap", "std.native.collections.vector.swap", 3),
    ("push", "std.native.collections.vector.push", 2),
    ("to_list", "std.native.collections.vector.to_list", 1),
];
            ...
            NativeBoundaryCommand::Call { request_id, operation, args, reply } => {
                let result = match validate_args(&resources, &args) {
                    Ok(()) => match operation {
                        ...
                        "std.native.collections.vector.get" => native_unimplemented_operation(operation),
                        "std.native.collections.vector.set_at" => native_unimplemented_operation(operation),
                        "std.native.collections.vector.swap" => native_unimplemented_operation(operation),
                        "std.native.collections.vector.push" => native_unimplemented_operation(operation),
                        "std.native.collections.vector.to_list" => native_unimplemented_operation(operation),
