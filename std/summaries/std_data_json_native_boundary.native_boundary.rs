...
pub const NATIVE_MODULE: &str = "std_data_json_native_boundary";
...
pub const FUNCTIONS: &[(&str, usize)] = &[
    ...
    ("required_field_rows_page", 6),
    ("string_field_rows", 2),
    ("nested_string_field_rows", 4),
    ("nested_string_field_rows_page", 6),
    ("string_object_rows", 2),
    ("length", 1),
    ("at", 2),
    ("as_string", 1),
    ("as_int", 1),
...
pub const OPERATIONS: &[(&str, &str, usize)] = &[
    ...
    ("extend", "std.data.json.array_extend", 2),
    ("set", "std.data.json.array_set", 3),
    ("put", "std.data.json.object_put", 3),
    ("remove", "std.data.json.object_remove", 2),
    ("parse", "std.data.json.parse", 1),
    ("stringify", "std.data.json.stringify", 1),
    ("stringify_pretty", "std.data.json.stringify_pretty", 1),
    ("get", "std.data.json.get", 2),
    ("keys", "std.data.json.keys", 1),
    ("object_length", "std.data.json.object_length", 1),
    ("string_fields", "std.data.json.string_fields", 2),
    ("required_fields", "std.data.json.required_fields", 4),
    ("required_field_rows", "std.data.json.required_field_rows", 4),
    ("required_field_rows_page", "std.data.json.required_field_rows_page", 6),
    ("string_field_rows", "std.data.json.string_field_rows", 2),
    ("nested_string_field_rows", "std.data.json.nested_string_field_rows", 4),
    ("nested_string_field_rows_page", "std.data.json.nested_string_field_rows_page", 6),
    ("string_object_rows", "std.data.json.string_object_rows", 2),
            ...
            NativeBoundaryCommand::Call { request_id, operation, args, reply } => {
                let result = match validate_args(&resources, &args) {
                    Ok(()) => match operation {
                        ...
                        "std.data.json.array_extend" => native_unimplemented_operation(operation),
                        "std.data.json.array_set" => native_unimplemented_operation(operation),
                        "std.data.json.object_put" => native_unimplemented_operation(operation),
                        "std.data.json.object_remove" => native_unimplemented_operation(operation),
                        ...
                        "std.data.json.stringify_pretty" => native_unimplemented_operation(operation),
                        "std.data.json.get" => native_unimplemented_operation(operation),
                        "std.data.json.keys" => native_unimplemented_operation(operation),
                        "std.data.json.object_length" => native_unimplemented_operation(operation),
                        "std.data.json.string_fields" => native_unimplemented_operation(operation),
                        "std.data.json.required_fields" => native_unimplemented_operation(operation),
                        "std.data.json.required_field_rows" => native_unimplemented_operation(operation),
                        "std.data.json.required_field_rows_page" => native_unimplemented_operation(operation),
                        "std.data.json.string_field_rows" => native_unimplemented_operation(operation),
                        "std.data.json.nested_string_field_rows" => native_unimplemented_operation(operation),
                        "std.data.json.nested_string_field_rows_page" => native_unimplemented_operation(operation),
                        "std.data.json.string_object_rows" => native_unimplemented_operation(operation),
