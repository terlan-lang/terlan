...
cli-help:
	...
	@echo "  make terlc-debugger-check - run reserved debugger command-surface regressions"
...
cli-test-fast:
	...
	$(TERLC_EXACT_TEST) commands::build::build_test::tests::artifact_test::build_command_emits_terlan_vm_artifact_without_erlang_or_beam -- --exact
...
formatter-pipe-canonicalization-check:
	$(TERLC_EXACT_TEST) --bin terlc compiler::syntax::formatter::formatter_test::formatter_preserves_nested_module_calls_without_pipe_promotion -- --exact
	$(TERLC_EXACT_TEST) --bin terlc compiler::syntax::formatter::formatter_test::formatter_preserves_nested_receiver_calls_without_pipe_promotion -- --exact
	$(TERLC_EXACT_TEST) --bin terlc compiler::syntax::formatter::formatter_test::formatter_preserves_nested_selected_import_calls_without_pipe_promotion -- --exact
	$(TERLC_EXACT_TEST) --bin terlc compiler::syntax::formatter::formatter_test::formatter_wraps_explicit_pipe_chains_to_one_stage_per_line -- --exact
	$(TERLC_EXACT_TEST) --bin terlc compiler::syntax::formatter::formatter_test::formatter_does_not_promote_named_argument_calls_to_pipe_chain -- --exact
	$(TERLC_EXACT_TEST) --bin terlc compiler::syntax::formatter::formatter_test::formatter_does_not_promote_function_value_calls_to_pipe_chain -- --exact
	$(TERLC_EXACT_TEST) --bin terlc compiler::syntax::formatter::formatter_test::formatter_does_not_promote_nested_call_arguments_to_pipe_chain -- --exact
	$(TERLC_EXACT_TEST) --bin terlc compiler::syntax::formatter::formatter_test::formatter_splits_short_function_body_semicolon_sequences -- --exact
	$(TERLC_EXACT_TEST) --bin terlc compiler::typeck::expression_test::syntax_output_infers_pipe_forward_into_imported_module_member_call -- --exact

terlc-debugger-check:
	$(RUST_TEST) --locked -p terlan --bin terlan-quality function_head_observability_test
	$(CARGO) run -p terlan --bin terlan-quality --quiet -- function-head-observability
	$(TERLC_EXACT_TEST) --bin terlc \
		commands::test::test_command_test::run_test_reports_function_head_clause_pattern_miss_diagnostics -- --exact
	$(TERLC_EXACT_TEST) --bin terlc \
		tests::debug_cli_test::run_cli_routes_debug_command_to_reserved_surface -- --exact
	$(TERLC_EXACT_TEST) --bin terlc \
		tests::debug_cli_test::run_cli_routes_debug_command_after_json_diagnostic_flag -- --exact
	$(TERLC_EXACT_TEST) --bin terlc \
		tests::debug_cli_test::run_cli_routes_repl_debug_to_reserved_surface -- --exact
	$(TERLC_EXACT_TEST) --bin terlc \
	...
	$(TERLC_EXACT_TEST) --bin terlc \
		tests::debug_cli_test::run_cli_routes_debug_breakpoint_management_script_to_reserved_surface -- --exact
	$(TERLC_EXACT_TEST) --bin terlc \
	...
	$(TERLC_EXACT_TEST) --bin terlc \
		tests::debug_cli_test::debug_usage_documents_reserved_script_commands -- --exact
	$(TERLC_EXACT_TEST) --bin terlc \
	...
	$(TERLC_EXACT_TEST) --bin terlc \
		commands::debug::debug_test::debug_script_accepts_reserved_commands_and_breakpoints -- --exact
	$(TERLC_EXACT_TEST) --bin terlc \
	...
	$(TERLC_EXACT_TEST) --bin terlc \
		commands::debug::debug_test::debug_reserved_text_report_is_stable -- --exact
	$(TERLC_EXACT_TEST) --bin terlc \
		commands::debug::debug_test::debug_reserved_json_report_is_stable -- --exact
	$(TERLC_EXACT_TEST) --bin terlc \
		commands::debug::debug_test::debug_reserved_text_report_includes_script_command_count -- --exact
	$(TERLC_EXACT_TEST) --bin terlc \
		commands::debug::debug_test::debug_error_renderers_are_stable -- --exact

terlan-lint-style-check:
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::lint_reports_semicolon_chain_with_stable_diagnostic -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::lint_fix_splits_simple_semicolon_chain -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::lint_fix_preserves_comment_semicolon_lines -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::lint_fix_splits_semicolon_chains_with_string_arguments -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::lint_reports_directory_sources_in_sorted_order -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::lint_command_fix_rewrites_safe_chain -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::lint_command_reports_unfixed_chain -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::lint_command_rejects_unknown_flag -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::readability_test::lint_reports_deep_expression_tree -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::readability_test::lint_accepts_staged_expression_tree -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::readability_test::lint_reports_short_callback_name_for_multi_expression_body -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::readability_test::lint_accepts_meaningful_callback_name_for_multi_expression_body -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::readability_test::lint_accepts_short_callback_name_for_single_expression_body -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::readability_test::lint_reports_unused_destructured_let_binding -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::readability_test::lint_accepts_underscore_prefixed_destructured_let_binding -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::readability_test::lint_accepts_used_destructured_let_bindings -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::readability_test::lint_reports_unused_destructured_case_binding -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::readability_test::lint_reports_redundant_comment_restatement -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::readability_test::lint_accepts_explanatory_line_comment -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::readability_test::lint_accepts_doc_comment_before_declaration -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::readability_test::branch_test::lint_reports_boolean_heavy_branch_condition -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::readability_test::branch_test::lint_accepts_simple_boolean_branch_condition -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::readability_test::branch_test::lint_accepts_named_predicate_branch_condition -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::readability_test::branch_test::lint_accepts_boolean_heavy_branch_text_inside_comments -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::readability_test::lint_reports_public_declaration_without_docs -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::readability_test::lint_accepts_documented_public_declaration -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::readability_test::lint_accepts_undocumented_public_test_declaration -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::readability_test::lint_reports_doc_comment_missing_star_space -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::readability_test::lint_accepts_canonical_doc_comment_spacing -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::readability_test::lint_ignores_non_doc_block_comment_spacing -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::complexity_test::lint_reports_function_clause_size_threshold -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::complexity_test::lint_accepts_function_clause_size_threshold -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::complexity_test::lint_reports_match_arm_size_threshold -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::complexity_test::lint_accepts_match_arm_size_threshold -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::complexity_test::lint_reports_ordinary_source_file_size_threshold -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::complexity_test::lint_accepts_ordinary_source_file_at_size_threshold -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::complexity_test::lint_accepts_generated_source_file_size_with_manifest_policy -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::maintainability_test::lint_reports_unstructured_debug_call_in_production_source -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::maintainability_test::lint_accepts_debug_words_in_strings_and_comments -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::maintainability_test::lint_accepts_structured_logger_debug_call -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::maintainability_test::lint_accepts_debug_call_in_test_source -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::actor_vm_test::lint_reports_manual_message_tag_equality_in_actor_handler -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::actor_vm_test::lint_accepts_pattern_matched_actor_message_handler -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::actor_vm_test::lint_accepts_tag_equality_outside_actor_handler -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::actor_vm_test::lint_accepts_message_tag_equality_in_test_source -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::actor_vm_test::lint_reports_actor_lifecycle_state_parameter_without_state_name -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::actor_vm_test::lint_accepts_actor_lifecycle_state_parameter_with_state_name -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::actor_vm_test::lint_accepts_state_typed_parameter_outside_actor_lifecycle -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::actor_vm_test::lint_accepts_actor_lifecycle_state_parameter_in_test_source -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::consistency_test::lint_reports_import_before_module_declaration -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::consistency_test::lint_accepts_docs_before_module_declaration -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::consistency_test::lint_accepts_line_comments_before_module_declaration -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::consistency_test::lint_reports_import_after_function_declaration -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::consistency_test::lint_accepts_imports_before_declarations -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::consistency_test::lint_accepts_docs_between_imports_and_declarations -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::consistency_test::lint_reports_duplicate_module_declaration -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::consistency_test::lint_accepts_module_mentions_inside_comments -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::consistency_test::lint_reports_type_declaration_after_function_declaration -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::consistency_test::lint_reports_impl_declaration_after_function_declaration -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::consistency_test::lint_accepts_type_impl_function_declaration_order -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::consistency_test::lint_reports_std_module_declaration_path_mismatch -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::consistency_test::lint_accepts_std_module_declaration_matching_path -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::consistency_test::lint_accepts_non_std_module_declaration_path_mismatch -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::consistency_test::lint_accepts_std_module_path_with_comment_module_mentions -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::consistency_test::lint_accepts_comments_between_declaration_blocks -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::consistency_test::lint_accepts_multiple_impl_blocks_with_methods_before_functions -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::generated_test::lint_reports_generated_file_missing_source_manifest -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::generated_test::lint_accepts_generated_file_with_source_manifest -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::generated_test::lint_accepts_non_generated_file_mentioning_generated_values -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::generated_test::lint_reports_generated_file_inline_lint_suppression -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::generated_test::lint_accepts_generated_file_lint_suppression_manifest -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::generated_test::lint_accepts_non_generated_inline_lint_suppression_text -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::generated_test::lint_reports_generated_file_unstructured_skip_note -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::generated_test::lint_accepts_generated_file_skip_manifest -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::generated_test::lint_accepts_non_generated_unsupported_notes -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::lint_reports_duplicate_import_declaration -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::lint_accepts_distinct_selected_imports -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::lint_accepts_import_text_inside_comments -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::lint_reports_duplicate_selected_import_name -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::lint_accepts_distinct_selected_import_names -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::lint_reports_duplicate_selected_type_import_name -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::lint_reports_unsorted_import_declaration -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::lint_accepts_sorted_import_declarations -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::lint_accepts_import_text_inside_block_comments -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::lint_reports_unsorted_selected_import_names -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::lint_accepts_sorted_selected_import_names -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::lint_accepts_sorted_type_selected_import_names -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::lint_reports_split_selected_imports_from_same_module -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::lint_accepts_grouped_selected_imports_from_same_module -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::lint_accepts_separate_value_and_type_selected_imports -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::unused_test::lint_reports_unused_selected_value_import -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::unused_test::lint_accepts_used_selected_value_imports -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::unused_test::lint_accepts_used_selected_type_import -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::unused_test::lint_accepts_constructor_shaped_selected_import_without_textual_use -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::unused_test::lint_accepts_used_selected_import_alias -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::unused_test::lint_reports_unused_module_import -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::unused_test::lint_accepts_used_module_import_by_visible_name -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::unused_test::lint_accepts_used_module_import_by_qualified_path -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::unused_test::lint_accepts_used_module_import_alias -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::unused_test::lint_accepts_selected_imports_for_module_unused_rule -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::unused_test::lint_accepts_type_and_asset_imports_for_module_unused_rule -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::redundant_test::lint_reports_redundant_module_qualified_selected_import_call -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::redundant_test::lint_reports_redundant_full_qualified_selected_import_call -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::redundant_test::lint_accepts_direct_selected_import_call -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::redundant_test::lint_reports_redundant_qualified_call_for_aliased_selected_import -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::redundant_test::lint_accepts_type_and_constructor_selected_imports_for_redundant_qualifier_rule -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::redundant_test::lint_accepts_qualified_selected_import_text_inside_comments_and_strings -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::selected_default_test::lint_reports_default_import_that_could_be_selected -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::selected_default_test::lint_reports_full_qualified_default_import_that_could_be_selected -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::selected_default_test::lint_accepts_default_import_used_for_multiple_members -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::selected_default_test::lint_accepts_aliased_default_import -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::selected_default_test::lint_accepts_constructor_shaped_member_use -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::selected_default_test::lint_accepts_default_import_used_for_constructor_and_member -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::imports_test::selected_default_test::lint_accepts_default_import_member_text_inside_comments_and_strings -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::naming_test::lint_reports_camel_case_function_name -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::naming_test::lint_accepts_snake_case_function_name -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::naming_test::lint_reports_camel_case_method_name -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::naming_test::lint_accepts_upper_camel_type_name -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::naming_test::lint_reports_noncanonical_type_name -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::naming_test::lint_reports_noncanonical_struct_name -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::naming_test::lint_accepts_upper_camel_struct_name -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::naming_test::lint_reports_case_underscore_function_name_collision -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::naming_test::lint_reports_case_underscore_type_name_collision -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::naming_test::lint_accepts_distinct_declaration_names -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::naming_test::lint_reports_camel_case_function_parameter_binding -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::naming_test::lint_reports_camel_case_let_pattern_binding -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::naming_test::lint_accepts_snake_case_value_bindings -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::naming_test::lint_accepts_underscore_prefixed_value_bindings -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::targets_test::lint_reports_incompatible_target_std_imports -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::targets_test::lint_accepts_vm_and_native_std_imports_together -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::targets_test::lint_accepts_target_std_imports_inside_comments -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::lint_reports_literal_true_assertion_in_test_source -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::lint_reports_literal_true_body_in_test_source -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::lint_accepts_unannotated_helper_identity_assertion_in_test_source -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::lint_accepts_non_literal_assertion_condition_in_test_source -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::lint_reports_qualified_literal_true_assertion_in_test_source -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::lint_reports_identity_assertion_in_test_source -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::lint_accepts_non_identity_assertion_in_test_source -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::lint_reports_declaration_only_surface_test_name -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::lint_reports_generated_declaration_only_surface_test_name -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::lint_accepts_unannotated_declaration_only_helper_name_in_test_source -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::lint_reports_oversized_test_assertion_volume -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::lint_accepts_focused_test_assertion_volume_threshold -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::lint_accepts_unannotated_helper_assertion_volume_in_test_source -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::lint_reports_repeated_assert_equal_table_candidate -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::lint_accepts_two_assert_equal_rows_without_table_candidate -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::lint_accepts_mixed_assertions_without_table_candidate -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::lint_rejects_identity_assertion_rule_outside_test_source -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::lint_reports_qualified_identity_assertion_in_test_source -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::test_rules_test::lint_reports_roundtrip_test_without_property_runner -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::test_rules_test::lint_accepts_roundtrip_test_with_property_runner -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::test_rules_test::lint_accepts_ordinary_ordering_example_without_property_runner -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::test_rules_test::lint_reports_ordering_law_without_property_runner -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::pipe_test::lint_reports_safe_nested_module_call_pipe_candidate -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::pipe_test::lint_command_fix_rewrites_safe_nested_module_call_pipe_candidate -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::pipe_test::lint_reports_safe_receiver_inner_call_pipe_candidate -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::pipe_test::lint_command_fix_rewrites_safe_receiver_inner_call_pipe_candidate -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::pipe_test::lint_command_fix_rewrites_declared_local_helper_pipe_stage -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::pipe_test::lint_command_fix_rewrites_selected_import_pipe_stage -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::pipe_test::lint_rejects_named_argument_pipe_candidate -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::pipe_test::lint_rejects_named_receiver_call_pipe_candidate -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::pipe_test::lint_rejects_function_value_pipe_candidate -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::pipe_test::lint_rejects_unproven_local_variable_pipe_candidate -- --exact
	$(TERLC_EXACT_TEST) --bin terlc commands::lint::lint_test::pipe_test::lint_rejects_nested_argument_pipe_candidate -- --exact
	$(TERLC_EXACT_TEST) --bin terlc tests::help_test::top_level_usage_hides_internal_scratch_commands -- --exact
	$(TERLC_EXACT_TEST) --bin terlc tests::help_test::run_cli_accepts_command_local_help_for_known_commands -- --exact
...
cli-terlan-vm-compiler-bridge-check:
	...
	printf '%s\n' '[package]' 'name = "app"' 'version = "0.0.1"' '' '[build]' 'source_roots = ["src"]' 'artifact = "terlan-vm"' > /tmp/terlan_vm_compiler_bridge_check/terlan.toml
	...
	compiler_output="$$(target/debug/terlc --out-dir /tmp/terlan_vm_compiler_bridge_check/_build run /tmp/terlan_vm_compiler_bridge_check)"; \
	if [ "$$compiler_output" != "hello from Terlan VM bridge" ]; then \
		printf '%s\n' "terlan-vm compiler bridge check failed in compiler VM lane"; \
		printf '%s\n' "$$compiler_output"; \
		exit 1; \
	fi; \
	vm_output="$$(target/debug/terlan-vm run /tmp/terlan_vm_compiler_bridge_check/src/app/Main.terl)"; \
	if [ "$$vm_output" != "$$compiler_output" ]; then \
		printf '%s\n' "terlan-vm compiler bridge check produced mismatched output"; \
		printf '%s\n' "compiler: $$compiler_output"; \
		printf '%s\n' "vm:       $$vm_output"; \
		exit 1; \
	fi
	rm -rf /tmp/terlan_vm_intrinsic_bridge_check
	mkdir -p /tmp/terlan_vm_intrinsic_bridge_check/src/app
	printf '%s\n' '[package]' 'name = "app"' 'version = "0.0.1"' '' '[build]' 'source_roots = ["src"]' 'artifact = "terlan-vm"' > /tmp/terlan_vm_intrinsic_bridge_check/terlan.toml
	printf '%s\n' 'module app.Main.' '' 'pub main(): Unit ->' '    std.io.Console.println(std.core.Bool.to_string(std.core.Int.to_string(42) == "42" and "abc".contains("b") and "abc".length() == 3)).' > /tmp/terlan_vm_intrinsic_bridge_check/src/app/Main.terl
	intrinsic_output="$$(target/debug/terlc --out-dir /tmp/terlan_vm_intrinsic_bridge_check/_build run /tmp/terlan_vm_intrinsic_bridge_check)"; \
	if [ "$$intrinsic_output" != "true" ]; then \
		printf '%s\n' "terlan-vm compiler bridge check failed intrinsic VM lane"; \
		printf '%s\n' "$$intrinsic_output"; \
		exit 1; \
	fi
	rm -rf /tmp/terlan_vm_runtime_bridge_check
	mkdir -p /tmp/terlan_vm_runtime_bridge_check/src/app
	printf '%s\n' '[package]' 'name = "app"' 'version = "0.0.1"' '' '[build]' 'source_roots = ["src"]' 'artifact = "terlan-vm"' > /tmp/terlan_vm_runtime_bridge_check/terlan.toml
	printf '%s\n' 'module app.Main.' '' 'pub main(): Unit ->' '    let path = "/tmp/terlan-vm-runtime-bridge-check.txt";' '        write = std.io.File.write_text(path, "hello");' '    std.io.Console.println(std.core.Bool.to_string(std.core.Result.is_ok(write) and std.io.File.exists(path))).' > /tmp/terlan_vm_runtime_bridge_check/src/app/Main.terl
	runtime_output="$$(target/debug/terlc --out-dir /tmp/terlan_vm_runtime_bridge_check/_build run /tmp/terlan_vm_runtime_bridge_check)"; \
	if [ "$$runtime_output" != "true" ]; then \
		printf '%s\n' "terlan-vm compiler bridge check failed runtime intrinsic VM lane"; \
		printf '%s\n' "$$runtime_output"; \
		exit 1; \
	fi
...
http-tls-check:
	...
	$(TERLC_EXACT_TEST) commands::serve::tls::tls_test::serve_live_acme_issuance_starts_vm_worker_lane -- --exact
	...
	$(TERLC_EXACT_TEST) commands::serve::tls::tls_test::runtime_tls_config_rejects_zerossl_primary_before_cache_loading -- --exact
	...
	$(TERLC_EXACT_TEST) commands::serve::tls::tls_test::acme_runtime_tls_config_accepts_local_mock_issuer_cache_handoff -- --exact
	$(TERLC_EXACT_TEST) commands::serve::tls::tls_test::acme_runtime_tls_config_rejects_local_mock_issuer_without_cache_handoff -- --exact
	$(TERLC_EXACT_TEST) commands::serve::tls::tls_test::runtime_tls_config_rejects_auto_tls_cache_without_renewal_metadata -- --exact
	$(TERLC_EXACT_TEST) commands::serve::tls::tls_test::runtime_tls_config_rejects_malformed_auto_tls_certificate_cache_metadata -- --exact
	$(TERLC_EXACT_TEST) commands::serve::tls::tls_test::runtime_tls_config_rejects_future_dated_auto_tls_certificate_cache_metadata -- --exact
	$(TERLC_EXACT_TEST) commands::serve::tls::tls_test::runtime_tls_config_rejects_stale_auto_tls_certificate_cache -- --exact
	...
	$(TERLC_EXACT_TEST) commands::serve::serve_test::hyper_request_handler_serves_acme_http01_head_without_body -- --exact
...
http-acme-live-check:
	$(PYTHON) tools/check_http_acme_live.py
...
template-contract-check:
	...
	$(RUST_TEST) -p terlan --bin terlc commands::artifacts::artifacts_test::collect_syntax_
	$(RUST_TEST) -p terlan --bin terlc validation::template_contract::
	$(RUST_TEST) -p terlan --bin terlc commands::static_site::render::render_test::
...
artifact-template-check:
	$(RUST_TEST) -p terlan --bin terlc html::artifact::artifact_test::
	$(RUST_TEST) -p terlan --bin terlc html::structured::structured_test::
...
typed-template-interpolation-vm-check: compiler-purity-metadata-check template-contract-check
	...
	$(TERLC_EXACT_TEST) commands::serve::handler::handler_test::handler_response_converts_from_vm_typed_template_html_descriptor -- --exact
	$(RUST_TEST) -p terlan --bin terlan-vm runtime::vm::http::template_response_target_test::
	$(RUST_TEST) -p terlan --bin terlan-vm runtime::vm::http_session::http_session_live_template_response_test::
	$(RUST_TEST) -p terlan --bin terlan-vm runtime::vm::live_template_protocol::live_template_protocol_test::
...
typed-template-interpolation-js-check: template-contract-check
	...
	$(RUST_TEST) -p terlan --features editor-lsp --bin terlan-lsp template_completion_test::
...
typed-template-interpolation-backend-check: artifact-template-check template-contract-check
	...
	$(TERLC_EXACT_TEST) commands::emit_js::template_runtime::template_runtime_test::generated_js_template_runtime_matches_vm_shared_fixture_corpus -- --exact
	$(RUST_TEST) -p terlan --bin terlc html::structured_render::structured_render_test::
	$(RUST_TEST) -p terlan --bin terlc commands::static_site::render::render_attribute_test::
...
comprehension-guards-check: compiler-purity-metadata-check tree-sitter-cli-check
	...
	$(TERLC_EXACT_TEST) formal_pipeline::formal_pipeline_test::embedded_std_interfaces_include_core_guard_result_contract -- --exact
	$(CARGO) test -p terlan --bin terlc comprehension
	$(CARGO) test -p terlan --bin terlan-lsp --features editor-lsp comprehension
...
flexible-shape-guards-check: compiler-purity-metadata-check pattern-matching-support-check
	$(TERLC_EXACT_TEST) compiler::syntax::parser::parser_expr_test::tests::formal_keyword_exprs_preserve_clause_guards -- --exact
	$(TERLC_EXACT_TEST) compiler::syntax::parser::parser_expr_test::tests::formal_keyword_exprs_reject_when_clause_guards -- --exact
	$(TERLC_EXACT_TEST) compiler::syntax::parser::parser_expr_test::tests::formal_expr_parses_range_membership_with_range_precedence -- --exact
	$(TERLC_EXACT_TEST) compiler::syntax::syntax_output::syntax_output_expr_test::tests::syntax_output_includes_case_guard_trees -- --exact
	$(TERLC_EXACT_TEST) compiler::syntax::syntax_output::syntax_output_expr_test::tests::syntax_output_includes_function_clause_guard_trees -- --exact
	$(TERLC_EXACT_TEST) compiler::syntax::syntax_output::syntax_output_expr_test::tests::syntax_output_accepts_function_clause_where_guard_trees -- --exact
	$(TERLC_EXACT_TEST) compiler::syntax::formatter::formatter_test::formatter_preserves_case_guards_with_where -- --exact
	$(TERLC_EXACT_TEST) compiler::syntax::formatter::formatter_test::formatter_canonicalizes_function_head_guards_to_where -- --exact
	$(TERLC_EXACT_TEST) compiler::typeck::expression_test::syntax_output_infers_range_membership_on_formal_path -- --exact
	$(TERLC_EXACT_TEST) compiler::typeck::expression_test::syntax_output_rejects_non_integer_range_bounds -- --exact
	$(TERLC_EXACT_TEST) compiler::typeck::expression_test::syntax_output_rejects_non_range_membership_target -- --exact
	$(TERLC_EXACT_TEST) compiler::typeck::pattern_test::syntax_output_refines_case_guards_on_formal_path -- --exact
	$(TERLC_EXACT_TEST) compiler::typeck::pattern_test::syntax_output_refines_function_guards_on_formal_path -- --exact
	$(TERLC_EXACT_TEST) compiler::typeck::pattern_test::syntax_output_refines_where_guards_on_formal_path -- --exact
	$(TERLC_EXACT_TEST) compiler::typeck::pattern_test::syntax_output_rejects_non_bool_case_guard -- --exact
	$(TERLC_EXACT_TEST) compiler::typeck::pattern_test::syntax_output_rejects_non_bool_function_guard -- --exact
	$(TERLC_EXACT_TEST) compiler::typeck::pattern_test::syntax_output_rejects_impure_case_guard_assignment -- --exact
	$(TERLC_EXACT_TEST) compiler::typeck::pattern_test::syntax_output_rejects_impure_case_guard_template_call -- --exact
	$(TERLC_EXACT_TEST) compiler::typeck::pattern_test::syntax_output_rejects_impure_function_guard_assignment -- --exact
	$(TERLC_EXACT_TEST) compiler::typeck::pattern_test::syntax_output_rejects_impure_function_guard_template_call -- --exact
...
private-field-check:
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::expression_test::syntax_output_accepts_local_private_struct_field_access -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::expression_test::syntax_output_accepts_local_private_struct_field_update -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::expression_test::syntax_output_accepts_local_private_struct_field_pattern -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::expression_test::syntax_output_rejects_bare_access_to_private_struct_field -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::expression_test::syntax_output_rejects_bare_update_to_private_struct_field -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::expression_test::syntax_output_rejects_bare_pattern_for_private_struct_field -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::import_test::syntax_output_rejects_imported_private_struct_field_access -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::import_test::syntax_output_rejects_imported_private_struct_field_update -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::import_test::syntax_output_rejects_imported_private_struct_field_pattern -- --exact

db-command-check:
	$(PYTHON) tools/check_db_command_boundary.py
	$(CARGO) test -p terlan --bin terlc commands::db::
	$(CARGO) test -p terlan --bin terlc runtime::vm::postgres
	$(CARGO) test -p terlan --bin terlc source_postgres

native-boundary-postgres-check:
	$(TERLC_EXACT_TEST) runtime::native::postgres::postgres_test::config_defaults_are_stable -- --exact
	$(TERLC_EXACT_TEST) runtime::native::postgres::postgres_test::config_builders_set_pool_limits_and_timeouts -- --exact
	$(TERLC_EXACT_TEST) runtime::native::postgres::postgres_test::validate_config_rejects_invalid_pool_settings -- --exact
	$(TERLC_EXACT_TEST) runtime::native::postgres::postgres_test::query_operations_reject_empty_sql_before_adapter_dispatch -- --exact
	$(TERLC_EXACT_TEST) runtime::native::postgres::postgres_test::row_accessors_decode_matching_values -- --exact
	$(TERLC_EXACT_TEST) runtime::native::postgres::postgres_test::row_accessors_keep_dynamic_column_and_enum_text_as_strings -- --exact
	$(TERLC_EXACT_TEST) runtime::native::postgres::postgres_test::row_accessors_report_missing_and_type_errors -- --exact
	$(TERLC_EXACT_TEST) runtime::native_boundary::dispatch::dispatch_test::dispatch_postgres_connect_preserves_adapter_error_codes -- --exact
	$(TERLC_EXACT_TEST) runtime::native_boundary::dispatch::dispatch_test::dispatch_postgres_query_operations_are_known_driver_operations -- --exact
	$(TERLC_EXACT_TEST) runtime::native_boundary::dispatch::dispatch_test::dispatch_postgres_transaction_requires_runtime_bridge -- --exact
	$(TERLC_EXACT_TEST) runtime::native_boundary::dispatch::dispatch_test::dispatch_postgres_row_accessors_decode_values -- --exact
	$(TERLC_EXACT_TEST) runtime::native_boundary::dispatch::dispatch_test::bridge_dispatch_postgres_row_handles_decode_values -- --exact
	$(TERLC_EXACT_TEST) runtime::native_boundary::dispatch::dispatch_test::bridge_dispatch_postgres_row_keeps_atom_like_columns_as_text -- --exact
	$(TERLC_EXACT_TEST) runtime::native_boundary::dispatch::dispatch_test::bridge_dispatch_postgres_pool_handles_reach_query_adapter -- --exact
...
native-boundary-postgres-docker-check:
	...
	$(RUST_TEST) --locked -p terlan --bin terlc \
...
sql-form-check:
	...
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::parser::parser_expr_test::tests::formal_typed_sql_raw_macro_expr_parses_result_type -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::parser::parser_expr_test::tests::formal_typed_sql_raw_macro_expr_parses_interpolation_expressions -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::parser::parser_expr_test::tests::formal_typed_sql_raw_macro_expr_rejects_bad_interpolation -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::parser::parser_expr_test::tests::formal_typed_sql_raw_macro_expr_ignores_comment_interpolation_text -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::parser::parser_adversarial_test::tests::formal_typed_sql_raw_macro_expr_ignores_dollar_quoted_interpolation_text -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::parser::parser_adversarial_test::tests::formal_typed_sql_raw_macro_expr_ignores_nested_comment_interpolation_text -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::syntax_output::syntax_output_expr_test::tests::syntax_output_includes_typed_sql_raw_macro_expr_trees -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::syntax_output::syntax_output_expr_test::tests::syntax_output_includes_typed_sql_interpolation_children -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::syntax_output::syntax_output_expr_test::tests::syntax_output_ignores_typed_sql_comment_interpolation_text -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::syntax_output::syntax_output_expr_test::tests::syntax_output_ignores_typed_sql_dollar_quoted_interpolation_text -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_forms_test::infers_select_limit_one_as_optional_one -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_forms_test::infers_cte_select_from_postgres_ast -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_forms_test::infers_fetch_first_one_as_optional_one -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_forms_test::keeps_dynamic_limit_and_fetch_with_ties_as_many_rows -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_forms_test::classifies_postgres_statement_kinds_from_ast -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_forms_test::infers_transaction_requirements_from_postgres_ast -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_forms_test::builds_locking_query_with_active_transaction_requirement -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_forms_test::rejects_vm_owned_transaction_control_from_wrapper_plan -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_forms_test::derives_aliased_expression_and_cte_projection_fields_from_ast -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_forms_test::rejects_duplicate_projection_output_names -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_forms_test::folds_unquoted_projection_names_before_duplicate_validation -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_forms_test::rejects_duplicate_unqualified_names_from_compound_columns -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_forms_test::infers_mutating_statement_without_returning_as_affected_rows -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_forms_test::rewrites_interpolations_to_postgres_placeholders_in_order -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_forms_test::leaves_parameter_text_inside_postgres_dollar_quotes_untouched -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_forms_test::analyzes_dollar_quoted_sql_without_parameter_drift -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_forms_test::rejects_explicit_postgres_placeholders -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_forms_test::reports_ready_sql_wrapper_lowering_front_door -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_forms_test::builds_ready_sql_wrapper_plan -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_forms_test::sql_macro_validation_rejects_malformed_postgres_syntax -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_forms_test::sql_macro_validation_rejects_multiple_statements -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_forms_test::sql_macro_validation_rejects_comment_only_forms -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_forms_test::sql_macro_validation_keeps_injection_shaped_values_parameterized -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_parameter_type_test::sql_parameter_types_accept_runtime_scalar_contract -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_parameter_type_test::sql_parameter_types_reject_structured_dynamic_and_nullable_values -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_parameter_type_test::sql_parameter_type_diagnostic_preserves_interpolation_index_and_span -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_row_descriptor_test::sql_row_descriptor_accepts_scalar_tuple_and_infers_result_type -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_row_descriptor_test::sql_row_descriptor_accepts_transparent_scalar_tuple_alias -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_row_descriptor_test::sql_row_descriptor_rejects_tuple_projection_arity_mismatch -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_row_descriptor_test::sql_row_descriptor_rejects_non_decodable_structural_fields -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_row_descriptor_test::sql_row_descriptor_accepts_nullable_scalar_tuple_and_struct_fields -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::sql_row_descriptor_test::sql_row_descriptor_rejects_nullable_structured_payloads -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::diagnostic_test::sql_macro_validation_reports_duplicate_projection_name -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::diagnostic_test::sql_macro_validation_rejects_explicit_postgres_placeholders -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::diagnostic_test::syntax_output_rejects_raw_macro_expr_without_macro_resolution -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::diagnostic_test::sql_macro_validation_reports_stable_malformed_sql_diagnostic -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::diagnostic_test::sql_macro_validation_rejects_vm_owned_transaction_control -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::diagnostic_test::syntax_output_rejects_sql_projection_field_not_on_row_struct -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::diagnostic_test::syntax_output_uses_sql_wrapper_result_type_for_return_checking -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_lowering_test::syntax_output_lowering_to_core_records_sql_query_payload -- --exact
...
sql-runtime-check:
	...
	$(TERLC_EXACT_TEST) commands::sql_runtime::sql_runtime_test::encode_row_serializes_supported_scalar_values -- --exact
	$(TERLC_EXACT_TEST) commands::sql_runtime::sql_runtime_test::encode_row_serializes_json_values -- --exact
	$(TERLC_EXACT_TEST) commands::sql_runtime::sql_runtime_test::encode_row_rejects_missing_projection_fields -- --exact
...
formal-cli-build-gate:
	...
	$(TERLC_EXACT_TEST) commands::build::build_test::tests::artifact_test::build_command_emits_terlan_vm_artifact_without_erlang_or_beam -- --exact
	$(TERLC_EXACT_TEST) commands::build::build_test::tests::artifact_test::build_command_defaults_to_terlan_vm_artifact_without_erlang_or_beam -- --exact
	$(TERLC_EXACT_TEST) commands::build::build_test::tests::artifact_test::build_command_defaults_project_directory_to_terlan_vm_artifacts -- --exact
...
formal-cli-a0-54-constructor-contract-gate:
	...
	$(TERLC_EXACT_TEST) tests::check_constructor_error_manifest_test::run_check_single_file_rejects_public_constructor_private_return_before_core_phase -- --exact
	$(TERLC_EXACT_TEST) commands::build::build_test::tests::executable_vm_artifact_test::build_command_compiles_project_explicit_constructor_entrypoint -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::diagnostic_test::syntax_output_rejects_public_constructor_returning_private_type -- --exact
...
formal-cli-a0-55-function-clause-contract-gate:
	...
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::pattern_test::syntax_output_refines_function_guards_on_formal_path -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_lowering_test::syntax_output_lowering_to_core_records_function_clause_summaries -- --exact

formal-cli-a0-56-primary-expression-contract-gate:
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::parser::parser_expr_test::tests::formal_macro_expr_parses_as_primary_expr -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::parser::parser_expr_test::tests::formal_raw_macro_expr_requires_immediate_raw_block -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::parser::parser_expr_test::tests::formal_constructor_chain_expr_parses_with_record_expr -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::syntax_output::syntax_output_expr_test::tests::syntax_output_includes_quoted_atom_literals -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::syntax_output::syntax_output_expr_test::tests::syntax_output_includes_sequence_primary_expr_trees -- --exact
...
formal-cli-a0-57-keyword-expression-contract-gate:
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::syntax_output::syntax_output_expr_test::tests::syntax_output_allows_keyword_expressions_in_operator_chains -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::syntax_output::syntax_output_expr_test::tests::syntax_output_includes_if_expression_trees -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::syntax_output::syntax_output_expr_test::tests::syntax_output_includes_try_expression_trees -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::expression_test::syntax_output_checks_if_expr_on_formal_path -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::expression_test::syntax_output_checks_try_expr_on_formal_path -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::expression_test::syntax_output_supports_try_after_cleanup -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_control_flow_test::syntax_output_lowering_to_core_records_if_core_expr -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_control_flow_test::syntax_output_lowering_to_core_records_try_core_expr -- --exact
...
formal-cli-a0-58-calls-and-references-contract-gate:
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::expression_test::syntax_output_infers_local_calls_on_formal_path -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::expression_test::syntax_output_infers_field_access_on_formal_path -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_lowering_test::syntax_output_lowering_to_core_records_local_call_core_expr -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_lowering_test::syntax_output_lowering_to_core_records_function_value_call_core_expr -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_lowering_test::syntax_output_typechecks_pipe_into_function_value_call -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_expr_test::syntax_output_lowering_to_core_index_expr_uses_index_get_call -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_expr_test::syntax_output_lowering_to_core_field_access_expr -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_expr_test::syntax_output_lowering_to_core_marks_remote_call_proof_model_required -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_expr_test::syntax_output_lowering_to_core_rejects_remote_fun_ref_source_syntax -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::receiver_method_test::syntax_output_resolves_local_receiver_method_calls_on_formal_path -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::receiver_method_test::syntax_output_rejects_duplicate_receiver_method_identity_on_formal_path -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::receiver_method_test::syntax_output_rejects_receiver_methods_for_imported_owner_on_formal_path -- --exact
	$(TERLC_EXACT_TEST) tests::check_target_profile_progression_test::run_check_single_file_accepts_fun_call_for_a0_16_vm_target_profile -- --exact
	$(TERLC_EXACT_TEST) tests::check_target_profile_progression_test::run_check_single_file_keeps_fun_call_out_of_a0_15_vm_target_profile -- --exact
	$(TERLC_EXACT_TEST) tests::check_target_profile_progression_test::run_check_single_file_accepts_qualified_calls_for_a0_20_vm_target_profile -- --exact
	$(TERLC_EXACT_TEST) tests::check_target_profile_progression_test::run_check_single_file_keeps_qualified_calls_out_of_a0_19_vm_target_profile -- --exact
...
formal-cli-a0-59-data-form-contract-gate:
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::syntax_output::syntax_output_expr_test::tests::syntax_output_rejects_erlang_binary_segment_text -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::syntax_output::syntax_output_pattern_test::tests::syntax_output_includes_list_cons_expr_and_pattern_trees -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::syntax_output::syntax_output_expr_test::tests::syntax_output_includes_record_suffix_trees -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::syntax_output::syntax_output_expr_test::tests::syntax_output_includes_map_constructor_record_and_template_field_trees -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::expression_test::syntax_output_binds_list_comprehension_patterns_on_formal_path -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::expression_test::syntax_output_rejects_list_comprehension_non_list_source_on_formal_path -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_expr_test::syntax_output_lowering_to_core_binary_literal -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_expr_test::syntax_output_lowering_to_core_map_expr -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_expr_test::syntax_output_lowering_to_core_list_cons_expr -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_expr_test::syntax_output_lowering_to_core_fixed_array_expr -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_expr_test::syntax_output_lowering_to_core_list_comprehension_expr -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_expr_test::syntax_output_lowering_to_core_record_construct_expr -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_expr_test::syntax_output_lowering_to_core_record_access_expr -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_expr_test::syntax_output_lowering_to_core_record_update_expr -- --exact
	$(TERLC_EXACT_TEST) tests::check_target_profile_progression_test::run_check_single_file_accepts_lists_for_a0_7_vm_target_profile -- --exact
	$(TERLC_EXACT_TEST) tests::check_target_profile_progression_test::run_check_single_file_keeps_lists_out_of_a0_6_vm_target_profile -- --exact
	$(TERLC_EXACT_TEST) tests::check_target_profile_progression_test::run_check_single_file_accepts_binary_for_a0_8_vm_target_profile -- --exact
	$(TERLC_EXACT_TEST) tests::check_target_profile_progression_test::run_check_single_file_keeps_binary_out_of_a0_7_vm_target_profile -- --exact
	$(TERLC_EXACT_TEST) tests::check_target_profile_progression_test::run_check_single_file_accepts_list_cons_for_a0_9_vm_target_profile -- --exact
	$(TERLC_EXACT_TEST) tests::check_target_profile_progression_test::run_check_single_file_keeps_list_cons_out_of_a0_8_vm_target_profile -- --exact
	$(TERLC_EXACT_TEST) tests::check_target_profile_gate_test::run_check_single_file_rejects_fixed_array_for_core_v0_target_profile -- --exact
	$(TERLC_EXACT_TEST) tests::check_target_profile_gate_test::run_check_single_file_rejects_map_for_core_v0_target_profile -- --exact
	$(TERLC_EXACT_TEST) tests::check_target_profile_gate_test::run_check_single_file_rejects_list_comprehension_for_core_v0_target_profile -- --exact
...
formal-cli-a0-60-pattern-contract-gate:
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::syntax_output::syntax_output_expr_test::tests::syntax_output_includes_recursive_expression_and_pattern_trees -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::syntax_output::syntax_output_expr_test::tests::syntax_output_includes_case_guard_trees -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::syntax_output::syntax_output_pattern_test::tests::syntax_output_marks_constructor_pattern_candidates -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::syntax_output::syntax_output_pattern_test::tests::syntax_output_includes_list_cons_expr_and_pattern_trees -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::constructor_test::syntax_output_declared_constructor_patterns_are_valid_on_formal_path -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::diagnostic_test::syntax_output_unknown_constructor_patterns_are_rejected_on_formal_path -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::constructor_test::syntax_output_raw_atom_patterns_do_not_require_constructor_declarations_on_formal_path -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::pattern_test::syntax_output_list_cons_patterns_are_valid_on_formal_path -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::constructor_test::syntax_output_single_shape_alias_constructor_patterns_are_valid_on_formal_path -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::diagnostic_test::syntax_output_single_shape_alias_constructor_patterns_report_arity_mismatch_on_formal_path -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::constructor_test::syntax_output_literal_alias_constructor_patterns_are_valid_on_formal_path -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::diagnostic_test::syntax_output_union_aliases_do_not_generate_constructor_patterns_on_formal_path -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::pattern_test::syntax_output_binds_case_constructor_patterns_on_formal_path -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::pattern_test::syntax_output_refines_case_guards_on_formal_path -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_lowering_test::syntax_output_lowering_to_core_records_record_pattern_payload -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_lowering_test::syntax_output_lowering_to_core_pattern_coverage_includes_float_payload -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_lowering_test::syntax_output_lowering_to_core_pattern_coverage_includes_map_payload -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_lowering_test::syntax_output_lowering_to_core_pattern_coverage_includes_list_cons_payload -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_lowering_test::syntax_output_lowering_to_core_pattern_coverage_requires_covered_tuple_children -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_lowering_test::syntax_output_lowering_to_core_pattern_coverage_requires_covered_list_children -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_lowering_test::syntax_output_lowering_to_core_pattern_coverage_requires_covered_constructor_args -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_lowering_test::syntax_output_lowering_to_core_pattern_coverage_requires_map_field_payload -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_lowering_test::syntax_output_lowering_to_core_pattern_coverage_includes_compat_wildcards -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::constructor_test::syntax_output_lowering_to_core_resolves_declared_constructor_pattern_identity -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::constructor_test::syntax_output_lowering_to_core_resolves_imported_constructor_pattern_identity -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::constructor_test::syntax_output_lowering_to_core_resolves_aliased_imported_constructor_pattern_identity -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::constructor_test::syntax_output_lowering_to_core_resolves_local_alias_constructor_pattern_identity -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::constructor_test::syntax_output_lowering_to_core_resolves_direct_imported_alias_constructor_pattern_identity -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::constructor_test::syntax_output_lowering_to_core_resolves_imported_alias_constructor_pattern_identity -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_control_flow_test::syntax_output_lowering_to_core_case_with_record_pattern_requires_proof_model -- --exact
	$(TERLC_EXACT_TEST) tests::check_target_profile_progression_test::run_check_single_file_accepts_constructor_pattern_for_a0_13_vm_target_profile -- --exact
	$(TERLC_EXACT_TEST) tests::check_target_profile_progression_test::run_check_single_file_keeps_constructor_pattern_out_of_a0_12_vm_target_profile -- --exact
...
formal-cli-a0-61-lexical-and-name-contract-gate:
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::parser::parser_pattern_test::tests::formal_raw_atom_patterns_are_literal_patterns -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::parser::parser_pattern_test::tests::formal_nullary_constructor_pattern_call_is_rejected -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::syntax_output::syntax_output_expr_test::tests::syntax_output_includes_quoted_atom_literals -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::syntax_output::syntax_output_expr_test::tests::syntax_output_normalizes_prefixed_integer_literals -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::syntax_output::syntax_output_pattern_test::tests::syntax_output_marks_constructor_pattern_candidates -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::syntax_output::syntax_output_expr_test::tests::syntax_output_keeps_constructor_call_candidates_as_named_calls -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::constructor_test::syntax_output_raw_atom_patterns_do_not_require_constructor_declarations_on_formal_path -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::constructor_test::syntax_output_literal_alias_constructor_patterns_are_valid_on_formal_path -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::import_test::syntax_output_imported_literal_alias_constructor_patterns_are_valid_on_formal_path -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::constructor_test::syntax_output_literal_aliases_compare_with_literal_values_on_formal_path -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::diagnostic_test::syntax_output_literal_alias_constructor_calls_are_rejected_on_formal_path -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::diagnostic_test::syntax_output_remote_literal_alias_constructor_calls_are_rejected_by_parser_on_formal_path -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::import_test::syntax_output_imported_literal_alias_constructor_calls_are_rejected_on_formal_path -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::constructor_test::syntax_output_quoted_atom_alias_constructor_patterns_are_valid_on_formal_path -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::diagnostic_test::syntax_output_remote_alias_constructor_calls_are_rejected_by_parser_on_formal_path -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_lowering_test::syntax_output_lowering_to_core_records_compound_core_type_payloads -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_lowering_test::syntax_output_lowering_to_core_records_type_decl_core_body_payloads -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_expr_test::syntax_output_lowering_to_core_float_literal -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::typeck::core_expr_test::syntax_output_lowering_to_core_binary_literal -- --exact
	$(TERLC_EXACT_TEST) tests::check_target_profile_progression_test::run_check_single_file_accepts_raw_atoms_for_a0_5_vm_target_profile -- --exact
	$(TERLC_EXACT_TEST) tests::check_target_profile_progression_test::run_check_single_file_keeps_raw_atoms_out_of_a0_4_vm_target_profile -- --exact
	$(TERLC_EXACT_TEST) tests::check_target_profile_progression_test::run_check_single_file_accepts_named_call_for_a0_10_vm_target_profile -- --exact
	$(TERLC_EXACT_TEST) tests::check_target_profile_progression_test::run_check_single_file_keeps_named_call_out_of_a0_9_vm_target_profile -- --exact
	$(TERLC_EXACT_TEST) tests::check_target_profile_progression_test::run_check_single_file_accepts_constructor_call_for_a0_12_vm_target_profile -- --exact
	$(TERLC_EXACT_TEST) tests::check_target_profile_progression_test::run_check_single_file_keeps_constructor_call_out_of_a0_11_vm_target_profile -- --exact
	$(TERLC_EXACT_TEST) tests::check_target_profile_progression_test::run_check_single_file_accepts_constructor_pattern_for_a0_13_vm_target_profile -- --exact
	$(TERLC_EXACT_TEST) tests::check_target_profile_progression_test::run_check_single_file_keeps_constructor_pattern_out_of_a0_12_vm_target_profile -- --exact
...
formal-cli-js-gate:
	...
	$(TERLC_EXACT_TEST) commands::emit_js::emit_js_test::emit_core_module_with_direct_oxc_ast_handles_destructuring_list_comprehension -- --exact
...
formal-cli-a0-62-template-boundary-contract-gate:
	...
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::syntax_output::syntax_output_expr_test::tests::syntax_output_includes_map_constructor_record_and_template_field_trees -- --exact
	$(EXACT_CARGO_TEST) -p terlan compiler::syntax::syntax_output::syntax_output_decl_test::tests::syntax_output_includes_struct_constructor_trait_and_template_signatures -- --exact
	$(TERLC_EXACT_TEST) tests::check_language_feature_rejection_test::run_check_single_file_rejects_unresolved_template_body_before_core_phase -- --exact
	$(TERLC_EXACT_TEST) tests::check_target_profile_gate_test::run_check_single_file_rejects_template_instantiate_for_core_v0_target_profile -- --exact
