...
impl Backend {
    ...
    pub(in super::super) fn local_struct_field_completion_items(
    ...
    ///   ranking and display.
    pub(in super::super) fn field_completion_item(label: String, detail: String) -> CompletionItem {
        CompletionItem {
            label: label.clone(),
    ...
    pub(in super::super) fn method_completion_item(
        label: String,
        detail: String,
        docs: &[String],
    ) -> CompletionItem {
    ...
    pub(in super::super) fn imported_public_constructor_signatures(
    ...
    ///   cursor.
    pub(in super::super) fn local_symbol_completion_items(
        module: &SyntaxModuleOutput,
    ...
    pub(in super::super) fn variable_completion_item(
        label: String,
        detail: String,
    ) -> CompletionItem {
        CompletionItem {
    ...
    pub(in super::super) fn type_completion_item(
        label: String,
        detail: String,
    ...
    ///   edits.
    pub(in super::super) fn simple_let_bindings_before_offset(
        text: &str,
        byte_offset: usize,
    ...
    pub(in super::super) fn simple_let_binding_for_line(
        line: &str,
    ...
    pub(in super::super) fn simple_assignment_binding_for_line(
        line: &str,
    ) -> Option<(String, Option<&'static str>)> {
    ...
    pub(in super::super) fn simple_assignment_binding_after_prefix(
        after_prefix: &str,
    ) -> Option<(String, Option<&'static str>)> {
    ...
    pub(in super::super) fn imported_public_function_signatures(
        interface: &crate::terlan_hir::ModuleInterface,
    ...
    pub(in super::super) fn function_completion_item(
        label: String,
        detail: String,
        docs: &[String],
    ) -> CompletionItem {
    ...
    pub(in super::super) fn constant_completion_item(
        label: String,
        detail: String,
        docs: &[String],
    ) -> CompletionItem {
    ...
    pub(in super::super) fn constructor_completion_item(
        label: String,
        detail: String,
        docs: &[String],
    ) -> CompletionItem {
    ...
    ///   completion data.
    pub(in super::super) fn shape_completion_item(
        label: String,
        detail: String,
        docs: &[String],
    ) -> CompletionItem {
    ...
    pub(in super::super) fn completion_documentation(docs: &[String]) -> Option<Documentation> {
        (!docs.is_empty()).then(|| {
    ...
    pub(in super::super) fn completion_imported_modules(
        module: &SyntaxModuleOutput,
    ) -> Vec<String> {
        module
            .declarations
    ...
    pub(in super::super) fn target_compatible_completion_imported_modules(
        module: &SyntaxModuleOutput,
    ) -> Vec<String> {
    ...
    pub(in super::super) fn completion_has_target_profile_conflict(
    ...
    pub(in super::super) fn completion_target_family(module_name: &str) -> Option<&'static str> {
    ...
    pub(in super::super) fn is_target_specific_std_import(module_name: &str) -> bool {
        matches!(
            module_name,
    ...
    pub(in super::super) fn receiver_method_signature_help(
        module: &SyntaxModuleOutput,
        type_name: &str,
        callee: &str,
        active_parameter: usize,
