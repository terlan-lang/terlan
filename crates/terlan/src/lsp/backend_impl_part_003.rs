impl Backend {
    ...
    fn signature_help_from_interface_parts(
        name: &str,
        generic_params: &[String],
    ...
    fn pure_display_prefix(is_pure: bool) -> &'static str {
        if is_pure {
            "pure "
        } else {
            ""
    ...
    fn declaration_has_marker_annotation(
    ...
    fn signature_parameter_label(param: &SyntaxParamOutput) -> String {
        let mut label = String::new();
        if param.is_mutable {
            label.push_str("mut ");
        }
    ...
    fn call_context_at_byte_offset(
        text: &str,
        byte_offset: usize,
    ...
    fn identifier_before_byte_offset(
        text: &str,
        byte_offset: usize,
    ...
    fn active_parameter_index(bytes: &[u8], start: usize, end: usize) -> usize {
    ...
    ///   inference.
    fn inlay_hints_for_range(document: &OpenDocument, uri: &Url, range: Range) -> Vec<InlayHint> {
    ...
    fn parameter_inlay_hints_for_line(
        ...
        let mut signatures: Vec<(&str, String, Vec<(String, Option<String>)>)> = Vec::new();
    ...
    ///   signatures.
    fn parameter_inlay_hints_for_signature(
        line: &str,
        line_number: u32,
        name: &str,
        tooltip_name: &str,
    ...
    fn defaulted_parameter_inlay_hints(
        line_number: u32,
        close_paren: usize,
        name: &str,
        params: &[(String, Option<String>)],
    ...
    fn receiver_parameter_inlay_hints_for_line(
        module: &SyntaxModuleOutput,
        interfaces: &std::collections::HashMap<String, crate::terlan_hir::ModuleInterface>,
        line: &str,
        line_number: u32,
    ...
    fn receiver_method_parameter_names(
        module: &SyntaxModuleOutput,
        interfaces: &std::collections::HashMap<String, crate::terlan_hir::ModuleInterface>,
        type_name: &str,
        method: &str,
    ...
    fn parameter_inlay_hints_for_call_arguments(
        line: &str,
        line_number: u32,
        open_paren: usize,
        close_paren: usize,
    ...
    fn same_line_call_close(line: &str, open_paren: usize) -> Option<usize> {
