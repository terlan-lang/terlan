...
#[test]
fn signature_parameter_label_preserves_mutability_patterns_and_defaults() {
...
#[test]
fn document_symbols_include_representative_outline_tree() {
...
#[test]
fn definition_locations_use_formatter_shifted_function_spans() -> std_io::Result<()> {
...
#[test]
fn definition_locations_resolve_same_document_type_annotation() {
...
#[test]
fn definition_locations_resolve_same_document_impl_method_reference() {
...
#[test]
fn definition_locations_resolve_same_document_field_reference() {
...
#[test]
fn definition_locations_resolve_wildcard_selected_imported_function() -> std_io::Result<()> {
    let unique = SystemTime::now()
        .duration_since(UNIX_EPOCH)
        .expect("system time")
        .as_nanos();
...
#[test]
fn definition_locations_resolve_selected_import_alias_to_provider() -> std_io::Result<()> {
    let unique = SystemTime::now()
        .duration_since(UNIX_EPOCH)
        .expect("system time")
        .as_nanos();
...
#[test]
fn definition_locations_reject_ambiguous_imported_symbol() -> std_io::Result<()> {
    let unique = SystemTime::now()
        .duration_since(UNIX_EPOCH)
        .expect("system time")
        .as_nanos();
