impl Backend {
    ...
    fn value_lifecycle_semantic_tokens(document: &OpenDocument) -> SemanticTokens {
    ...
    fn completion_items_for_position(
        uri: &Url,
        document: &OpenDocument,
        position: Position,
    ) -> Vec<CompletionItem> {
    ...
    fn local_receiver_method_completion_items(
        module: &SyntaxModuleOutput,
        type_name: &str,
    ) -> Vec<CompletionItem> {
        let mut items = Vec::new();
    ...
    fn local_impl_method_completion_items(
        module: &SyntaxModuleOutput,
        type_name: &str,
    ) -> Vec<CompletionItem> {
        let mut items = Vec::new();
    ...
    fn imported_receiver_method_completion_items(
    ...
    fn receiver_name_before_member_access(text: &str, byte_offset: usize) -> Option<String> {
