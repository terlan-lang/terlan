...
#[test]
pub(super) fn completion_ranks_local_symbol_before_imported_ambiguous_symbol() -> std_io::Result<()>
{
...
#[test]
pub(super) fn completion_uses_formatter_shifted_positions_for_local_functions() -> std_io::Result<()>
{
...
#[test]
pub(super) fn completion_uses_generated_typi_interface_summary_provenance() -> std_io::Result<()> {
    let unique = SystemTime::now()
        .duration_since(UNIX_EPOCH)
        .expect("system time")
        .as_nanos();
...
#[test]
pub(super) fn completion_rejects_deleted_generated_typi_summary() -> std_io::Result<()> {
    let unique = SystemTime::now()
        .duration_since(UNIX_EPOCH)
        .expect("system time")
        .as_nanos();
...
#[test]
pub(super) fn completion_rejects_mixed_target_profile_imported_suggestions() -> std_io::Result<()> {
    let unique = SystemTime::now()
        .duration_since(UNIX_EPOCH)
        .expect("system time")
        .as_nanos();
