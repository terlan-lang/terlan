...
#[test]
pub(super) fn definition_locations_reject_private_provider_symbol() -> std_io::Result<()> {
...
#[test]
pub(super) fn definition_locations_reject_missing_provider_file() -> std_io::Result<()> {
    let unique = SystemTime::now()
        .duration_since(UNIX_EPOCH)
        .expect("system time")
        .as_nanos();
...
#[test]
pub(super) fn definition_locations_prefer_local_definition_over_import() -> std_io::Result<()> {
    let unique = SystemTime::now()
        .duration_since(UNIX_EPOCH)
        .expect("system time")
        .as_nanos();
...
#[test]
pub(super) fn definition_locations_resolve_nested_package_provider_function() -> std_io::Result<()>
{
    let unique = SystemTime::now()
        .duration_since(UNIX_EPOCH)
        .expect("system time")
...
///   imports.
#[test]
pub(super) fn definition_locations_resolve_imported_overloaded_function() -> std_io::Result<()> {
    let unique = SystemTime::now()
        .duration_since(UNIX_EPOCH)
        .expect("system time")
        .as_nanos();
...
#[test]
pub(super) fn definition_locations_follow_selected_reexport_summary() -> std_io::Result<()> {
    let unique = SystemTime::now()
        .duration_since(UNIX_EPOCH)
        .expect("system time")
        .as_nanos();
...
#[test]
pub(super) fn definition_locations_reject_stale_reexport_provider_summary() -> std_io::Result<()> {
    let unique = SystemTime::now()
        .duration_since(UNIX_EPOCH)
        .expect("system time")
        .as_nanos();
...
#[test]
pub(super) fn definition_locations_resolve_generated_summary_function_binding() -> std_io::Result<()>
{
    let unique = SystemTime::now()
        .duration_since(UNIX_EPOCH)
        .expect("system time")
...
///   summaries.
#[test]
pub(super) fn definition_locations_resolve_generated_std_summary_type() -> std_io::Result<()> {
    let unique = SystemTime::now()
        .duration_since(UNIX_EPOCH)
        .expect("system time")
        .as_nanos();
...
#[test]
pub(super) fn definition_locations_resolve_imported_type_annotation() -> std_io::Result<()> {
    let unique = SystemTime::now()
        .duration_since(UNIX_EPOCH)
        .expect("system time")
        .as_nanos();
...
#[test]
pub(super) fn definition_locations_resolve_imported_struct_field_reference() -> std_io::Result<()> {
    let unique = SystemTime::now()
        .duration_since(UNIX_EPOCH)
        .expect("system time")
        .as_nanos();
...
#[test]
pub(super) fn definition_locations_resolve_imported_shape_reference() -> std_io::Result<()> {
    let unique = SystemTime::now()
        .duration_since(UNIX_EPOCH)
        .expect("system time")
        .as_nanos();
