...
"#,
    ...
    markdown.insert(
        "HelloPost".to_string(),
        crate::terlan_html::parse_markdown("# Hello\n", "posts/hello.md").expect("markdown"),
    );
...
"#,
    ...
    templates.insert(
        "Page".to_string(),
        crate::terlan_html::parse_html_template(
...
"#,
    ...
    templates.insert(
        "Page".to_string(),
        crate::terlan_html::parse_html_template(r#"<h1>{title}</h1>"#, "page.terl.html")
            .expect("parse template"),
    );
