...
use crate::terlan_syntax::syntax_output::{SyntaxAnnotationOutput, SyntaxDeclarationPayload};
use crate::terlan_syntax::{SyntaxDeclarationOutput, SyntaxParamOutput};
...
///   Erlang backend.
pub(in crate::backends::erlang::emit) fn lower_intrinsic_annotation_body(
...
pub(in crate::backends::erlang::emit) fn lower_intrinsic_annotation_body_for_names<'a>(
    decl: &SyntaxDeclarationOutput,
