...
#[derive(Debug, Clone)]
pub(in crate::backends::erlang::emit) enum ErlType {
    Raw(String),
    Named {
        name: String,
        args: Vec<ErlType>,
...
impl ErlType {
    ...
    pub(in crate::backends::erlang::emit) fn render(&self) -> String {
        match self {
    ...
    /// shapes unchanged.
    pub(in crate::backends::erlang::emit) fn normalized(self) -> Self {
        match self {
    ...
    pub(in crate::backends::erlang::emit) fn collect_type_vars(
        &self,
    ...
    pub(in crate::backends::erlang::emit) fn render_with_phantom_vars(
        &self,
...
#[derive(Debug, Clone)]
pub(in crate::backends::erlang::emit) struct ErlMapTypeField {
    pub(in crate::backends::erlang::emit) key: String,
    pub(in crate::backends::erlang::emit) value: ErlType,
    pub(in crate::backends::erlang::emit) required: bool,
}
