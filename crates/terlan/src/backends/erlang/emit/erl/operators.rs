...
#[derive(Debug, Clone)]
pub(in crate::backends::erlang::emit) enum ErlBinaryOp {
    Add,
    Sub,
    Mul,
    Div,
...
#[derive(Debug, Clone)]
pub(in crate::backends::erlang::emit) enum ErlUnaryOp {
    Neg,
    Not,
}
...
impl ErlBinaryOp {
    ...
    pub(in crate::backends::erlang::emit) fn render(&self) -> &'static str {
        match self {
            ErlBinaryOp::Add => "+",
            ErlBinaryOp::Sub => "-",
            ErlBinaryOp::Mul => "*",
