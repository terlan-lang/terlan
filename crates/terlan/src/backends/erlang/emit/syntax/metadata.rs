...
use crate::terlan_syntax::parse_expr_as_syntax_output;
...
pub(in crate::backends::erlang::emit::syntax) fn collect_imported_module_member_functions(
...
pub(in crate::backends::erlang::emit::syntax) fn extend_receiver_methods_with_local_struct_includes(
...
pub(in crate::backends::erlang::emit::syntax) fn collect_syntax_typed_trait_method_wrappers(
    module: &SyntaxModuleOutput,
...
pub(in crate::backends::erlang::emit::syntax) fn collect_syntax_local_function_values(
    module: &SyntaxModuleOutput,
...
pub(in crate::backends::erlang::emit::syntax) fn infer_syntax_trait_dispatch_type(
...
pub(in crate::backends::erlang::emit::syntax) fn is_syntax_int_type_text(type_text: &str) -> bool {
    matches!(
...
///   `impl Ordering[Unit]`.
pub(in crate::backends::erlang::emit::syntax) fn normalize_syntax_trait_dispatch_type_key(
    type_text: &str,
) -> String {
...
pub(in crate::backends::erlang::emit::syntax) fn lower_syntax_function_env(
...
pub(in crate::backends::erlang::emit::syntax) fn lower_syntax_constructor_clause_env(
...
pub(in crate::backends::erlang::emit::syntax) fn lower_syntax_expr(
    expr: &SyntaxExprOutput,
    ctx: &SyntaxLowerCtx,
) -> Option<ErlExpr> {
...
pub(in crate::backends::erlang::emit::syntax) fn resolve_syntax_field_access_struct(
