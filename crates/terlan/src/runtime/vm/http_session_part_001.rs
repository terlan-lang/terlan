...
use super::actor::VmActorReceive;
...
use super::table::{VmTableAccess, VmTableEntry, VmTableEvent, VmTableId, VmTableStore};
use super::ReplValue;
...
#[derive(Clone, Debug, PartialEq)]
struct VmHttpSessionRecord {
    id: String,
    actor: VmProcessId,
    table: VmTableId,
    expires_at_tick: u64,
    state_version: u64,
    command_results: BTreeMap<String, ReplValue>,
    live_template_subscribers: BTreeMap<String, VmHttpSessionLiveTemplateSubscriber>,
}
...
pub struct VmHttpSessionRuntime {
    ...
    tables: VmTableStore,
    sessions: BTreeMap<String, VmHttpSessionRecord>,
    next_session_id: u64,
    now_tick: u64,
    ttl_ticks: u64,
    node_id: String,
    recovery_policy: VmHttpSessionRecoveryPolicy,
    live_template_protocol: VmLiveTemplateProtocolManifest,
}
