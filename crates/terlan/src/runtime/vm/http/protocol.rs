use super::*;
pub(crate) use crate::runtime::vm::http_metrics::VmHttpQueueMetrics;

#[path = "deadline.rs"]
pub(crate) mod deadline;
#[path = "lifecycle.rs"]
pub(crate) mod lifecycle;
#[path = "lifecycle_hooks.rs"]
mod lifecycle_hooks;
#[path = "overload.rs"]
pub(crate) mod overload;
#[path = "request_resources.rs"]
pub(crate) mod request_resources;
#[path = "response_memory.rs"]
mod response_memory;
...
pub(crate) struct VmHttpTcpHandler {
    ...
    pub(super) tls_stream: Option<VmTlsTcpServerStream>,
}
...
pub(crate) struct VmHttpTcpServer {
    ...
    pub(crate) handlers: Vec<VmHttpTcpHandler>,
    pub(super) next_handler_index: usize,
...
#[path = "protocol/exchange.rs"]
mod exchange;
#[path = "protocol/server_runtime.rs"]
mod server_runtime;
