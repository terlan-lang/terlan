...
#[test]
pub(super) fn memory_bulk_shared_release_validates_every_allocation_before_mutation() {
...
#[test]
pub(super) fn memory_process_exit_releases_shared_references_and_preserves_other_owners() {
    let mut processes = VmProcessTable::default();
    let owner = processes.spawn_root(source());
...
#[test]
pub(super) fn memory_accounting_soak_preserves_ownership_and_writes_benchmark_report() {
