...
#[test]
fn supervision_system_propagates_child_supervisor_failure_to_parent_snapshot() {
...
#[test]
fn supervision_system_tolerates_removed_parent_during_child_failure() {
    let mut processes = VmProcessTable::default();
    let mut supervision = VmSupervisionSystem::default();
    let parent = supervision.create_supervisor("root");
    let child_supervisor = supervision
...
#[test]
fn supervision_system_records_restart_history_for_restart_and_limit() {
    let mut processes = VmProcessTable::default();
    let mut supervision = VmSupervisionSystem::default();
...
#[test]
fn supervision_system_records_restart_history_for_non_restartable_child() {
    let mut processes = VmProcessTable::default();
    let mut supervision = VmSupervisionSystem::default();
    let supervisor = supervision.create_supervisor("root");
    let child = supervision
...
#[test]
fn supervision_system_rejects_missing_child_supervisor_parent() {
    let mut supervision = VmSupervisionSystem::default();
    let missing = super::VmSupervisorId(99);
...
#[test]
fn supervision_group_policies_report_missing_child() {
    let mut processes = VmProcessTable::default();
    let mut supervision = VmSupervisionSystem::default();
...
#[test]
fn supervision_system_reports_missing_process_instead_of_panicking_on_restart() {
    let mut processes = VmProcessTable::default();
