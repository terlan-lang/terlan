...
#[test]
fn vm_http_tcp_server_poll_with_tls_allows_plaintext_transport() {
...
#[test]
fn vm_http_tcp_server_poll_with_tls_handles_encrypted_transport() {
...
#[test]
fn vm_http_tcp_server_poll_with_tls_normalizes_cursor_after_closing_last_handler() {
...
#[test]
fn vm_http_tcp_server_keep_alive_with_tls_allows_plaintext_transport() {
    let mut processes = VmProcessTable::default();
    let mut tcp = VmTcpRuntime::new();
...
#[test]
fn vm_http_tcp_server_keep_alive_with_tls_handles_encrypted_transport() {
...
#[test]
fn vm_http_tcp_server_keep_alive_with_tls_honors_connection_close_request() {
...
#[test]
fn vm_http_tcp_server_keep_alive_with_tls_limits_preserves_scheduler_budgets() {
    let mut processes = VmProcessTable::default();
    let mut tcp = VmTcpRuntime::new();
...
#[test]
fn vm_http_tcp_server_keep_alive_with_tls_rejects_zero_limits_and_reports_idle() {
    let mut processes = VmProcessTable::default();
    let mut tcp = VmTcpRuntime::new();
    ...
    assert_eq!(idle, super::VmHttpTcpServerPoll::default());
    assert_eq!(server.active_handlers(), 0);
}

#[test]
fn vm_http_tcp_server_keep_alive_with_tls_rejects_zero_limits_and_reports_encrypted_idle() {
...
#[test]
fn vm_http_tcp_server_keep_alive_with_tls_rejects_handler_without_tls_state() {
...
#[test]
fn vm_http_tcp_server_keep_alive_with_tls_accept_limit_preserves_accept_budget() {
    let mut processes = VmProcessTable::default();
    let mut tcp = VmTcpRuntime::new();
...
#[test]
fn vm_http_tcp_server_keep_alive_with_tls_accept_limit_handles_encrypted_transport() {
...
#[test]
fn vm_http_tcp_server_keep_alive_with_tls_limits_handles_encrypted_transport() {
...
#[test]
fn vm_http_tcp_server_keep_alive_with_tls_skips_blocked_encrypted_handler() {
...
#[test]
fn vm_http_tcp_server_keep_alive_with_tls_rejects_missing_retained_handler_process() {
    let (dir, cert_path, key_path, _cert_der) =
...
#[test]
fn vm_http_tcp_server_keep_alive_with_tls_reports_ready_when_more_encrypted_bytes_are_queued() {
