...
///   it.
#[test]
pub(super) fn vm_websocket_upgrade_response_serializes_http1_switching_protocols() {
    let response =
...
#[test]
pub(super) fn vm_websocket_upgrade_response_serialization_rejects_invalid_metadata() {
    assert_eq!(
...
#[test]
pub(super) fn vm_websocket_runtime_send_upgrade_response_writes_to_peer() {
...
#[test]
pub(super) fn vm_websocket_runtime_send_upgrade_response_rejects_closed_stream() {
...
#[test]
pub(super) fn vm_websocket_runtime_send_tls_upgrade_response_writes_to_peer() {
...
///   incorrectly.
#[test]
pub(super) fn vm_websocket_runtime_send_tls_upgrade_response_rejects_stream_mismatch() {
    let (dir, cert_path, key_path, cert_der) =
...
#[test]
pub(super) fn vm_websocket_runtime_session_for_stream_returns_bound_session() {
    let mut tcp = VmTcpRuntime::new();
...
#[test]
pub(super) fn vm_websocket_runtime_session_for_stream_is_deterministic_for_duplicate_raw_bindings()
{
...
///   WebSocket close.
#[test]
pub(super) fn vm_websocket_runtime_remove_session_for_stream_detaches_without_sending_close() {
    let mut tcp = VmTcpRuntime::new();
...
#[test]
pub(super) fn vm_websocket_runtime_remove_session_for_stream_ignores_unbound_stream() {
    let mut tcp = VmTcpRuntime::new();
...
#[test]
pub(super) fn vm_websocket_runtime_remove_inactive_stream_sessions_prunes_closed_and_cancelled_streams(
) {
    let mut tcp = VmTcpRuntime::new();
...
#[test]
pub(super) fn vm_websocket_runtime_remove_inactive_stream_sessions_rejects_invalid_stream_without_partial_prune(
) {
    let mut tcp = VmTcpRuntime::new();
...
#[test]
pub(super) fn vm_websocket_runtime_sends_by_session_handle() {
    let (mut tcp, client, server) = connected_tcp_pair();
    let mut runtime = VmWebSocketRuntime::new();
...
#[test]
pub(super) fn vm_websocket_runtime_sends_frame_to_selected_sessions() {
    let mut tcp = VmTcpRuntime::new();
...
#[test]
pub(super) fn vm_websocket_runtime_fanout_rejects_invalid_sets_without_partial_send() {
    let mut tcp = VmTcpRuntime::new();
...
#[test]
pub(super) fn vm_websocket_runtime_best_effort_fanout_reports_partial_results() {
    let mut tcp = VmTcpRuntime::new();
...
#[test]
pub(super) fn vm_websocket_runtime_best_effort_fanout_reports_duplicates() {
    let (mut tcp, client, server) = connected_tcp_pair();
    let mut runtime = VmWebSocketRuntime::new();
    let session = runtime.open_session(server);
