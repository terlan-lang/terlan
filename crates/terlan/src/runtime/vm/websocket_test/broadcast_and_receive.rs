...
///   are attached.
#[test]
pub(super) fn vm_websocket_runtime_broadcast_to_all_open_sessions_is_empty_for_empty_runtime() {
...
#[test]
pub(super) fn vm_websocket_runtime_broadcast_to_all_open_sessions_skips_closed_sessions() {
    let mut tcp = VmTcpRuntime::new();
...
#[test]
pub(super) fn vm_websocket_runtime_receive_from_all_open_sessions_is_empty_for_empty_runtime() {
    let mut tcp = VmTcpRuntime::new();
    let mut runtime = VmWebSocketRuntime::new();
...
#[test]
pub(super) fn vm_websocket_runtime_receive_from_all_open_sessions_skips_closed_sessions() {
    let mut tcp = VmTcpRuntime::new();
...
#[test]
pub(super) fn vm_websocket_runtime_receive_from_all_open_sessions_with_auto_pong_replies_to_ping() {
    let mut tcp = VmTcpRuntime::new();
...
#[test]
pub(super) fn vm_websocket_runtime_receives_first_frame_from_selected_sessions() {
    let mut tcp = VmTcpRuntime::new();
...
///   validation errors.
#[test]
pub(super) fn vm_websocket_runtime_group_receive_rejects_invalid_sets_without_consuming() {
    let mut tcp = VmTcpRuntime::new();
...
#[test]
pub(super) fn vm_websocket_runtime_group_receive_with_auto_pong_replies_to_selected_ping() {
    let mut tcp = VmTcpRuntime::new();
...
#[test]
pub(super) fn vm_websocket_runtime_inspect_reports_empty_state() {
...
#[test]
pub(super) fn vm_websocket_runtime_inspect_aggregates_session_state() {
    let mut tcp = VmTcpRuntime::new();
...
#[test]
pub(super) fn vm_websocket_runtime_inspect_sessions_reports_empty_state() {
    let runtime = VmWebSocketRuntime::new();
...
#[test]
pub(super) fn vm_websocket_runtime_inspect_sessions_returns_sorted_snapshots() {
    let mut tcp = VmTcpRuntime::new();
...
#[test]
pub(super) fn vm_websocket_runtime_receive_frame_with_auto_pong_replies_by_handle() {
...
#[test]
pub(super) fn vm_websocket_runtime_removes_only_closed_sessions() {
    let mut tcp = VmTcpRuntime::new();
...
#[test]
pub(super) fn vm_websocket_runtime_remove_closed_sessions_is_empty_when_all_open() {
...
#[test]
pub(super) fn vm_websocket_runtime_remove_closed_sessions_can_close_tcp_streams() {
    let mut tcp = VmTcpRuntime::new();
...
///   failure surface.
#[test]
pub(super) fn vm_websocket_runtime_remove_closed_sessions_reports_invalid_stream_close() {
    let mut tcp = VmTcpRuntime::new();
    let mut runtime = VmWebSocketRuntime::new();
...
#[test]
pub(super) fn vm_websocket_runtime_tcp_closing_cleanup_is_empty_when_all_open() {
