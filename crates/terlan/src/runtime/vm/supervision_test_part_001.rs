...
#[test]
fn restart_backoff_zero_inputs_disable_delay() {
    assert_eq!(
...
fn restarted_event(restart: &VmSupervisionRestart) -> Option<(VmProcessId, VmProcessId, u32)> {
    match restart {
...
#[test]
fn supervision_system_restarts_all_children_for_one_for_all_policy() {
    let mut processes = VmProcessTable::default();
    let mut supervision = VmSupervisionSystem::default();
...
#[test]
fn supervision_system_one_for_all_enforces_restart_limit_before_group_restart() {
    let mut processes = VmProcessTable::default();
    let mut supervision = VmSupervisionSystem::default();
    let supervisor = supervision.create_supervisor_with_policy("root", VmRestartPolicy::OneForAll);
    let first = supervision
...
#[test]
fn supervision_system_restarts_failed_and_later_children_for_rest_for_one_policy() {
    let mut processes = VmProcessTable::default();
    let mut supervision = VmSupervisionSystem::default();
...
#[test]
fn supervision_system_rest_for_one_enforces_restart_limit_before_group_restart() {
    let mut processes = VmProcessTable::default();
    let mut supervision = VmSupervisionSystem::default();
    let supervisor = supervision.create_supervisor_with_policy("root", VmRestartPolicy::RestForOne);
    let first = supervision
...
#[test]
fn supervision_system_temporary_child_never_restarts() {
    let mut processes = VmProcessTable::default();
    let mut supervision = VmSupervisionSystem::default();
    let supervisor = supervision.create_supervisor("root");
    let child = supervision
...
#[test]
fn supervision_system_transient_child_restarts_only_after_abnormal_exit() {
    let mut processes = VmProcessTable::default();
    let mut supervision = VmSupervisionSystem::default();
    let supervisor = supervision.create_supervisor("root");
...
#[test]
fn supervision_system_group_restart_skips_non_restartable_children_without_blocking_restartable_siblings(
) {
    let mut processes = VmProcessTable::default();
    let mut supervision = VmSupervisionSystem::default();
    let supervisor = supervision.create_supervisor_with_policy("root", VmRestartPolicy::OneForAll);
...
#[test]
fn supervision_system_applies_exponential_restart_backoff_for_one_for_one_policy() {
    let mut processes = VmProcessTable::default();
    let mut supervision = VmSupervisionSystem::default();
    let supervisor = supervision.create_supervisor("root");
    let child = supervision
...
#[test]
fn supervision_system_group_restart_reports_per_child_backoff_delays() {
    let mut processes = VmProcessTable::default();
    let mut supervision = VmSupervisionSystem::default();
    let supervisor = supervision.create_supervisor_with_policy("root", VmRestartPolicy::OneForAll);
    let first = supervision
...
#[test]
fn supervision_system_records_shutdown_timeout_for_live_child_restart() {
    let mut processes = VmProcessTable::default();
    let mut supervision = VmSupervisionSystem::default();
    let supervisor = supervision.create_supervisor("root");
...
#[test]
fn supervision_system_group_restart_reports_per_child_shutdown_timeouts() {
    let mut processes = VmProcessTable::default();
    let mut supervision = VmSupervisionSystem::default();
    let supervisor = supervision.create_supervisor_with_policy("root", VmRestartPolicy::OneForAll);
    let first = supervision
...
#[test]
fn supervision_system_records_supervisor_failure_when_restart_limit_escalates() {
    let mut processes = VmProcessTable::default();
    let mut supervision = VmSupervisionSystem::default();
    let supervisor = supervision.create_supervisor("root");
    let child = supervision
