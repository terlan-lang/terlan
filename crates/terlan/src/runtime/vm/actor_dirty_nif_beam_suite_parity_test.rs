...
use super::super::process::{VmProcessSource, VmProcessState};
use super::{ReplValue, VmActorReceive, VmActorRuntime};
...
fn dirty_nif_suite_registry_burst_routes_exactly_once_and_cleans_stale_names() {
    ...
    runtime
        .exit_actor(retired, super::super::process::VmExitReason::Normal)
    ...
    runtime
        .exit_actor(owner, super::super::process::VmExitReason::Killed)
