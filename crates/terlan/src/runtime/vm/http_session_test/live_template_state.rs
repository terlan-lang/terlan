...
#[test]
pub(super) fn http_session_binds_typed_live_template_to_actor_state() {
    let mut sessions =
...
#[test]
pub(super) fn http_session_traces_live_template_subscription_source_map() {
    let mut sessions =
        VmHttpSessionRuntime::new("node-a", 10).expect("session runtime should create");
    let created = sessions.lookup_or_create(None).expect("create session");
...
#[test]
pub(super) fn http_session_live_template_state_update_fans_out_to_all_subscribers() {
    let mut sessions =
        VmHttpSessionRuntime::new("node-a", 10).expect("session runtime should create");
    let created = sessions.lookup_or_create(None).expect("create session");
...
#[test]
pub(super) fn http_session_live_template_state_update_rejects_int_overflow() {
    let mut sessions =
        VmHttpSessionRuntime::new("node-a", 10).expect("session runtime should create");
    let created = sessions.lookup_or_create(None).expect("create session");
    sessions
...
#[test]
pub(super) fn http_session_state_update_rejects_stale_concurrent_writer() {
    let mut sessions =
        VmHttpSessionRuntime::new("node-a", 10).expect("session runtime should create");
    let created = sessions.lookup_or_create(None).expect("create session");
    let observed_version = sessions
...
#[test]
pub(super) fn http_session_persistence_snapshot_replays_after_restart() {
    let mut sessions =
        VmHttpSessionRuntime::new("node-a", 10).expect("session runtime should create");
    let created = sessions.lookup_or_create(None).expect("create session");
...
#[test]
pub(super) fn http_session_persistence_rejects_blank_ids_and_accepts_external_ids() {
...
#[test]
pub(super) fn http_session_reports_normal_and_missing_actor_exit_reasons() {
    let mut sessions =
        VmHttpSessionRuntime::new("node-a", 10).expect("session runtime should create");
    let created = sessions.lookup_or_create(None).expect("create session");
    let actor = sessions.sessions.get("s1").expect("session record").actor;
...
#[test]
pub(super) fn http_session_actor_mailbox_backpressure_is_attributed() {
    let mut sessions =
        VmHttpSessionRuntime::new("node-a", 10).expect("session runtime should create");
    let created = sessions.lookup_or_create(None).expect("create session");
...
#[test]
pub(super) fn http_session_migrates_durable_state_across_workers() {
    let mut source = VmHttpSessionRuntime::new("node-a", 10).expect("source runtime should create");
    let created = source.lookup_or_create(None).expect("create session");
    source
        .write(
    ...
    assert_eq!(
        ...
        VmHttpSessionWorkerMigration {
            ...
            destination_route: destination.snapshots().into_iter().next().map_or_else(
                ...
                |snapshot| super::super::VmHttpSessionRoute {
...
#[test]
pub(super) fn http_session_reports_hot_reload_migration_compatibility() {
    let mut sessions =
        VmHttpSessionRuntime::new("node-a", 10).expect("session runtime should create");
    let created = sessions.lookup_or_create(None).expect("create session");
...
#[test]
pub(super) fn http_session_rotate_changes_cookie_without_losing_actor_state() {
    let mut sessions =
        VmHttpSessionRuntime::new("node-a", 10).expect("session runtime should create");
    let created = sessions.lookup_or_create(None).expect("create session");
    sessions
...
#[test]
pub(super) fn http_session_expiration_cleans_actor_table_and_reports_stale() {
    let mut sessions =
...
#[test]
pub(super) fn http_session_recovery_policy_can_fail_closed_for_stale_cookie() {
...
#[test]
pub(super) fn http_session_rejects_invalid_runtime_configuration() {
    assert_eq!(
