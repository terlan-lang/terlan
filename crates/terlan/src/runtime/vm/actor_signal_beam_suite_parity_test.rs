use super::super::process::{VmExitReason, VmMessagePriority, VmProcessSource, VmProcessState};
use super::super::process_alias::VmProcessAliasOptions;
use super::super::scheduler::{VmSchedulerDecision, VmSchedulerOutcome};
use super::super::ReplValue;
use super::actor_exit::VmActorExitSignalOutcome;
...
fn receive_payload(
    ...
    recipient: super::super::process::VmProcessId,
) -> ReplValue {
