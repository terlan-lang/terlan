...
#[test]
fn timer_table_rejects_cancellation_token_from_another_owner() {
...
#[test]
fn timer_table_covers_all_late_interval_overflow_boundaries() {
...
#[test]
fn timer_table_reports_overflow_for_late_interval_before_next_boundary() {
    let mut processes = VmProcessTable::default();
...
#[test]
fn timer_event_mailbox_encoding_covers_every_outcome() {
...
#[test]
fn timer_table_allows_nested_timer_at_current_monotonic_tick() {
    let mut processes = VmProcessTable::default();
...
#[test]
fn timer_table_rejects_backward_clock_without_losing_pending_timer() {
    let mut processes = VmProcessTable::default();
...
#[test]
fn timer_table_delivers_typed_outcomes_to_live_owner_mailbox() {
    let mut processes = VmProcessTable::default();
...
#[test]
fn timer_table_does_not_deliver_owner_exited_outcome_to_dead_mailbox() {
    let mut processes = VmProcessTable::default();
...
#[test]
fn timer_table_writes_deadline_report_from_runtime_events() {
    let mut processes = VmProcessTable::default();
...
#[test]
fn timer_table_reports_deadline_report_directory_and_write_failures() {
