...
#[test]
pub(super) fn vm_http_tcp_server_shutdown_with_tls_removes_listener_plan() {
...
#[test]
pub(super) fn vm_http_tcp_server_noop_poll_and_empty_shutdown_are_stable() {
    let mut processes = VmProcessTable::default();
    let mut tcp = VmTcpRuntime::new();
    let listener = tcp.listen("http.local").expect("listen");
    let mut server = VmHttpTcpServer::new(listener, source("handle"));
...
#[test]
pub(super) fn vm_http_tcp_server_inspects_listener_pressure_and_handler_counters() {
    let mut processes = VmProcessTable::default();
...
#[test]
pub(super) fn vm_http_tcp_server_propagates_handler_errors_without_finishing_handler() {
    let mut processes = VmProcessTable::default();
    let mut tcp = VmTcpRuntime::new();
    let listener = tcp.listen("http.local").expect("listen");
...
#[test]
pub(super) fn vm_http_tcp_server_keep_alive_reports_half_closed_truncated_body() {
    let mut processes = VmProcessTable::default();
    let mut tcp = VmTcpRuntime::new();
    let listener = tcp.listen("http.local").expect("listen");
    let client = tcp.connect("http.local", "client").expect("connect");
...
#[test]
pub(super) fn vm_http_tcp_server_keep_alive_reports_half_closed_partial_headers() {
    let mut processes = VmProcessTable::default();
    let mut tcp = VmTcpRuntime::new();
    let listener = tcp.listen("http.local").expect("listen");
    let client = tcp.connect("http.local", "client").expect("connect");
...
#[test]
pub(super) fn vm_http_tcp_server_reports_missing_retained_handler_process() {
    let mut processes = VmProcessTable::default();
    let mut tcp = VmTcpRuntime::new();
    let listener = tcp.listen("http.local").expect("listen");
...
#[test]
pub(super) fn vm_http_tcp_server_cancel_adjusts_round_robin_cursor_edges() {
    let mut processes = VmProcessTable::default();
    let mut tcp = VmTcpRuntime::new();
    let listener = tcp.listen("http.local").expect("listen");
    let first_client = tcp.connect("http.local", "first").expect("first");
...
#[test]
pub(super) fn vm_http_tcp_read_stream_handles_empty_buffer_and_eof() {
    let mut tcp = VmTcpRuntime::new();
    let listener = tcp.listen("http.local").expect("listen");
...
#[test]
pub(super) fn vm_http_tcp_actor_poll_returns_ready_when_stream_has_more_data_before_parking() {
    let mut processes = VmProcessTable::default();
...
#[test]
pub(super) fn vm_http_tcp_server_retains_ready_handler_without_parking() {
    let mut processes = VmProcessTable::default();
    let mut tcp = VmTcpRuntime::new();
    let listener = tcp.listen("http.local").expect("listen");
    let client = tcp.connect("http.local", "client").expect("connect");
...
#[test]
pub(super) fn vm_http_buffer_parser_reports_incomplete_limit_edges() {
    ...
    assert_eq!(
        super::super::try_parse_http1_request_buffer(&oversized_header)
            .expect_err("oversized incomplete header should fail"),
        "VM HTTP request exceeded 64 KiB header limit"
    );
    assert_eq!(
        super::super::try_parse_http1_request_buffer(oversized_body.as_bytes())
