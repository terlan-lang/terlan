...
#[test]
pub(super) fn vm_http_accepts_tcp_stream_into_handler_process_state() {
...
#[test]
pub(super) fn vm_http_finishes_tcp_handler_by_closing_stream_and_exiting_process() {
    let mut processes = VmProcessTable::default();
    let mut tcp = VmTcpRuntime::new();
    let listener = tcp.listen("http.local").expect("listen");
    let client = tcp.connect("http.local", "client").expect("connect");
...
#[test]
pub(super) fn vm_http_finishes_cancelled_tcp_handler_with_error_reason() {
    let mut processes = VmProcessTable::default();
    let mut tcp = VmTcpRuntime::new();
    let listener = tcp.listen("http.local").expect("listen");
...
#[test]
pub(super) fn vm_http_tcp_server_polls_runnable_handlers_and_skips_parked_handlers() {
    let mut processes = VmProcessTable::default();
...
#[test]
pub(super) fn vm_http_tcp_server_keep_alive_reuses_handler_for_pipelined_requests() {
    let mut processes = VmProcessTable::default();
    let mut tcp = VmTcpRuntime::new();
    let listener = tcp.listen("http.local").expect("listen");
    let client = tcp.connect("http.local", "client").expect("connect");
...
#[test]
pub(super) fn vm_http_tcp_server_keep_alive_parks_idle_handler_and_wakes_on_later_request() {
    let mut processes = VmProcessTable::default();
    let mut scheduler = VmScheduler::new(VmSchedulerConfig::new(10, 10));
    let mut tcp = VmTcpRuntime::new();
    let listener = tcp.listen("http.local").expect("listen");
...
#[test]
pub(super) fn vm_http_tcp_server_keep_alive_accept_limit_bounds_accept_work_per_poll() {
    let mut processes = VmProcessTable::default();
    let mut tcp = VmTcpRuntime::new();
    let listener = tcp.listen("http.local").expect("listen");
...
#[test]
pub(super) fn vm_http_tcp_server_keep_alive_handler_limit_bounds_handler_work_per_poll() {
    let mut processes = VmProcessTable::default();
    let mut tcp = VmTcpRuntime::new();
    let listener = tcp.listen("http.local").expect("listen");
    let first_client = tcp.connect("http.local", "first").expect("first");
...
#[test]
pub(super) fn vm_http_tcp_server_keep_alive_handler_budget_uses_round_robin_cursor() {
    let mut processes = VmProcessTable::default();
    let mut tcp = VmTcpRuntime::new();
    let listener = tcp.listen("http.local").expect("listen");
    let first_client = tcp.connect("http.local", "first").expect("first");
...
#[test]
pub(super) fn vm_http_tcp_server_keep_alive_honors_connection_close_request() {
    let mut processes = VmProcessTable::default();
    let mut tcp = VmTcpRuntime::new();
    let listener = tcp.listen("http.local").expect("listen");
    let client = tcp.connect("http.local", "client").expect("connect");
...
#[test]
pub(super) fn vm_http_tcp_server_cancels_parked_handler_and_closes_stream() {
    let mut processes = VmProcessTable::default();
    let mut tcp = VmTcpRuntime::new();
    let listener = tcp.listen("http.local").expect("listen");
    let client = tcp.connect("http.local", "client").expect("connect");
...
#[test]
pub(super) fn vm_http_tcp_server_shutdown_closes_listener_and_active_handlers() {
    let mut processes = VmProcessTable::default();
    let mut tcp = VmTcpRuntime::new();
    let listener = tcp.listen("http.local").expect("listen");
    let first_client = tcp.connect("http.local", "first").expect("first");
