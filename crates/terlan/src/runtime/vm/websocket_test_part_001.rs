...
use tungstenite::protocol::{frame::Frame, Message, Role, WebSocket};

use crate::runtime::vm::tcp::VmTcpRuntime;
use crate::runtime::vm::tls::{VmTlsMode, VmTlsPlan, VmTlsRuntime, VmTlsTcpServerStream};
...
#[test]
fn vm_websocket_upgrade_response_uses_tungstenite_accept_key() {
    let response =
...
#[test]
fn vm_websocket_upgrade_response_rejects_blank_key() {
...
#[test]
fn vm_websocket_adapter_frame_constructors_build_typed_frames() {
    assert_eq!(
...
#[test]
fn vm_websocket_adapter_endpoint_validates_channel_limits() {
    assert_eq!(
    ...
    assert_eq!(
        endpoint(0, 4096).expect_err("zero pending frames"),
        "error[vm_websocket_endpoint]: max_pending_frames must be greater than 0"
    );
    assert_eq!(
        endpoint(16, 0).expect_err("zero frame bytes"),
...
#[test]
fn vm_websocket_endpoint_opens_bounded_inbound_queue() {
...
///   contract.
#[test]
fn vm_websocket_inbound_queue_preserves_order_and_pressure() {
...
#[test]
fn vm_websocket_inbound_queue_rejects_full_and_oversized_frames() {
...
#[test]
fn vm_websocket_endpoint_declares_binary_payload_rejection_policy() {
...
#[test]
fn vm_websocket_decodes_tungstenite_client_text_frame() {
...
#[test]
fn vm_websocket_encodes_server_text_frame_for_tungstenite_client() {
...
///   to tungstenite.
#[test]
fn vm_websocket_rejects_malformed_text_frame_with_stable_error() {
...
#[test]
fn vm_websocket_receives_client_text_frame_over_vm_tcp() {
...
#[test]
fn vm_websocket_sends_server_text_frame_over_vm_tcp() {
    let (mut tcp, client, server) = connected_tcp_pair();
...
#[test]
fn vm_websocket_receive_over_vm_tcp_reports_none_for_empty_stream() {
...
#[test]
fn vm_websocket_receive_over_vm_tcp_wraps_transport_receive_errors() {
    let (mut tcp, _client, server) = connected_tcp_pair();
...
///   WebSocket handlers.
#[test]
fn vm_websocket_send_over_vm_tcp_wraps_transport_send_errors() {
    let (mut tcp, _client, server) = connected_tcp_pair();
...
///   control events.
#[test]
fn vm_websocket_decodes_client_ping_control_frame() {
...
#[test]
fn vm_websocket_decodes_client_pong_control_frame() {
...
#[test]
fn vm_websocket_text_reader_rejects_ping_frame() {
...
///   behavior.
#[test]
fn vm_websocket_encodes_server_pong_control_frame_for_tungstenite_client() {
...
#[test]
fn vm_websocket_decodes_client_close_control_frame() {
...
#[test]
fn vm_websocket_control_reader_rejects_text_frame() {
...
#[test]
fn vm_websocket_decode_client_frame_accepts_text_and_control() {
...
#[test]
fn vm_websocket_decode_client_frame_rejects_binary_frame() {
    let err =
        decode_client_frame(&encode_client_binary_frame(&[1, 2, 3])).expect_err("binary rejection");
...
#[test]
fn vm_websocket_low_level_helpers_cover_control_and_error_edges() {
    let server_ping =
...
#[test]
fn vm_websocket_receives_client_control_frame_over_vm_tcp() {
    let (mut tcp, client, server) = connected_tcp_pair();
...
#[test]
fn vm_websocket_sends_server_control_frame_over_vm_tcp() {
    let (mut tcp, client, server) = connected_tcp_pair();
