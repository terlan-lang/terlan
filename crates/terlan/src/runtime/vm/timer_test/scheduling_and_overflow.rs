...
use super::super::{VmTimerEvent, VmTimerKind, VmTimerTable};
...
#[test]
pub(super) fn timer_table_starts_one_shot_timer_and_exposes_snapshot() {
...
#[test]
pub(super) fn timer_table_interval_timer_fires_and_reschedules() {
    let mut processes = VmProcessTable::default();
...
#[test]
pub(super) fn timer_table_coalesces_late_interval_timer_and_reschedules_after_skipped_deadlines() {
    let mut processes = VmProcessTable::default();
    let owner = processes.spawn_root(source("interval"));
    let mut scheduler = VmScheduler::new(VmSchedulerConfig::new(10, 100));
    let mut timers = VmTimerTable::default();
...
#[test]
pub(super) fn timer_table_reports_overflow_when_interval_reschedule_exceeds_tick_range() {
    let mut processes = VmProcessTable::default();
    let owner = processes.spawn_root(source("interval"));
    let mut scheduler = VmScheduler::new(VmSchedulerConfig::new(10, 100));
    let mut timers = VmTimerTable::default();
...
#[test]
pub(super) fn timer_table_reports_overflow_when_late_interval_coalescing_exceeds_tick_range() {
    let mut processes = VmProcessTable::default();
    let owner = processes.spawn_root(source("interval"));
    let mut scheduler = VmScheduler::new(VmSchedulerConfig::new(10, 100));
    let mut timers = VmTimerTable::default();
...
#[test]
pub(super) fn timer_table_reports_deadline_missed_for_late_interval_before_next_interval_boundary()
{
    let mut processes = VmProcessTable::default();
    let owner = processes.spawn_root(source("interval"));
    let mut scheduler = VmScheduler::new(VmSchedulerConfig::new(10, 100));
...
#[test]
pub(super) fn timer_table_rejects_zero_interval_timer_without_installing_snapshot() {
    let mut processes = VmProcessTable::default();
    let owner = processes.spawn_root(source("interval"));
    let mut timers = VmTimerTable::default();
...
#[test]
pub(super) fn timer_table_cancels_timer_and_reports_missing_timer() {
    let mut processes = VmProcessTable::default();
    let owner = processes.spawn_root(source("owner"));
    let mut timers = VmTimerTable::default();
    let timer = timers
...
#[test]
pub(super) fn timer_table_reports_owner_exited_for_owner_timer_cleanup_in_stable_order() {
    let mut processes = VmProcessTable::default();
    let owner = processes.spawn_root(source("owner"));
...
#[test]
pub(super) fn timer_table_distinguishes_manual_cancel_from_owner_exit_cleanup() {
    let mut processes = VmProcessTable::default();
    let owner = processes.spawn_root(source("owner"));
    let mut timers = VmTimerTable::default();
    let manual = timers
...
#[test]
pub(super) fn timer_table_fires_due_timers_only_once() {
    let mut processes = VmProcessTable::default();
    let owner = processes.spawn_root(source("owner"));
    let mut scheduler = VmScheduler::new(VmSchedulerConfig::new(10, 100));
    let mut timers = VmTimerTable::default();
...
#[test]
pub(super) fn timer_table_reports_deadline_missed_for_late_one_shot_timer() {
    let mut processes = VmProcessTable::default();
    let owner = processes.spawn_root(source("owner"));
    let mut scheduler = VmScheduler::new(VmSchedulerConfig::new(10, 100));
    let mut timers = VmTimerTable::default();
...
#[test]
pub(super) fn timer_table_reports_owner_exited_if_due_timer_owner_exited_before_fire() {
    let mut processes = VmProcessTable::default();
    let owner = processes.spawn_root(source("owner"));
    let mut scheduler = VmScheduler::new(VmSchedulerConfig::new(10, 100));
    let mut timers = VmTimerTable::default();
...
#[test]
pub(super) fn timer_table_fires_equal_deadlines_in_timer_id_order() {
    let mut processes = VmProcessTable::default();
...
#[test]
pub(super) fn timer_table_receive_timeout_wakes_blocked_process() {
    let mut processes = VmProcessTable::default();
...
#[test]
pub(super) fn receive_timeout_survives_unmatched_message_and_scheduler_preemption() {
    let mut processes = VmProcessTable::default();
    let owner = processes.spawn_root(source("receiver"));
...
#[test]
pub(super) fn receive_timeout_zero_and_maximum_u32_deadlines_are_exact() {
    let mut processes = VmProcessTable::default();
...
#[test]
pub(super) fn receive_timeout_wakes_large_equal_deadline_batch_once_in_identity_order() {
...
#[test]
pub(super) fn timer_wakeup_keeps_exactly_one_scheduler_entry() {
    let mut processes = VmProcessTable::default();
    let owner = processes.spawn_root(source("receiver"));
    let mut scheduler = VmScheduler::new(VmSchedulerConfig::new(3, 100));
    let mut timers = VmTimerTable::default();
...
#[test]
pub(super) fn timer_wakeup_preserves_suspension_until_explicit_resume() {
    let mut processes = VmProcessTable::default();
...
#[test]
pub(super) fn timer_table_deadline_missed_receive_timeout_still_wakes_blocked_process() {
    let mut processes = VmProcessTable::default();
    let owner = processes.spawn_root(source("receiver"));
    let mut scheduler = VmScheduler::new(VmSchedulerConfig::new(3, 100));
    let mut timers = VmTimerTable::default();
...
#[test]
pub(super) fn timer_table_rejects_exited_process_owner() {
    let mut processes = VmProcessTable::default();
    let owner = processes.spawn_root(source("owner"));
    processes
...
#[test]
pub(super) fn timer_table_rejects_receive_timeout_deadline_overflow_without_blocking_owner() {
    let mut processes = VmProcessTable::default();
    let owner = processes.spawn_root(source("receiver"));
    let mut scheduler = VmScheduler::new(VmSchedulerConfig::new(10, 100));
    let mut timers = VmTimerTable::default();
...
#[test]
pub(super) fn timer_table_rejects_missing_process_owner() {
    let mut processes = VmProcessTable::default();
    let mut scheduler = VmScheduler::new(VmSchedulerConfig::new(10, 100));
...
#[test]
pub(super) fn timer_table_cancellation_token_wins_or_loses_delivery_race_deterministically() {
    let mut processes = VmProcessTable::default();
