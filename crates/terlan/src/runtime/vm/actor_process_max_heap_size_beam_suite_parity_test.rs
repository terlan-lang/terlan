use super::super::memory::{VmMemoryLimits, VmMemoryPressureOutcome};
use super::super::process::{VmExitReason, VmProcessId, VmProcessSource, VmProcessState};
use super::super::ReplValue;
use super::actor_heap_limit::{VmActorHeapLimitOutcome, VmActorHeapLimitPolicy};
        ...
        for allocation in ALLOCATION_PATHS {
            ...
            assert_eq!(
                ...
                VmActorHeapLimitOutcome {
                    pressure: super::super::memory::VmMemoryPressureDecision {
                        pid: target.as_u64(),
                        requested_bytes: 34,
                        previous_bytes: 200,
                        projected_bytes: 234,
