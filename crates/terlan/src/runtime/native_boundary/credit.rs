//! Credit accounting for NativeBoundary command/reply bridges.
//!
//! The VM/native bridge uses credits as a simple backpressure contract:
...
///
/// Transformation:
/// - Converts `0` to `1` so every NativeBoundary worker has at least one usable
