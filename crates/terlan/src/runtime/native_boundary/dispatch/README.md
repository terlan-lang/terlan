# NativeBoundary Dispatch Internals

This directory owns dispatch helpers for NativeBoundary calls. The implementation is
...
- `terlan_native_boundary`: owns native runtime surfaces.
