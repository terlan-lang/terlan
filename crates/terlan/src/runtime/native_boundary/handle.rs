//! Handle liveness and disposal for NativeBoundary resource registries.
//!
...
pub fn is_live(slot: HandleSlot, handle: NativeBoundaryHandle) -> bool {
...
pub fn dispose(slot: HandleSlot, handle: NativeBoundaryHandle) -> Option<HandleSlot> {
