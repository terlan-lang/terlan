...
#[test]
pub(super) fn emit_js_with_oxc_codegen_reprints_module_source() {
...
#[test]
pub(super) fn emit_core_module_with_oxc_codegen_emits_core_surface() {
    let source = "\
...
#[test]
pub(super) fn emit_core_module_with_oxc_codegen_falls_back_for_partial_if_expr() {
    let source = "\
...
///   expression.
#[test]
pub(super) fn emit_core_module_with_direct_oxc_ast_handles_literal_case_expr() {
    let source = "\
...
#[test]
pub(super) fn emit_core_module_with_direct_oxc_ast_handles_integer_literal_case_expr() {
    let source = "\
...
///   becomes a JavaScript strict-equality test.
#[test]
pub(super) fn emit_core_module_with_direct_oxc_ast_handles_float_literal_case_expr() {
    let source = "\
...
///   becomes a JavaScript strict-equality test.
#[test]
pub(super) fn emit_core_module_with_direct_oxc_ast_handles_string_literal_case_expr() {
    let source = "\
...
#[test]
pub(super) fn emit_core_module_with_direct_oxc_ast_handles_bool_literal_case_expr() {
    let source = "\
...
#[test]
pub(super) fn emit_core_module_with_oxc_codegen_falls_back_for_partial_case_expr() {
    let source = "\
...
#[test]
pub(super) fn emit_core_module_with_oxc_codegen_handles_guarded_case_expr() {
    let source = "\
...
#[test]
pub(super) fn emit_core_module_with_oxc_codegen_handles_destructuring_case_expr() {
    let source = "\
...
#[test]
pub(super) fn emit_core_module_with_direct_oxc_ast_handles_lambda_value() {
    let source = "\
...
///   call.
#[test]
pub(super) fn emit_core_module_with_direct_oxc_ast_handles_simple_list_comprehension() {
    let source = "\
...
#[test]
pub(super) fn emit_core_module_with_direct_oxc_ast_handles_ordered_list_comprehension_generators() {
    let source = "\
...
#[test]
pub(super) fn emit_core_module_with_direct_oxc_ast_handles_destructuring_list_comprehension() {
    let source = "\
...
///   `.filter(...).map(...)` pipeline.
#[test]
pub(super) fn emit_core_module_with_direct_oxc_ast_handles_guarded_list_comprehension() {
    let source = "\
...
#[test]
pub(super) fn emit_core_module_with_direct_oxc_ast_handles_guarded_destructuring_list_comprehension(
) {
    let source = "\
...
#[test]
pub(super) fn emit_core_module_with_direct_oxc_ast_handles_stacked_guarded_list_comprehension() {
    let source = "\
...
#[test]
pub(super) fn emit_core_module_with_oxc_codegen_falls_back_for_remote_call() {
    let source = "\
...
#[test]
pub(super) fn emit_core_module_with_oxc_codegen_rejects_remote_fun_ref_source_syntax() {
    let source = "\
