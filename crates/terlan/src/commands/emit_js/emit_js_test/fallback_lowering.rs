...
#[test]
pub(super) fn emit_core_module_with_oxc_codegen_falls_back_for_constructor_call() {
    let source = "\
...
///   command-facing facade preserves the JS stub fallback.
#[test]
pub(super) fn emit_core_module_with_oxc_codegen_falls_back_for_constructor_chain() {
    let source = "\
...
#[test]
pub(super) fn emit_core_module_with_oxc_codegen_falls_back_for_try_expr() {
    let source = "\
...
///   command-facing facade preserves the JS stub fallback.
#[test]
pub(super) fn emit_core_module_with_oxc_codegen_falls_back_for_quote_expr() {
    let source = "\
...
#[test]
pub(super) fn emit_core_module_with_oxc_codegen_falls_back_for_unquote_expr() {
    let source = "\
...
#[test]
pub(super) fn emit_core_module_with_oxc_codegen_falls_back_for_html_block_expr() {
    let source = "\
...
#[test]
pub(super) fn emit_core_module_with_direct_oxc_ast_handles_array_like_literals() {
    let source = "\
...
#[test]
pub(super) fn emit_core_module_with_direct_oxc_ast_handles_unary_negation() {
    let source = "\
...
#[test]
pub(super) fn emit_core_module_with_direct_oxc_ast_handles_list_cons() {
    let source = "\
...
#[test]
pub(super) fn emit_core_module_with_oxc_codegen_falls_back_for_index_trait_call() {
    let source = "\
...
///   subset.
#[test]
pub(super) fn emit_core_module_with_direct_oxc_ast_handles_map_literal() {
    let source = "\
...
#[test]
pub(super) fn emit_core_module_with_direct_oxc_ast_handles_field_access() {
    let source = "\
...
///   struct-value subset.
#[test]
pub(super) fn emit_core_module_with_direct_oxc_ast_handles_record_construct() {
    let source = "\
...
///   becomes JavaScript static member access.
#[test]
pub(super) fn emit_core_module_with_direct_oxc_ast_handles_record_access() {
    let source = "\
...
#[test]
pub(super) fn emit_core_module_with_direct_oxc_ast_handles_binary_operator_set() {
    let source = "\
...
#[test]
pub(super) fn emit_core_module_with_direct_oxc_ast_handles_named_call() {
    let source = "\
...
///   application.
#[test]
pub(super) fn emit_core_module_with_direct_oxc_ast_handles_function_value_call() {
    let source = "\
...
#[test]
pub(super) fn emit_core_module_with_direct_oxc_ast_handles_string_contains_intrinsic() {
    let source = "\
