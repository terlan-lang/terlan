use super::args::{ServeHandlerRuntime, DEFAULT_POLL_MS, DEFAULT_SERVE_HOST, DEFAULT_SERVE_PORT};
...
#[test]
fn parse_serve_args_accepts_release_check_config_alias() {
...
#[test]
fn parse_serve_args_accepts_explicit_web_root_host_port_and_handler_runtime() {
...
#[test]
fn parse_serve_args_rejects_explicit_beam_handler_runtime() {
...
#[test]
fn parse_serve_args_rejects_unknown_handler_runtime() {
    let err = parse_serve_args(
        &[
            "--handler-runtime".to_string(),
            "otp".to_string(),
...
#[test]
fn request_header_pairs_normalizes_hyper_headers_for_handler_request_maps() {
...
fn run_async_serve_test<T>(future: impl Future<Output = T>) -> T {
...
#[test]
fn hyper_request_handler_rejects_non_get_websocket_route_before_static_fallback() {
    run_async_serve_test(async {
...
#[test]
fn hyper_request_handler_heads_non_get_websocket_route_without_body() {
    run_async_serve_test(async {
...
#[test]
fn hyper_request_handler_reports_websocket_upgrade_required_before_static_fallback() {
    run_async_serve_test(async {
...
#[test]
fn hyper_request_handler_rejects_malformed_websocket_upgrade_before_static_fallback() {
    run_async_serve_test(async {
...
#[test]
fn hyper_request_handler_returns_websocket_upgrade_handshake() {
    run_async_serve_test(async {
...
#[test]
fn hyper_request_handler_serves_manifest_declared_static_assets_from_build_output() {
    run_async_serve_test(async {
