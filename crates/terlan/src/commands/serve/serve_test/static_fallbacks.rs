...
#[test]
pub(super) fn vm_stream_request_serves_static_index_fallback_without_hyper() {
...
#[test]
pub(super) fn vm_stream_head_static_index_fallback_omits_body_without_hyper() {
...
#[test]
pub(super) fn vm_stream_options_static_index_fallback_reports_get_head_allow_without_hyper() {
...
#[test]
pub(super) fn vm_stream_request_rejects_static_parent_path_without_hyper() {
...
#[test]
pub(super) fn vm_stream_request_rejects_unmatched_mutating_method_without_hyper() {
...
///   without going through Hyper.
#[test]
pub(super) fn vm_stream_options_static_asset_reports_get_head_allow_without_hyper() {
...
#[test]
pub(super) fn hyper_request_handler_recompiles_changed_managed_aot_module() {
...
#[test]
pub(super) fn hyper_request_handler_prefers_physical_static_asset_over_file_fallback() {
    run_async_serve_test(async {
...
#[test]
pub(super) fn hyper_request_handler_prefers_physical_static_asset_over_static_response_fallback() {
    run_async_serve_test(async {
...
#[test]
pub(super) fn hyper_request_handler_rejects_static_parent_path() {
    run_async_serve_test(async {
...
#[test]
pub(super) fn hyper_request_handler_streams_reload_sse_events() {
    run_async_serve_test(async {
...
#[test]
pub(super) fn hyper_request_handler_heads_reload_sse_without_opening_stream() {
    run_async_serve_test(async {
        let reload_hub = Arc::new(Mutex::new(Vec::new()));
...
#[test]
pub(super) fn hyper_request_handler_rejects_reload_sse_mutating_method() {
    run_async_serve_test(async {
        let response = handle_hyper_request(
...
#[test]
pub(super) fn hyper_request_handler_serves_acme_http01_challenge_from_auto_tls_cache() {
    run_async_serve_test(async {
...
#[test]
pub(super) fn hyper_request_handler_serves_acme_http01_head_without_body() {
    run_async_serve_test(async {
...
#[test]
pub(super) fn hyper_request_handler_returns_404_for_missing_acme_http01_challenge() {
    run_async_serve_test(async {
...
#[test]
pub(super) fn hyper_request_handler_rejects_invalid_acme_http01_token() {
    run_async_serve_test(async {
...
#[test]
pub(super) fn hyper_request_handler_keeps_acme_like_static_files_for_plain_http_package() {
    run_async_serve_test(async {
...
#[test]
pub(super) fn hyper_request_handler_omits_static_head_response_body() {
    run_async_serve_test(async {
...
#[test]
pub(super) fn hyper_request_handler_rejects_unmatched_mutating_method() {
    run_async_serve_test(async {
