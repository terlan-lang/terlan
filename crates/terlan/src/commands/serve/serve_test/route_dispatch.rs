...
#[test]
pub(super) fn vm_stream_request_dispatches_pattern_head_route_handler_without_hyper() {
  ...
  "handlers": [
    {
      "method": "GET",
      "route": "/api/users/{id:String}/files/:name",
      "module": "app.Api",
      "function": "show",
      "arity": 3,
      "source": {
...
#[test]
pub(super) fn vm_stream_request_reports_pattern_head_route_handler_miss_without_hyper() {
    clear_vm_handler_module_cache_for_test();
...
"#,
    ...
    assert!(response.contains("content-type: text/plain; charset=utf-8\r\n"));
    assert!(
        response.contains("error[if_clause]: no native if condition matched"),
        "{response}"
    );
...
#[test]
pub(super) fn vm_stream_head_request_falls_back_to_get_dynamic_handler_without_body() {
    clear_vm_handler_module_cache_for_test();
...
#[test]
pub(super) fn vm_stream_request_reports_dynamic_handler_runtime_error_without_hyper() {
    clear_vm_handler_module_cache_for_test();
...
#[test]
pub(super) fn vm_stream_request_prefers_dynamic_handler_over_file_fallback_without_hyper() {
    clear_vm_handler_module_cache_for_test();
...
#[test]
pub(super) fn vm_stream_request_prefers_dynamic_handler_over_static_response_fallback_without_hyper(
) {
    clear_vm_handler_module_cache_for_test();
...
#[test]
pub(super) fn vm_stream_request_serves_static_asset_without_hyper() {
...
#[test]
pub(super) fn vm_stream_request_serves_manifest_declared_static_assets_from_build_output_without_hyper(
) {
...
#[test]
pub(super) fn vm_stream_request_prefers_physical_static_asset_over_static_response_fallback_without_hyper(
) {
...
#[test]
pub(super) fn vm_stream_request_prefers_physical_static_asset_over_file_fallback_without_hyper() {
...
#[test]
pub(super) fn vm_stream_request_serves_reload_sse_handshake_without_hyper() {
...
#[test]
pub(super) fn vm_stream_sse_route_activates_materialized_router_middleware() {
    clear_vm_handler_module_cache_for_test();
