...
#[test]
fn hyper_request_handler_prefers_dynamic_handler_over_static_response_fallback() {
    run_async_serve_test(async {
...
#[test]
fn hyper_request_handler_executes_dynamic_handler_with_vm_runtime() {
    run_async_serve_test(async {
...
#[test]
fn vm_stream_request_executes_dynamic_handler_without_hyper() {
    clear_vm_handler_module_cache_for_test();
...
#[test]
fn vm_stream_request_activates_materialized_router_middleware_without_hyper() {
    clear_vm_handler_module_cache_for_test();
...
#[test]
fn vm_plain_http1_connection_serves_static_response_without_host_async_or_hyper() {
...
#[test]
fn vm_plain_http1_request_complete_tracks_declared_body_length() {
    assert!(
...
#[test]
fn vm_plain_http1_request_complete_rejects_invalid_content_length() {
    let message = vm_plain_http1_request_complete(
        b"POST /api HTTP/1.1\r\nHost: localhost\r\nContent-Length: nope\r\n\r\n",
    )
    .expect_err("invalid content length should fail");

    assert_eq!(message, "invalid VM plain HTTP content-length value");
}
...
#[test]
fn vm_stream_request_returns_bad_request_for_malformed_http_without_hyper() {
...
#[test]
fn vm_stream_request_returns_bad_request_for_incomplete_headers_without_hyper() {
...
#[test]
fn vm_stream_request_returns_bad_request_for_invalid_content_length_without_hyper() {
...
#[test]
fn vm_stream_request_returns_bad_request_for_oversized_body_without_hyper() {
...
#[test]
fn vm_stream_request_returns_bad_request_for_truncated_body_without_hyper() {
...
#[test]
fn vm_stream_request_passes_route_params_to_dynamic_handler_without_hyper() {
    clear_vm_handler_module_cache_for_test();
