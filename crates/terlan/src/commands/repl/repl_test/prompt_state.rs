...
#[test]
pub(super) fn repl_prompt_inputs_compare_persisted_integer_literal_binding() {
...
#[test]
pub(super) fn repl_json_event_without_extra_fields_is_valid_json() {
...
///   `serde_json`.
#[test]
pub(super) fn repl_json_event_with_extra_fields_is_valid_json() {
...
#[test]
pub(super) fn repl_load_sources_uses_project_manifest_source_roots() {
...
pub(super) fn make_repl_test_dir(label: &str) -> PathBuf {
