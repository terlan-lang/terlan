use super::migration::{
    applied_migration_from_history_row, discover_migration_files, duplicate_migration_id_message,
    load_migration_file, load_migration_files, migration_engine_inputs,
    migration_history_insert_sql, migration_history_select_sql, migration_history_table_sql,
    migration_status, parse_migration_file_name, pending_migration_engine_inputs,
    split_migration_sections, AppliedMigration, LoadedMigration, MigrationDiagnostic,
    MigrationFileName, MigrationStatusEntry, MigrationStatusState, MIGRATION_HISTORY_TABLE,
};
...
fn out_of_order_history_fixture(
    name: &str,
...
#[test]
fn migration_status_classifies_applied_pending_missing_and_checksum_mismatch() {
...
#[test]
fn migration_status_classifies_name_mismatch() {
...
#[test]
fn migration_status_classifies_gap_before_applied_history_as_out_of_order() {
...
#[test]
fn pending_migration_engine_inputs_rejects_out_of_order_history_gap() {
    let (directory, loaded, applied) =
...
#[test]
fn pending_migration_engine_inputs_rejects_checksum_mismatch() {
