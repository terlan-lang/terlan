use super::super::test_support::{remove_dir, temp_db_dir};
use super::super::{parse_db_command, run, DbCommand, DEFAULT_MIGRATION_DIR};
...
#[test]
pub(super) fn parse_db_command_accepts_init_default_directory() {
    assert_eq!(
...
#[test]
pub(super) fn parse_db_command_accepts_new_default_directory() {
    assert_eq!(
...
#[test]
pub(super) fn parse_db_command_accepts_new_custom_directory() {
    assert_eq!(
        parse_db_command(&[
            "new".to_string(),
...
#[test]
pub(super) fn parse_db_command_accepts_migrate_default_directory() {
    assert_eq!(
...
#[test]
pub(super) fn parse_db_command_accepts_migrate_custom_directory() {
    assert_eq!(
...
///   adapter is wired.
#[test]
pub(super) fn parse_db_command_accepts_migrate_database_url_and_directory() {
    assert_eq!(
        parse_db_command(&[
            "migrate".to_string(),
...
#[test]
pub(super) fn parse_db_command_accepts_rebuild_without_dev_for_later_rejection() {
    assert_eq!(
...
#[test]
pub(super) fn parse_db_command_accepts_rebuild_with_dev_and_directory() {
    assert_eq!(
        parse_db_command(&[
            "rebuild".to_string(),
            "--dev".to_string(),
...
#[test]
pub(super) fn parse_db_command_accepts_rebuild_database_url_and_directory() {
    assert_eq!(
        parse_db_command(&[
            "rebuild".to_string(),
            "--dev".to_string(),
...
#[test]
pub(super) fn parse_db_command_accepts_reset_with_dev_and_directory() {
    assert_eq!(
        parse_db_command(&[
            "reset".to_string(),
            "schema".to_string(),
...
#[test]
pub(super) fn parse_db_command_accepts_reset_database_url_and_directory() {
    assert_eq!(
        parse_db_command(&[
            "reset".to_string(),
            "--database-url".to_string(),
...
#[test]
pub(super) fn parse_db_command_accepts_validate_default_directory() {
    assert_eq!(
...
#[test]
pub(super) fn parse_db_command_accepts_validate_custom_directory() {
    assert_eq!(
...
#[test]
pub(super) fn parse_db_command_accepts_status_default_directory() {
    assert_eq!(
...
#[test]
pub(super) fn parse_db_command_accepts_status_custom_directory() {
    assert_eq!(
...
#[test]
pub(super) fn parse_db_command_accepts_status_database_url_and_directory() {
    assert_eq!(
        parse_db_command(&[
            "status".to_string(),
            "--database-url".to_string(),
...
#[test]
pub(super) fn parse_db_command_accepts_snapshot_contract_options() {
    assert_eq!(
        parse_db_command(&[
            "snapshot".to_string(),
            "--check".to_string(),
...
#[test]
pub(super) fn parse_db_command_defaults_snapshot_paths_and_rejects_duplicate_options() {
    assert_eq!(
...
#[test]
pub(super) fn parse_db_command_accepts_help_for_documented_subcommands() {
    for subcommand in [
...
///   variables.
#[test]
pub(super) fn resolve_optional_database_config_prefers_explicit_url() {
    let resolved = super::super::resolve_optional_database_config_from_sources(
...
///   environment state.
#[test]
pub(super) fn resolve_optional_database_config_uses_env_url() {
    let resolved = super::super::resolve_optional_database_config_from_sources(
        None,
...
///   can run.
#[test]
pub(super) fn resolve_optional_database_config_rejects_invalid_scheme() {
    let error = super::super::resolve_optional_database_config_from_sources(
        Some("sqlite://local.db".to_string()),
        None,
    )
    .expect_err("invalid database URL should fail");

    assert!(error.to_string().contains("invalid Postgres database URL"));
}

#[test]
pub(super) fn local_database_dependencies_validate_project_compose_before_socket_work() {
    ...
    let config = super::super::resolve_optional_database_config_from_sources(
    ...
    let error = super::super::prepare_local_database_dependencies(&migrations, &config)
...
#[test]
pub(super) fn remote_database_commands_do_not_start_local_project_dependencies() {
    ...
    let session = super::super::prepare_local_database_dependencies(&migrations, &config)
...
///   are implemented.
#[test]
pub(super) fn parse_db_command_rejects_unknown_subcommand() {
    assert_eq!(
...
#[test]
pub(super) fn parse_db_command_rejects_new_without_name() {
    assert_eq!(
...
#[test]
pub(super) fn parse_db_command_rejects_validate_extra_operands() {
    assert_eq!(
...
#[test]
pub(super) fn parse_db_command_rejects_status_extra_operands() {
    assert_eq!(
...
#[test]
pub(super) fn parse_db_command_rejects_duplicate_database_url() {
    assert_eq!(
        parse_db_command(&[
            "migrate".to_string(),
            "--database-url".to_string(),
...
#[test]
pub(super) fn parse_db_command_rejects_duplicate_dev_flag() {
    assert_eq!(
        parse_db_command(&[
            "rebuild".to_string(),
            "--dev".to_string(),
...
#[test]
pub(super) fn parse_db_command_rejects_duplicate_confirm_flag() {
    assert_eq!(
        parse_db_command(&[
            "reset".to_string(),
            "--dev".to_string(),
...
#[test]
pub(super) fn parse_db_command_rejects_confirm_for_migrate() {
    assert_eq!(
...
#[test]
pub(super) fn run_init_creates_migration_directory() {
...
#[test]
pub(super) fn run_new_creates_valid_migration_template() {
...
#[test]
pub(super) fn run_new_rejects_invalid_migration_name() {
