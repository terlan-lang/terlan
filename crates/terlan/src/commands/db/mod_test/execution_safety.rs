...
#[test]
pub(super) fn run_validate_accepts_valid_migration_directory() {
...
///   tests.
#[test]
pub(super) fn run_migrate_validates_then_reports_unreachable_executor() {
...
#[test]
pub(super) fn run_rebuild_rejects_missing_dev_flag() {
    let exit = run(CliCommand {
        verb: Some("db".to_string()),
...
#[test]
pub(super) fn run_rebuild_rejects_missing_confirmation_before_migration_discovery() {
...
#[test]
pub(super) fn run_reset_with_dev_validates_then_reports_unreachable_executor() {
...
#[test]
pub(super) fn run_rebuild_with_dev_rejects_remote_development_database_url() {
...
#[test]
pub(super) fn run_rebuild_with_confirmation_accepts_loopback_database() {
...
#[test]
pub(super) fn run_rebuild_rejects_protected_transport_options_before_file_or_socket_work() {
...
///   exists.
#[test]
pub(super) fn run_validate_rejects_invalid_migration_source() {
...
///   connectivity.
#[test]
pub(super) fn run_status_accepts_valid_migration_directory() {
...
#[test]
pub(super) fn run_status_with_database_url_reports_unreachable_history_loader() {
...
#[test]
pub(super) fn migration_status_summary_counts_all_status_states() {
    let entries = vec![
...
#[test]
pub(super) fn run_status_rejects_invalid_migration_source() {
...
pub(super) fn status_entry(version: &str, state: MigrationStatusState) -> MigrationStatusEntry {
