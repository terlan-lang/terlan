...
use super::render_values::{
    is_static_template_html_type, is_template_children_slot, static_template_slot_value,
    static_template_value_text, StaticTemplateValue,
};
...
pub(super) fn render_syntax_static_template_nodes(
    ...
    template: &crate::terlan_html::HtmlTemplate,
...
fn render_syntax_static_template_node(
    ...
    match node {
        crate::terlan_html::HtmlNode::Text(text) => out.push_str(text),
