...
pub(super) const DEFAULT_PORT: u16 = 18080;
pub(super) const DEFAULT_COMPOSE_SERVICE: &str = "db";
pub(super) const DEFAULT_DB_USER: &str = "postgres";
pub(super) const DEFAULT_DB_NAME: &str = "postgres";
pub(super) const DEFAULT_DB_PASSWORD: &str = "postgres";
pub(super) const DEFAULT_DB_HOST: &str = "localhost";
pub(super) const DEFAULT_DB_PORT: &str = "5432";
pub(super) const DEFAULT_WAIT_SECS: u64 = 30;

#[derive(Debug, Clone, PartialEq, Eq)]
pub(super) struct IntegrationArgs {
    pub(super) project_dir: PathBuf,
    pub(super) flow_name: Option<String>,
    pub(super) host: String,
    pub(super) host_from_cli: bool,
    pub(super) port: u16,
    pub(super) port_from_cli: bool,
    pub(super) compose_service: String,
    pub(super) compose_service_from_cli: bool,
    pub(super) skip_db: bool,
    pub(super) skip_build: bool,
    pub(super) migrations_dir: Option<PathBuf>,
    pub(super) migrations_from_cli: bool,
    pub(super) wait_secs: u64,
    pub(super) wait_secs_from_cli: bool,
    pub(super) http_checks: Vec<HttpCheck>,
    pub(super) http_checks_from_cli: bool,
    pub(super) websocket_checks: Vec<WebSocketCheck>,
    pub(super) websocket_checks_from_cli: bool,
    pub(super) traits: IntegrationTraits,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub(super) struct IntegrationTraits {
    pub(super) compose_db: bool,
    pub(super) migrations: bool,
    pub(super) web_build: bool,
    pub(super) web_server: bool,
    pub(super) http_checks: bool,
    pub(super) websocket_checks: bool,
}
...
pub(super) struct ManifestIntegrationFlow {
    pub(super) traits: Option<IntegrationTraits>,
    pub(super) host: Option<String>,
    pub(super) port: Option<u16>,
    pub(super) compose_service: Option<String>,
    pub(super) migrations_dir: Option<PathBuf>,
    pub(super) wait_secs: Option<u64>,
    pub(super) http_checks: Option<Vec<HttpCheck>>,
    pub(super) websocket_checks: Option<Vec<WebSocketCheck>>,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub(super) struct HttpCheck {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(super) struct WebSocketCheck {
    pub(super) first_path: String,
    pub(super) first_initial_contains: String,
    pub(super) second_path: String,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(super) struct WebSocketMoveCheck {
    pub(super) row: u64,
    pub(super) column: u64,
    pub(super) first_update_contains: String,
    pub(super) second_update_contains: String,
}
...
pub(super) fn parse_integration_args(args: &[String]) -> Result<IntegrationArgs, String> {
...
pub(super) fn parse_http_check(value: &str) -> Result<HttpCheck, String> {
...
pub(super) fn parse_websocket_check_path(value: &str, label: &str) -> Result<String, String> {
...
pub(super) fn parse_websocket_check_contains(value: &str, label: &str) -> Result<String, String> {
...
pub(super) fn run_integration(mut args: IntegrationArgs, state: CliState) -> Result<(), String> {
...
pub(super) fn apply_manifest_flow(
    project_dir: &Path,
    args: &mut IntegrationArgs,
) -> Result<(), String> {
...
pub(super) fn read_manifest_integration_flow(
    path: &Path,
    flow_name: &str,
...
pub(super) fn parse_manifest_integration_flow(
    source: &str,
    path: &Path,
    flow_name: &str,
) -> Result<Option<ManifestIntegrationFlow>, String> {
...
pub(super) fn parse_integration_traits(
    values: &[String],
    path: &Path,
    line_no: usize,
...
pub(super) fn parse_manifest_string(
    value: &str,
    path: &Path,
    line_no: usize,
...
pub(super) fn parse_manifest_string_array(
    value: &str,
    path: &Path,
    line_no: usize,
...
pub(super) fn unescape_manifest_string(value: &str) -> String {
...
pub(super) fn strip_manifest_comment(line: &str) -> &str {
