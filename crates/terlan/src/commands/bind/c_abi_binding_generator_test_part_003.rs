...
#[test]
fn bindable_unsafe_c_shapes_fail_with_stable_diagnostic_families() {
...
#[test]
fn structured_c_metadata_rejects_unmaintained_producer_and_unknown_skip_shape() {
...
#[test]
fn dispatcher_metadata_rejects_ambiguous_or_unsupported_stack_contracts() {
    let cases: &[(&str, &str, fn(&mut Value))] = &[
        (
            "dispatcher_abi",
...
#[test]
fn external_c_distribution_aliases_link_without_bundled_sources() {
...
#[test]
fn external_c_distribution_can_compile_package_owned_adapter_sources() {
...
#[test]
fn package_owned_rust_extension_is_copied_and_declares_pinned_dependencies() {
...
#[test]
fn package_owned_rust_extension_rejects_escaping_sources_and_unpinned_dependencies() {
...
#[test]
fn pkg_config_external_c_distribution_compiles_package_owned_adapter_sources() {
...
#[test]
fn checked_libpq_package_matches_deterministic_regeneration() {
...
#[test]
fn send_only_opaque_resources_generate_send_without_sync() {
...
#[test]
fn opaque_resources_reject_unknown_thread_safety_metadata() {
...
#[test]
fn external_c_distribution_splits_cpp_adapters_and_maps_borrowed_strings() {
...
#[test]
fn multiple_opaque_resources_generate_typed_owners_and_cross_resource_calls() {
    ...
    assert!(adapter.contains("pub fn apply_model(&self, boundary: &NativeBoundary)"));
    ...
    assert!(helper.contains("fn live_nativemodel("));
