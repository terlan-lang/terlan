use oxc_ast::ast::{PropertyKey, TSLiteral, TSTypeName};

use super::super::super::ts_type_mapping::TsTypeRef;
use super::super::declarations::TsParseError;
...
///   expressions.
pub(super) fn parse_literal_type(literal: &TSLiteral<'_>) -> Result<TsTypeRef, TsParseError> {
    match literal {
...
pub(in crate::commands::bind::ts_parser_adapter) fn property_key_name(
    key: &PropertyKey<'_>,
...
///   mapping.
pub(super) fn type_name(name: &TSTypeName<'_>) -> Result<String, TsParseError> {
    match name {
...
pub(in crate::commands::bind::ts_parser_adapter) fn unsupported(
    reason: &'static str,
    message: &str,
) -> TsParseError {
    TsParseError {
