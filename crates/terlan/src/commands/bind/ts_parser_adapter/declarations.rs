use oxc_ast::{
    ast::{
        BindingPattern, Declaration, Statement, TSModuleDeclarationBody, TSSignature,
...
use super::super::ts_type_mapping::TsTypeRef;
use super::types::{
    interface_member_source, normalize_jsdoc, parse_optional_type_annotation, parse_parameter,
    parse_type, property_key_name, unsupported,
};
...
pub(in crate::commands::bind) struct TsDeclarationFile {
    pub(in crate::commands::bind) declarations: Vec<TsDeclaration>,
}
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(in crate::commands::bind) enum TsDeclaration {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(in crate::commands::bind) struct TsUnsupportedDeclaration {
    pub(in crate::commands::bind) source: String,
    pub(in crate::commands::bind) reason: &'static str,
    pub(in crate::commands::bind) detail: String,
}
...
///   scope metadata.
#[derive(Debug, Clone, PartialEq, Eq)]
pub(in crate::commands::bind) struct TsInterfaceDeclaration {
    pub(in crate::commands::bind) namespace: String,
    pub(in crate::commands::bind) name: String,
    pub(in crate::commands::bind) doc: Option<String>,
    pub(in crate::commands::bind) type_params: Vec<String>,
    pub(in crate::commands::bind) members: Vec<TsInterfaceMember>,
}
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(in crate::commands::bind) struct TsTypeAliasDeclaration {
    pub(in crate::commands::bind) namespace: String,
    pub(in crate::commands::bind) name: String,
    pub(in crate::commands::bind) doc: Option<String>,
    pub(in crate::commands::bind) type_params: Vec<String>,
    pub(in crate::commands::bind) ty: TsTypeRef,
}
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(in crate::commands::bind) enum TsInterfaceMember {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(in crate::commands::bind) struct TsUnsupportedMember {
    pub(in crate::commands::bind) source: String,
    pub(in crate::commands::bind) reason: &'static str,
    pub(in crate::commands::bind) detail: String,
}
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(in crate::commands::bind) struct TsPropertyDeclaration {
    pub(in crate::commands::bind) name: String,
    pub(in crate::commands::bind) doc: Option<String>,
    pub(in crate::commands::bind) readonly: bool,
    pub(in crate::commands::bind) optional: bool,
    pub(in crate::commands::bind) ty: TsTypeRef,
}
...
///   generation.
#[derive(Debug, Clone, PartialEq, Eq)]
pub(in crate::commands::bind) struct TsMethodDeclaration {
    pub(in crate::commands::bind) name: String,
    pub(in crate::commands::bind) doc: Option<String>,
    pub(in crate::commands::bind) optional: bool,
    pub(in crate::commands::bind) params: Vec<TsParameterDeclaration>,
    pub(in crate::commands::bind) return_type: TsTypeRef,
}
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(in crate::commands::bind) struct TsParameterDeclaration {
    pub(in crate::commands::bind) name: String,
    pub(in crate::commands::bind) optional: bool,
    pub(in crate::commands::bind) ty: TsTypeRef,
}
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(in crate::commands::bind) struct TsParseError {
    pub(in crate::commands::bind) reason: &'static str,
    pub(in crate::commands::bind) message: String,
}
...
pub(in crate::commands::bind) fn parse_ts_declaration_file(
    source: &str,
) -> Result<TsDeclarationFile, TsParseError> {
