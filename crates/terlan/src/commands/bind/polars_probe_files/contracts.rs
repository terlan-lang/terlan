...
pub(in crate::commands::bind) struct GeneratedFile {
    pub(in crate::commands::bind) path: &'static str,
    pub(in crate::commands::bind) contents: &'static str,
}

pub(super) const POLARS_TOML: &str = r#"[package]
...
pub(super) const POLARS_DATAFRAME_TN: &str = r#"/**
...
pub(super) const POLARS_MAPPING_TOML: &str = r#"[package]
...
pub(super) const POLARS_NATIVE_ABI_TOML: &str = r#"[package]
namespace = "std.native.polars"
adapter = "rust"
...
pub(super) const POLARS_PACKAGE_DOC: &str = r#"# std.native.polars
...
pub(super) const POLARS_READ_CSV_EXAMPLE: &str = r#"module examples.polars.ReadCsv.
...
pub(super) const POLARS_DATAFRAME_TYPI: &str = r#"//! Native Polars DataFrame contract.
//!
//! `std.native.polars.DataFrame` is the first curated native Rust package probe.
//! It is intentionally small and opaque: Terlan source can pass DataFrame values
//! through typed APIs, while the native Rust adapter owns the real Polars value.
...
pub(super) const POLARS_RUST_CARGO_TOML: &str = r#"[package]
...
pub(super) const POLARS_RUST_STUB: &str = r#"#![forbid(unsafe_code)]
