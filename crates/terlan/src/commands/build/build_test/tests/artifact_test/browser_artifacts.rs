...
#[test]
pub(super) fn build_command_emits_browser_web_package_for_js_browser_target() {
...
#[test]
pub(super) fn build_command_infers_js_browser_target_from_asset_imports() {
...
#[test]
pub(super) fn build_command_rejects_explicit_vm_target_for_js_evidence() {
...
#[test]
pub(super) fn build_command_emits_manifest_declared_static_assets_for_js_browser_project() {
...
#[test]
pub(super) fn build_command_rejects_case_folded_static_asset_collisions_for_js_browser_project() {
