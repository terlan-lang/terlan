use super::manifest::{
    write_browser_manifest, WebAssetArtifact, WebErrorHandlerArtifact, WebHandlerArtifact,
};
use super::routes::{
...
fn write_response_middleware_source(path: &Path, middleware_decl: &str) {
    fs::write(
        path,
        format!(
...
#[test]
fn discover_web_route_manifest_extracts_grouped_sse_routes() {
