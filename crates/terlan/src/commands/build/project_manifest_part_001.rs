...
pub(crate) use model::{
    ...
    ProjectManifest, ProjectNativeRust, ProjectPackage, ProjectScript, ProjectServerProfile,
...
///   - optional `[scripts] seed = "scripts/Seed.terl"`
...
/// - `value`: manifest value expected to be a package-relative `.terl` path.
/// - `path`: manifest path used in diagnostics.
/// - `line_no`: 1-based line number used in diagnostics.
///
/// Output:
