...
fn measure_vm_resource_runtime_primitives() -> Result<(), String> {
    let mut processes = VmProcessTable::default();
...
fn measure_vm_cancellation_resource_cleanup_primitives() -> Result<(), String> {
    let mut processes = VmProcessTable::default();
    let owner = processes.spawn_root(VmProcessSource::new("bench.Resource", "owner", 0));
    let mut resources = VmResourceTable::default();
    let registered = resources.register(
...
fn measure_vm_table_runtime_primitives() -> Result<(), String> {
    let mut processes = VmProcessTable::default();
...
fn measure_vm_map_workload(size: usize, iterations: usize) -> Result<Measurement, String> {
...
fn run_vm_map_workload(size: usize) -> Result<(), String> {
...
fn measure_vm_collision_heavy_map_workload(iterations: usize) -> Result<Measurement, String> {
    measure_repeated(
...
fn run_vm_collision_heavy_map_workload() -> Result<(), String> {
    let mut map = map_value::VmMapValue::from_entries(Vec::new());
...
struct CollidingBenchmarkKey(i64);
...
fn measure_vm_shared_persistent_map_workload(
    size: usize,
    iterations: usize,
...
fn run_vm_shared_persistent_map_workload(size: usize) -> Result<(), String> {
...
fn measure_vm_iterator_equality_rendering_map_workload(
    size: usize,
    iterations: usize,
) -> Result<Measurement, String> {
    let mut durations = Vec::with_capacity(iterations);
...
fn run_vm_iterator_equality_rendering_map_workload(size: usize) -> Result<(), String> {
...
fn measure_vm_mixed_map_workload(size: usize, iterations: usize) -> Result<Measurement, String> {
    let mut durations = Vec::with_capacity(iterations);
    for _ in 0..iterations {
        let start = Instant::now();
...
fn run_vm_mixed_map_workload(size: usize) -> Result<(), String> {
...
fn measure_otp_map_workload(size: usize, iterations: usize) -> Result<Measurement, String> {
    let eval = otp_map_benchmark_eval(size, iterations);
    measure_otp_map_eval(otp_map_measurement_name(size), eval, iterations)
}

fn measure_otp_shared_persistent_map_workload(
    size: usize,
    iterations: usize,
) -> Result<Measurement, String> {
...
fn measure_otp_iterator_equality_rendering_map_workload(
    size: usize,
    iterations: usize,
) -> Result<Measurement, String> {
...
fn measure_otp_mixed_map_workload(size: usize, iterations: usize) -> Result<Measurement, String> {
...
fn otp_map_benchmark_eval(size: usize, iterations: usize) -> String {
    format!(
...
fn otp_shared_persistent_map_benchmark_eval(size: usize, iterations: usize) -> String {
    format!(
        "Size = {size}, Iterations = {iterations}, \
         Work = fun() -> \
         Keys = lists:seq(1, Size), \
...
fn otp_iterator_equality_rendering_map_benchmark_eval(size: usize, iterations: usize) -> String {
    format!(
        "Size = {size}, Iterations = {iterations}, \
         Work = fun() -> \
         Keys = lists:seq(1, Size), \
...
fn otp_mixed_map_benchmark_eval(size: usize, iterations: usize) -> String {
    format!(
        "Size = {size}, Iterations = {iterations}, \
         Work = fun() -> \
         Keys = lists:seq(1, Size), \
...
fn parse_erlang_duration_list(text: &str) -> Result<Vec<Duration>, String> {
...
fn vm_map_measurement_name(size: usize) -> &'static str {
    match size {
...
fn otp_map_measurement_name(size: usize) -> &'static str {
    match size {
...
fn vm_shared_persistent_map_measurement_name(size: usize) -> &'static str {
    match size {
...
fn otp_shared_persistent_map_measurement_name(size: usize) -> &'static str {
    match size {
...
fn vm_iterator_equality_rendering_map_measurement_name(size: usize) -> &'static str {
    match size {
...
fn otp_iterator_equality_rendering_map_measurement_name(size: usize) -> &'static str {
    match size {
...
fn vm_mixed_map_measurement_name(size: usize) -> &'static str {
    match size {
...
fn otp_mixed_map_measurement_name(size: usize) -> &'static str {
    match size {
...
const LARGE_MAP_REFERENCE_SIZE: usize = 5_000;
