...
use crate::terlan_typeck::{
    CoreExpr, CoreExprSummary, CoreImportKind, CoreIntrinsicCall, CoreIntrinsicId, CoreModule,
...
pub(super) struct StdCallHeads {
    ...
    pub(super) vm_agent: HashSet<String>,
    pub(super) vm_gen_server: HashSet<String>,
    pub(super) vm_native_bridge: HashSet<String>,
    pub(super) vm_supervisor: HashSet<String>,
    pub(super) vm_task: HashSet<String>,
}
...
pub(super) fn std_call_heads(module: &CoreModule) -> StdCallHeads {
    StdCallHeads {
        ...
        vm_agent: std_module_call_heads(module, "std.vm.Agent", "Agent"),
        vm_gen_server: std_module_call_heads(module, "std.vm.GenServer", "GenServer"),
        vm_native_bridge: std_module_call_heads(module, "std.vm.NativeBridge", "NativeBridge"),
        vm_supervisor: std_module_call_heads(module, "std.vm.Supervisor", "Supervisor"),
        vm_task: std_module_call_heads(module, "std.vm.Task", "Task"),
    }
}
    ...
    match module {
        ...
        "std.http.Sse" | "Sse" => matches!(
            ...
            ("data", 1)
                ...
                | ("response", 1 | 2)
                | ("endpoint", 0 | 1 | 2)
                | ("endpoint_with_keep_alive", 0 | 1 | 2 | 3)
        ),
        "std.http.WebSocket" | "WebSocket" => matches!(
            (function, arity),
            ("text" | "ping" | "pong", 1) | ("close", 0) | ("endpoint", 0 | 1 | 2)
        ),
    ...
    matches!(profile, TargetProfile::CoreV0)
        && matches!(
            ...
            ("is_empty", 1)
                ...
                | ("with_header", 3)
                | ("set_cookie_header", 2)
                | ("cookie_with_options", 3 | 4 | 5 | 6 | 7 | 8 | 9 | 10 | 11)
                | ("with_cookie_options", 3 | 4 | 5 | 6 | 7 | 8 | 9 | 10 | 11)
                | ("delete_cookie", 2 | 3)
    ...
    matches!(profile, TargetProfile::CoreV0)
        && matches!(
            ...
            ("push", 1)
                ...
                | ("set_cookie_header", 1)
                | ("cookie", 2 | 3 | 4 | 5)
                | ("cookie_with_options", 2 | 3 | 4 | 5 | 6 | 7 | 8 | 9 | 10)
                | ("with_cookie", 2 | 3 | 4 | 5)
                | ("with_cookie_options", 2 | 3 | 4 | 5 | 6 | 7 | 8 | 9 | 10)
                | ("delete_cookie", 1 | 2)
