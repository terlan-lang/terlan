...
#[test]
fn target_profile_keeps_constructor_pattern_out_of_a0_12_vm_profile() {
    let module = lower(
        "\
...
#[test]
fn target_profile_accepts_lambda_for_a0_14_vm_profile() {
    let module = lower(
        "\
...
#[test]
fn target_profile_keeps_lambda_out_of_a0_13_vm_profile() {
    let module = lower(
        "\
...
#[test]
fn target_profile_accepts_constructor_extension_for_a0_15_vm_profile() {
    let module = lower(
        "\
...
#[test]
fn target_profile_keeps_constructor_extension_out_of_a0_14_vm_profile() {
    let module = lower(
        "\
...
#[test]
fn target_profile_accepts_fun_call_for_a0_16_vm_profile() {
    let module = lower(
        "\
...
#[test]
fn target_profile_keeps_fun_call_out_of_a0_15_vm_profile() {
    let module = lower(
        "\
...
#[test]
fn target_profile_accepts_field_access_for_a0_17_vm_profile() {
    let module = lower(
        "\
...
#[test]
fn target_profile_keeps_field_access_out_of_a0_16_vm_profile() {
    let module = lower(
        "\
...
#[test]
fn target_profile_accepts_let_expr_for_a0_18_vm_profile() {
    let module = lower(
        "\
...
#[test]
fn target_profile_keeps_let_expr_out_of_a0_17_vm_profile() {
    let module = lower(
        "\
...
#[test]
fn target_profile_accepts_index_access_for_a0_19_vm_profile() {
    let module = lower(
        "\
...
#[test]
fn target_profile_accepts_qualified_calls_for_a0_20_vm_profile() {
    let module = lower(
        "\
...
#[test]
fn target_profile_keeps_qualified_calls_out_of_a0_19_vm_profile() {
    let module = lower(
        "\
...
#[test]
fn target_profile_rejects_remote_fun_ref_for_a0_21_vm_profile() {
...
///   profile.
#[test]
fn target_profile_keeps_subtraction_out_of_a0_vm_profile() {
    let module = lower(
        "\
