...
pub(super) fn lean_expr_summary(expr: CoreExpr) -> CoreExprSummary {
    CoreExprSummary {
...
pub(super) fn expr_evidence(target: &str) -> CoreCheckedPreservationEvidence {
...
///   runtime-bindings-required freshness marker.
pub(super) fn pattern_evidence(target: &str) -> CoreCheckedPreservationEvidence {
    CoreCheckedPreservationEvidence {
...
pub(super) fn lean_core_metadata() -> CoreModuleMetadata {
    CoreModuleMetadata {
...
pub(super) fn empty_interface(module: &str) -> ModuleInterface {
    ModuleInterface {
...
pub(super) fn module_with_core_body(body: CoreExpr) -> CoreModule {
...
pub(super) fn module_with_unresolved_constructor_candidates(
...
///   payload.
pub(super) fn assert_unresolved_constructor_violation(
...
///   compares its formatted message against the expected profile/count
///   payload.
pub(super) fn assert_unresolved_constructor_violation_for_profile(
    violations: &[TargetProfileViolation],
...
pub(super) fn module_with_core_body_and_evidence(
    body: CoreExpr,
...
#[test]
pub(super) fn target_profile_accepts_documented_core_v0_shape_matrix() {
...
#[test]
pub(super) fn target_profile_rejects_missing_expr_evidence_for_core_v0_profile() {
...
///   checks for the missing-evidence diagnostic.
#[test]
pub(super) fn target_profile_rejects_missing_pattern_evidence_for_core_v0_profile() {
    let module = module_with_core_body_and_evidence(
        CoreExpr::Int(1),
...
#[test]
pub(super) fn target_profile_accepts_float_for_vm_profile() {
    let module = lower(
        "\
module profile_test.\n\npub f(): Int ->\n    1.0.\n",
...
#[test]
pub(super) fn target_profile_rejects_float_expr_for_core_v0_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_accepts_binary_for_vm_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_allows_lambda_for_vm_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_allows_map_expr_for_vm_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_allows_list_cons_expr_for_vm_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_allows_index_expr_for_vm_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_rejects_index_expr_for_core_v0_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_allows_fixed_array_expr_for_vm_profile() {
    let module = lower(
        "\
...
///   target-subset validation without mutating compiler artifacts.
#[test]
pub(super) fn target_profile_rejects_fixed_array_expr_for_core_v0_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_allows_list_comprehension_expr_for_vm_profile() {
    let module = lower(
        "\
...
///   target-subset validation without mutating compiler artifacts.
#[test]
pub(super) fn target_profile_rejects_list_comprehension_expr_for_core_v0_profile() {
    let module = lower(
        "\
...
///   target-subset validation without mutating compiler artifacts.
#[test]
pub(super) fn target_profile_rejects_iterable_list_comprehension_expr_for_core_v0_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_allows_record_construct_expr_for_vm_profile() {
    let module = lower(
        "\
...
///   target-subset validation without mutating compiler artifacts.
#[test]
pub(super) fn target_profile_rejects_record_construct_expr_for_core_v0_profile() {
    let module = lower(
        "\
