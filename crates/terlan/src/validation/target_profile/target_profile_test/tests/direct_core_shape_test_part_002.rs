...
#[test]
fn target_profile_allows_field_access_expr_for_vm_profile() {
    let module = lower(
        "\
...
#[test]
fn target_profile_allows_record_access_expr_for_vm_profile() {
    let module = lower(
        "\
...
#[test]
fn target_profile_allows_record_update_expr_for_vm_profile() {
    let module = lower(
        "\
...
#[test]
fn target_profile_allows_template_instantiate_expr_for_vm_profile() {
    let module = lower(
        "\
...
#[test]
fn target_profile_allows_constructor_chain_expr_for_vm_profile() {
    let module = lower(
        "\
...
#[test]
fn target_profile_allows_resolved_constructor_call_for_vm_profile() {
    let module = lower(
        "\
...
#[test]
fn target_profile_allows_remote_call_expr_for_vm_profile() {
    let module = lower(
        "\
...
#[test]
fn target_profile_rejects_function_value_invocation_for_core_v0_profile() {
    let module = lower(
        "\
...
#[test]
fn target_profile_accepts_vm_std_test_remote_call_for_core_v0_profile() {
    let module = lower(
        "\
...
#[test]
fn target_profile_accepts_composed_vm_std_test_remote_call_for_core_v0_profile() {
    let module = lower(
        "\
...
#[test]
fn target_profile_allows_if_expr_for_vm_profile() {
    let module = lower(
        "\
...
#[test]
fn target_profile_allows_try_expr_for_vm_profile() {
    let module = lower(
        "\
...
#[test]
fn target_profile_allows_unary_op_expr_for_vm_profile() {
    let module = lower(
        "\
...
#[test]
fn target_profile_allows_map_pattern_for_vm_profile() {
    let module = lower(
        "\
...
///   artifacts.
#[test]
fn target_profile_allows_float_pattern_for_vm_profile() {
    let module = lower(
        "\
...
#[test]
fn target_profile_allows_string_capture_pattern_for_vm_profile() {
    let module = lower(
        "\
...
///   patterns.
#[test]
fn target_profile_rejects_string_capture_pattern_for_core_v0_profile() {
    let module = lower(
        "\
...
#[test]
fn target_profile_allows_list_cons_pattern_for_vm_profile() {
    let module = lower(
        "\
...
#[test]
fn target_profile_allows_record_pattern_for_vm_profile() {
    let module = lower(
        "\
