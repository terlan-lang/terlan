...
#[test]
pub(super) fn target_profile_accepts_mathx_for_a0_vm_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_rejects_binary_for_a0_vm_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_accepts_arithmetic_for_a0_1_vm_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_accepts_bool_ops_for_a0_2_vm_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_keeps_bool_ops_out_of_a0_1_vm_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_accepts_if_expr_for_a0_3_vm_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_keeps_if_expr_out_of_a0_2_vm_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_accepts_case_expr_for_a0_4_vm_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_keeps_case_expr_out_of_a0_3_vm_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_accepts_raw_atoms_for_a0_5_vm_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_keeps_raw_atoms_out_of_a0_4_vm_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_accepts_tuples_for_a0_6_vm_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_keeps_tuples_out_of_a0_5_vm_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_accepts_lists_for_a0_7_vm_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_keeps_lists_out_of_a0_6_vm_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_accepts_binary_for_a0_8_vm_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_keeps_binary_out_of_a0_7_vm_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_accepts_list_cons_for_a0_9_vm_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_keeps_list_cons_out_of_a0_8_vm_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_accepts_named_call_for_a0_10_vm_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_keeps_named_call_out_of_a0_9_vm_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_accepts_unary_neg_for_a0_11_vm_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_keeps_unary_neg_out_of_a0_10_vm_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_accepts_constructor_call_for_a0_12_vm_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_keeps_constructor_call_out_of_a0_11_vm_profile() {
    let module = lower(
        "\
...
#[test]
pub(super) fn target_profile_accepts_constructor_pattern_for_a0_13_vm_profile() {
    let module = lower(
        "\
