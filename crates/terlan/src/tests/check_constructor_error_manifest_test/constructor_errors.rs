...
#[test]
pub(super) fn run_check_single_file_rejects_unknown_constructor_before_core_phase() {
...
#[test]
pub(super) fn run_check_single_file_rejects_imported_raw_struct_construction_before_core_phase() {
...
#[test]
pub(super) fn run_check_single_file_rejects_public_constructor_private_return_before_core_phase() {
...
///   {Atom["ok"], value: T}` and calls `Ok()` with no payload.
///
/// Output:
/// - Test passes when `terlc check --emit-phase-manifest` fails in the
...
#[test]
pub(super) fn run_check_single_file_rejects_alias_constructor_wrong_arity_before_core_phase() {
...
#[test]
pub(super) fn run_check_single_file_rejects_imported_alias_constructor_wrong_arity_before_core_phase(
) {
...
#[test]
pub(super) fn run_check_single_file_rejects_aliased_imported_alias_constructor_wrong_arity_before_core_phase(
) {
...
#[test]
pub(super) fn run_check_single_file_rejects_imported_alias_constructor_pattern_wrong_arity_before_core_phase(
) {
...
#[test]
pub(super) fn run_check_single_file_rejects_aliased_imported_alias_constructor_pattern_wrong_arity_before_core_phase(
) {
    let dir =
...
/// Inputs:
/// - A temporary single-file Terlan module that declares `Ok[T] =
///   {Atom["ok"], value: T}` and matches `Ok(value, extra)`.
///
/// Output:
/// - Test passes when `terlc check --emit-phase-manifest` fails in the
///   typecheck phase, skips CoreIR, and reports the constructor-pattern
...
#[test]
pub(super) fn run_check_single_file_rejects_alias_constructor_pattern_wrong_arity_before_core_phase(
) {
...
///   {Atom["user"], id: Int, name: Binary}` and uses `User(id)` as a
...
#[test]
pub(super) fn run_check_single_file_rejects_alias_constructor_chain_wrong_arity_before_core_phase()
{
...
///   constructor-chain metadata.
#[test]
pub(super) fn run_check_single_file_rejects_imported_alias_constructor_chain_wrong_arity_before_core_phase(
) {
...
#[test]
pub(super) fn run_check_single_file_rejects_aliased_imported_alias_constructor_chain_wrong_arity_before_core_phase(
) {
    let dir =
...
#[test]
pub(super) fn run_check_single_file_rejects_imported_list_alias_constructor_chain_before_core_phase(
) {
...
#[test]
pub(super) fn run_check_single_file_rejects_imported_list_alias_constructor_call_before_core_phase()
{
