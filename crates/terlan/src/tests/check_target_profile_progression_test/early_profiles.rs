...
#[test]
pub(super) fn run_check_single_file_accepts_subtraction_for_core_v0_target_profile() {
...
#[test]
pub(super) fn run_check_single_file_accepts_mathx_for_a0_vm_target_profile() {
...
#[test]
pub(super) fn run_check_single_file_rejects_binary_for_a0_vm_target_profile() {
...
#[test]
pub(super) fn run_check_single_file_accepts_arithmetic_for_a0_1_vm_target_profile() {
...
///   and asserts the documented successor matrix exits successfully.
#[test]
pub(super) fn run_check_single_file_accepts_bool_ops_for_a0_2_vm_target_profile() {
...
///   feature.
#[test]
pub(super) fn run_check_single_file_keeps_bool_ops_out_of_a0_1_vm_target_profile() {
...
///   and asserts the documented successor matrix exits successfully.
#[test]
pub(super) fn run_check_single_file_accepts_if_expr_for_a0_3_vm_target_profile() {
...
///   feature.
#[test]
pub(super) fn run_check_single_file_keeps_if_expr_out_of_a0_2_vm_target_profile() {
...
///   and asserts the documented successor matrix exits successfully.
#[test]
pub(super) fn run_check_single_file_accepts_case_expr_for_a0_4_vm_target_profile() {
...
///   feature.
#[test]
pub(super) fn run_check_single_file_keeps_case_expr_out_of_a0_3_vm_target_profile() {
...
///   and asserts the documented successor matrix exits successfully.
#[test]
pub(super) fn run_check_single_file_accepts_raw_atoms_for_a0_5_vm_target_profile() {
...
///   feature.
#[test]
pub(super) fn run_check_single_file_keeps_raw_atoms_out_of_a0_4_vm_target_profile() {
...
///   and asserts the documented successor matrix exits successfully.
#[test]
pub(super) fn run_check_single_file_accepts_tuples_for_a0_6_vm_target_profile() {
...
///   feature.
#[test]
pub(super) fn run_check_single_file_keeps_tuples_out_of_a0_5_vm_target_profile() {
...
///   and asserts the documented successor matrix exits successfully.
#[test]
pub(super) fn run_check_single_file_accepts_lists_for_a0_7_vm_target_profile() {
...
///   feature.
#[test]
pub(super) fn run_check_single_file_keeps_lists_out_of_a0_6_vm_target_profile() {
...
///   and asserts the documented successor matrix exits successfully.
#[test]
pub(super) fn run_check_single_file_accepts_binary_for_a0_8_vm_target_profile() {
...
///   feature.
#[test]
pub(super) fn run_check_single_file_keeps_binary_out_of_a0_7_vm_target_profile() {
...
///   and asserts the documented successor matrix exits successfully.
#[test]
pub(super) fn run_check_single_file_accepts_list_cons_for_a0_9_vm_target_profile() {
...
///   feature.
#[test]
pub(super) fn run_check_single_file_keeps_list_cons_out_of_a0_8_vm_target_profile() {
...
///   and asserts the documented successor matrix exits successfully.
#[test]
pub(super) fn run_check_single_file_accepts_named_call_for_a0_10_vm_target_profile() {
...
///   feature.
#[test]
pub(super) fn run_check_single_file_keeps_named_call_out_of_a0_9_vm_target_profile() {
