...
#[test]
pub(super) fn run_check_single_file_accepts_unary_neg_for_a0_11_vm_target_profile() {
...
///   feature.
#[test]
pub(super) fn run_check_single_file_keeps_unary_neg_out_of_a0_10_vm_target_profile() {
...
///   and asserts the documented successor matrix exits successfully.
#[test]
pub(super) fn run_check_single_file_accepts_constructor_call_for_a0_12_vm_target_profile() {
...
///   feature.
#[test]
pub(super) fn run_check_single_file_keeps_constructor_call_out_of_a0_11_vm_target_profile() {
...
///   and asserts the documented successor matrix exits successfully.
#[test]
pub(super) fn run_check_single_file_accepts_constructor_pattern_for_a0_13_vm_target_profile() {
...
///   feature.
#[test]
pub(super) fn run_check_single_file_keeps_constructor_pattern_out_of_a0_12_vm_target_profile() {
...
///   and asserts the documented successor matrix exits successfully.
#[test]
pub(super) fn run_check_single_file_accepts_lambda_for_a0_14_vm_target_profile() {
...
///   feature.
#[test]
pub(super) fn run_check_single_file_keeps_lambda_out_of_a0_13_vm_target_profile() {
...
///   and asserts the documented successor matrix exits successfully.
#[test]
pub(super) fn run_check_single_file_accepts_constructor_extension_for_a0_15_vm_target_profile() {
...
///   feature.
#[test]
pub(super) fn run_check_single_file_keeps_constructor_extension_out_of_a0_14_vm_target_profile() {
...
///   and asserts the documented successor matrix exits successfully.
#[test]
pub(super) fn run_check_single_file_accepts_fun_call_for_a0_16_vm_target_profile() {
...
///   kind.
#[test]
pub(super) fn run_check_single_file_keeps_fun_call_out_of_a0_15_vm_target_profile() {
...
///   and asserts the documented successor matrix exits successfully.
#[test]
pub(super) fn run_check_single_file_accepts_field_access_for_a0_17_vm_target_profile() {
...
///   shape.
#[test]
pub(super) fn run_check_single_file_keeps_field_access_out_of_a0_16_vm_target_profile() {
...
///   and asserts the documented successor matrix exits successfully.
#[test]
pub(super) fn run_check_single_file_accepts_let_expr_for_a0_18_vm_target_profile() {
...
///   shape.
#[test]
pub(super) fn run_check_single_file_keeps_let_expr_out_of_a0_17_vm_target_profile() {
...
///   and asserts the documented successor matrix exits successfully.
#[test]
pub(super) fn run_check_single_file_accepts_index_access_for_a0_19_vm_target_profile() {
...
///   bridge contract.
#[test]
pub(super) fn run_check_single_file_accepts_native_vector_selection_sort_for_vm_profile() {
...
///   and asserts the documented successor matrix exits successfully.
#[test]
pub(super) fn run_check_single_file_accepts_qualified_calls_for_a0_20_vm_target_profile() {
...
///   shape.
#[test]
pub(super) fn run_check_single_file_keeps_qualified_calls_out_of_a0_19_vm_target_profile() {
...
#[test]
pub(super) fn run_check_single_file_rejects_method_call_for_core_v0_target_profile() {
...
#[test]
pub(super) fn run_check_single_file_rejects_remote_fun_ref_for_a0_21_vm_target_profile() {
...
#[test]
pub(super) fn run_check_single_file_keeps_subtraction_out_of_a0_vm_target_profile() {
