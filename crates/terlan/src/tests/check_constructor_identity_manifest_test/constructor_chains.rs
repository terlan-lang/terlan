...
#[test]
pub(super) fn run_check_single_file_rejects_local_unknown_constructor_pattern_before_core_phase() {
...
#[test]
pub(super) fn run_check_single_file_accepts_declared_constructor_chain_in_core_phase() {
...
///   manifest emission.
#[test]
pub(super) fn run_check_single_file_accepts_alias_constructor_chain_in_core_phase() {
...
#[test]
pub(super) fn run_check_single_file_accepts_imported_constructor_chain_in_core_phase() {
...
///   lowering.
#[test]
pub(super) fn run_check_single_file_accepts_aliased_imported_constructor_chain_in_core_phase() {
...
#[test]
pub(super) fn run_check_single_file_accepts_direct_imported_alias_constructor_chain_in_core_phase()
{
...
#[test]
pub(super) fn run_check_single_file_accepts_aliased_imported_alias_constructor_chain_in_core_phase()
{
