...
///   emission.
#[test]
pub(super) fn run_check_single_file_accepts_declared_constructor_call_in_core_phase() {
...
///   emission.
#[test]
pub(super) fn run_check_single_file_accepts_alias_constructor_call_in_core_phase() {
...
#[test]
pub(super) fn run_check_single_file_accepts_imported_constructor_call_in_core_phase() {
...
///   unit-only lowering.
#[test]
pub(super) fn run_check_single_file_accepts_aliased_imported_constructor_call_in_core_phase() {
...
#[test]
pub(super) fn run_check_single_file_accepts_direct_imported_alias_constructor_call_in_core_phase() {
...
///   annotation, and phase-manifest emission.
#[test]
pub(super) fn run_check_single_file_accepts_aliased_imported_alias_constructor_call_in_core_phase()
{
...
///   lowering.
#[test]
pub(super) fn run_check_single_file_accepts_imported_constructor_pattern_in_core_phase() {
...
#[test]
pub(super) fn run_check_single_file_accepts_aliased_imported_constructor_pattern_in_core_phase() {
...
#[test]
pub(super) fn run_check_single_file_accepts_direct_imported_alias_constructor_pattern_in_core_phase(
) {
...
///   identity annotation, and phase-manifest emission.
#[test]
pub(super) fn run_check_single_file_accepts_aliased_imported_alias_constructor_pattern_in_core_phase(
) {
...
#[test]
pub(super) fn run_check_single_file_accepts_declared_constructor_pattern_in_core_phase() {
...
#[test]
pub(super) fn run_check_single_file_accepts_alias_constructor_pattern_in_core_phase() {
