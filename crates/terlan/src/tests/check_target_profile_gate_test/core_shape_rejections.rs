...
#[test]
pub(super) fn run_check_single_file_rejects_remote_call_for_core_v0_target_profile() {
...
#[test]
pub(super) fn run_check_single_file_rejects_remote_fun_ref_for_core_v0_target_profile() {
...
#[test]
pub(super) fn run_check_single_file_rejects_record_construct_for_core_v0_target_profile() {
...
///   successful result is returned.
#[test]
pub(super) fn run_check_single_file_rejects_record_access_for_core_v0_target_profile() {
...
///   successful result is returned.
#[test]
pub(super) fn run_check_single_file_rejects_record_update_for_core_v0_target_profile() {
...
///   before a successful result is returned.
#[test]
pub(super) fn run_check_single_file_rejects_template_instantiate_for_core_v0_target_profile() {
...
#[test]
pub(super) fn run_check_single_file_rejects_beam_process_contract_for_core_v0_target_profile() {
...
#[test]
pub(super) fn run_check_single_file_rejects_vm_native_bridge_contract_for_core_v0_target_profile() {
