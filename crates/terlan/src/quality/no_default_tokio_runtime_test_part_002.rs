...
#[test]
fn tokio_inventory_keeps_serve_http_websocket_as_migration_debt_or_tests() {
    ...
    let valid_rows = vec![
        TokioInventoryRow {
            path: PathBuf::from("crates/terlan/src/commands/serve/tls.rs"),
...
///   from Tokio.
#[test]
fn tokio_direct_dependency_parser_finds_names_and_tokio_features() {
...
#[test]
fn tokio_direct_dependency_parser_locks_current_removal_target_set() {
    let entries = parse_direct_tokio_dependency_entries(
        r#"
[package]
name = "terlan"
...
#[test]
fn tokio_direct_dependency_parser_detects_removed_features() {
...
#[test]
fn tokio_direct_dependency_parser_detects_unexpected_features() {
...
#[test]
fn tokio_direct_dependency_parser_ignores_non_default_dependency_sections() {
    let entries = parse_direct_tokio_dependency_entries(
        r#"
[package]
name = "terlan"
...
#[test]
fn tokio_direct_dependency_parser_ignores_optional_dependencies() {
    let entries = parse_direct_tokio_dependency_entries(
        r#"
[package]
name = "terlan"
...
#[test]
fn tokio_direct_dependency_parser_counts_default_enabled_optional_dependencies() {
    let entries = parse_direct_tokio_dependency_entries(
        r#"
[package]
name = "terlan"
...
///   inventory.
#[test]
fn tokio_direct_dependency_parser_detects_renamed_tokio_packages() {
    let entries = parse_direct_tokio_dependency_entries(
        r#"
[package]
name = "terlan"
...
#[test]
fn tokio_direct_dependency_parser_accepts_table_dependency_syntax() {
    let entries = parse_direct_tokio_dependency_entries(
        r#"
[package]
name = "terlan"
...
#[test]
fn tokio_removed_runtime_dependency_parser_finds_only_default_dependencies() {
...
#[test]
fn tokio_removed_runtime_dependency_parser_detects_renamed_removed_packages() {
    let entries = parse_removed_runtime_dependency_entries(
        r#"
[package]
name = "terlan"
...
///   being retired.
#[test]
fn tokio_direct_dependency_inventory_rejects_unexpected_entries() {
...
#[test]
fn tokio_direct_dependency_inventory_rejects_reintroduced_tokio_postgres() {
    let inventory = vec![TokioInventoryRow {
        path: PathBuf::from(CARGO_MANIFEST_PATH),
        classification: "migration-debt".to_string(),
        owner: "cargo".to_string(),
...
#[test]
fn tokio_direct_dependency_inventory_requires_cargo_manifest_row() {
...
#[test]
fn tokio_direct_dependency_inventory_requires_removal_plan_notes() {
    let inventory = vec![TokioInventoryRow {
        path: PathBuf::from(CARGO_MANIFEST_PATH),
        classification: "migration-debt".to_string(),
        owner: "cargo".to_string(),
...
///   from `Cargo.toml`.
#[test]
fn tokio_direct_dependency_inventory_rejects_stale_removal_plan_targets() {
    let inventory = vec![TokioInventoryRow {
        path: PathBuf::from(CARGO_MANIFEST_PATH),
        classification: "migration-debt".to_string(),
        owner: "cargo".to_string(),
...
#[test]
fn no_default_tokio_runtime_gate_rejects_malformed_cargo_manifest() {
...
#[test]
fn no_default_tokio_runtime_gate_rejects_direct_dependency_names() {
...
///   WebSocket client.
#[test]
fn no_default_tokio_runtime_gate_rejects_removed_runtime_dependencies() {
...
#[test]
fn no_default_tokio_runtime_gate_rejects_removed_tokio_features() {
...
///   exists.
#[test]
fn no_default_tokio_runtime_gate_rejects_unexpected_tokio_features() {
