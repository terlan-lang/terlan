...
#[test]
pub(super) fn tokio_inventory_parser_accepts_valid_rows() {
...
#[test]
pub(super) fn tokio_inventory_rejects_unknown_classification() {
...
#[test]
pub(super) fn tokio_inventory_rejects_placeholder_owner_and_notes() {
...
///   escape hatches.
#[test]
pub(super) fn tokio_inventory_rejects_placeholder_allowed_classification_names() {
...
#[test]
pub(super) fn tokio_inventory_rejects_unclassified_references() {
...
#[test]
pub(super) fn tokio_inventory_rejects_vm_runtime_paths() {
...
///   of Tokio-backed.
#[test]
pub(super) fn tokio_inventory_rejects_default_vm_runtime_semantic_paths() {
...
///   lanes.
#[test]
pub(super) fn tokio_inventory_rejects_classification_scope_mismatch() {
...
#[test]
pub(super) fn tokio_inventory_rejects_quality_gate_scope_outside_quality_sources() {
...
#[test]
pub(super) fn tokio_inventory_rejects_retired_reference_only_classification() {
...
#[test]
pub(super) fn tokio_inventory_rejects_retired_generated_summary_classification() {
...
#[test]
pub(super) fn tokio_inventory_accepts_scoped_test_lanes() {
...
#[test]
pub(super) fn tokio_inventory_limits_serve_tls_migration_to_live_acme_issuance() {
...
#[test]
pub(super) fn tokio_inventory_rejects_benchmark_helper_as_test_harness() {
...
#[test]
pub(super) fn tokio_inventory_keeps_lsp_tokio_as_editor_tooling_or_tests() {
...
#[test]
pub(super) fn tokio_inventory_rejects_postgres_runtime_references() {
...
#[test]
pub(super) fn tokio_inventory_rejects_benchmark_http_client_runtime_code() {
    let root = repo_root();
