...
#[test]
pub(super) fn parses_compact_markdown_page_header_string_braces() {
...
#[test]
pub(super) fn parses_multiline_markdown_page_header_string_braces() {
    let template = parse_markdown_template(
        "@page {\n  title = \"}\"\n}\n\n# Body\n",
        "templates/body.terl.md",
    )
...
#[test]
pub(super) fn extracts_multiline_page_metadata() {
...
#[test]
pub(super) fn extracts_compact_page_metadata() {
    let metadata = extract_page_metadata(
...
#[test]
pub(super) fn extracts_escaped_page_metadata_string() {
    let metadata = extract_page_metadata(
...
#[test]
pub(super) fn rejects_non_string_page_metadata_value() {
    let diagnostics =
...
#[test]
pub(super) fn parses_markdown_template_indented_header_like_body_text() {
    let template = parse_markdown_template(
        "# Body\n\n    import docs.Version.\n",
...
#[test]
pub(super) fn rejects_invalid_interpolation_syntax() {
    let diagnostics =
...
#[test]
pub(super) fn adversarial_template_slot_rejects_oversized_unterminated_interpolation() {
...
#[test]
pub(super) fn does_not_parse_interpolation_inside_script_or_style_text() {
...
#[test]
pub(super) fn validates_css_sources() {
    validate_css(
        "body { color: red; }\n.card { display: block; }",
        "styles/page.css",
    )
...
#[test]
pub(super) fn reports_css_parse_errors() {
...
#[test]
pub(super) fn validates_html_output_without_template_slots() {
    validate_html_output("<main>{literal}</main>", "public/page.html").expect("valid html");
}

#[test]
pub(super) fn validates_html_output_with_standard_void_elements() {
...
#[test]
pub(super) fn reports_html_output_validation_errors() {
...
#[test]
pub(super) fn renders_markdown_to_valid_html_nodes() {
...
#[test]
pub(super) fn renders_terlan_markdown_document_after_header() {
...
///   and content files.
#[test]
pub(super) fn renders_plain_markdown_without_terlan_header_stripping() {
...
#[test]
pub(super) fn validates_markdown_rendered_html_with_path() {
...
#[test]
pub(super) fn validates_markdown_derived_html_output() {
    let document = parse_markdown(
