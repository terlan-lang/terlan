use super::interface_rendering::assert_trait_conformance;

use super::super::imported_type_refs::collect_syntax_selected_type_refs;
use super::super::{
...
#[test]
pub(super) fn rendered_interface_docs_have_no_trailing_whitespace() {
...
#[test]
pub(super) fn type_import_resolves_module_default_type_export() {
...
#[test]
pub(super) fn wildcard_import_resolves_public_type_and_trait_surface() {
    let provider = parse_interface_module_as_syntax_output(
        "\
...
#[test]
pub(super) fn adversarial_hir_rejects_pathological_duplicate_wildcard_imports() {
...
#[test]
pub(super) fn std_interface_loading_handles_adjacent_std_test_source() {
...
#[test]
pub(super) fn std_interface_loading_discovers_release_core_collection_contracts() {
    let nanos = SystemTime::now()
        .duration_since(UNIX_EPOCH)
        .expect("system clock before unix epoch")
        .as_nanos();
...
#[test]
pub(super) fn std_interface_loading_discovers_release_traversal_contracts() {
    let nanos = SystemTime::now()
        .duration_since(UNIX_EPOCH)
        .expect("system clock before unix epoch")
        .as_nanos();
...
pub(super) fn assert_collection_summary_signature(
...
pub(super) fn assert_trait_method_signature(
    interfaces: &HashMap<String, ModuleInterface>,
    module_name: &str,
    trait_name: &str,
    method_name: &str,
...
#[test]
pub(super) fn interface_rendering_preserves_public_trait_conformances() {
    let module = parse_module_as_syntax_output(
        "\
...
#[test]
pub(super) fn interface_rendering_qualifies_default_imported_hkt_impl_type_heads() {
    let module = parse_module_as_syntax_output(
        "\
...
#[test]
pub(super) fn interface_rendering_qualifies_selected_types_in_function_signatures() {
    let module = parse_module_as_syntax_output(
...
#[test]
pub(super) fn interface_summary_without_imports_has_no_selected_type_references() {
...
#[test]
pub(super) fn interface_rendering_preserves_trait_default_method_markers() {
    let module = parse_module_as_syntax_output(
        "\
