...
#[test]
pub(super) fn interface_rendering_preserves_function_overloads() {
    let source = "\
...
#[test]
pub(super) fn resolved_interface_rendering_preserves_source_function_overloads() {
    let source = "\
...
#[test]
pub(super) fn interface_rendering_preserves_pure_function_metadata() {
    let source = "\
...
#[test]
pub(super) fn interface_rendering_preserves_public_struct_fields() {
...
#[test]
pub(super) fn interface_rendering_preserves_generic_struct_implications() {
    let module = parse_module_as_syntax_output(
        "\
...
#[test]
pub(super) fn interface_rendering_preserves_generic_trait_impl_implications() {
    let module = parse_module_as_syntax_output(
        r#"
...
#[test]
pub(super) fn interface_rendering_preserves_public_shape_declarations() {
    let module = parse_module_as_syntax_output(
        "\
...
#[test]
pub(super) fn interface_rendering_preserves_callable_parameter_defaults() {
    let module = parse_module_as_syntax_output(
        "\
...
#[test]
pub(super) fn generated_provider_interface_with_empty_impl_parses() {
    let source = "\
...
pub(super) fn assert_trait_conformance(
...
#[test]
pub(super) fn hir_rejects_duplicate_function_shape() {
    let module = parse_module_as_syntax_output(
        "\
...
#[test]
pub(super) fn hir_accepts_canonical_syntax_contract() {
    let contract =
...
#[test]
pub(super) fn hir_rejects_broken_syntax_contract() {
    let mut contract =
...
#[test]
pub(super) fn resolve_syntax_output_records_function_symbols() {
...
#[test]
pub(super) fn resolve_syntax_output_rejects_source_export_payloads() {
...
#[test]
pub(super) fn formal_hir_syntax_output_resolves_interface_surface() {
    let syntax_module = parse_module_as_syntax_output(
        r#"
//! Public docs.
...
#[test]
pub(super) fn formal_hir_preserves_higher_kinded_trait_params() {
    let syntax_module = parse_module_as_syntax_output(
        r#"
...
///   parameters.
#[test]
pub(super) fn formal_hir_preserves_higher_kinded_function_params() {
    let syntax_module = parse_module_as_syntax_output(
        r#"
