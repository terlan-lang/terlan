...
#[test]
pub(super) fn formatter_preserves_generic_trait_impl_structural_implication() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_preserves_negative_trait_impl_declarations() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_wraps_long_function_body_sequences() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_splits_short_function_body_semicolon_sequences() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_splits_case_clause_let_sequence() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_collapses_trivial_constant_function_bodies() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_canonicalizes_only_matching_singleton_atom_aliases() {
    let output = format_source_module(
        r#"
...
///   type declarations.
#[test]
pub(super) fn formatter_wraps_long_structural_type_alias_fields() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_wraps_long_structural_type_alias_without_splitting_nested_types() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_keeps_lambda_let_binding_parseable() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_preserves_list_comprehension_guards() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_preserves_ordered_list_comprehension_generators() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_indents_multiline_let_binding_values() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_emits_and_preserves_repeated_let_keywords() {
    let source = r#"
...
#[test]
pub(super) fn formatter_preserves_case_guards_with_where() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_preserves_string_capture_patterns() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_preserves_shape_synonym_raw_declarations() {
    let output = format_source_module(
        r#"
...
"#,
    ...
    assert!(output.contains("shape NonEmpty(head, tail) = [head | tail]."));
...
#[test]
pub(super) fn formatter_preserves_binary_layout_scaffold() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_splits_long_binary_layout_scaffold() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_canonicalizes_function_head_guards_to_where() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_wraps_long_case_clause_bodies() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_wraps_long_function_signatures() {
    let output = format_source_module(
        r#"
...
///   remains parseable.
#[test]
pub(super) fn formatter_preserves_constructor_patterns() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_preserves_function_head_pattern_parameters() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_escapes_canonical_atom_literals_portably() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_source_parser_rejects_export_declarations() {
