use super::super::{format_module, format_source_module};
...
#[test]
pub(super) fn formatter_normalizes_doc_block_marker_spacing() {
...
"#,
    ...
    assert!(output.contains(" * One-line documentation.\n"));
    assert!(!output.contains(" * One-line documentation. \n"));
}
...
#[test]
pub(super) fn formatter_preserves_braced_wildcard_imports() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_preserves_declaration_annotations() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_sorts_imports_alphabetically() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_sorts_type_imports_after_regular_imports() {
    let output = format_source_module(
        r#"
...
///   manual cleanup.
#[test]
pub(super) fn formatter_groups_regular_and_type_imports_without_extra_blank_lines() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_formats_nested_case_with_compact_short_branches() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_collapses_regular_and_type_imports_by_module_prefix() {
    let output = format_source_module(
        r#"
...
///   module paths.
#[test]
pub(super) fn formatter_collapses_default_selected_sibling_imports() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_separates_multi_field_struct_fields() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_promotes_repeated_direct_type_mappings_to_type_imports() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_promotes_repeated_direct_value_calls_to_imports() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_promotes_direct_value_call_next_to_existing_selected_import() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_preserves_nested_module_calls_without_pipe_promotion() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_wraps_explicit_pipe_chains_to_one_stage_per_line() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_preserves_nested_receiver_calls_without_pipe_promotion() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_preserves_nested_selected_import_calls_without_pipe_promotion() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_does_not_promote_named_argument_calls_to_pipe_chain() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_does_not_promote_function_value_calls_to_pipe_chain() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_does_not_promote_nested_call_arguments_to_pipe_chain() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_preserves_generic_callable_signatures() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_preserves_callable_constraint_lists() {
    let source = r#"
...
#[test]
pub(super) fn formatter_preserves_structural_generic_implication() {
    let output = format_source_module(
        r#"
...
#[test]
pub(super) fn formatter_preserves_structural_generic_struct_implication() {
    let output = format_source_module(
        r#"
