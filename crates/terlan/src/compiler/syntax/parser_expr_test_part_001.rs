    use crate::terlan_syntax::parse_tree::{Decl, Expr, Pattern, StringPatternSegment, UnaryOp};
...
"#,
    ...
    fn rejects_binary_layout_unknown_descriptor() {
        let err = parse_terlan_expr("Binary[big] { flags: U8 }")
    ...
    fn assert_typed_string_capture_pattern(
        ...
        let Pattern::StringPattern(segments) = pattern else {
