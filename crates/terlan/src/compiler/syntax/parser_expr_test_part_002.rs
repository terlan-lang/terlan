    ...
    #[test]
    fn formal_atom_literal_expr_syntax_accepts_legacy_aliases() {
    ...
    #[test]
    fn formal_atom_literal_expr_syntax_rejects_dynamic_atom_values() {
    ...
    #[test]
    fn formal_list_comprehension_preserves_stacked_filters_in_source_order() {
    ...
    #[test]
    fn formal_list_comprehension_rejects_where_filter_spelling() {
    ...
    #[test]
    fn formal_keyword_exprs_reject_when_clause_guards() {
    ...
    #[test]
    fn formal_grouped_callable_expression_uses_normal_call_suffix() {
