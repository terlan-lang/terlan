...
#[test]
fn syntax_output_lowering_to_core_maps_string_constructor_to_value_to_string_intrinsic() {
    let module = parse_module_as_syntax_output(
        "\
...
#[test]
fn syntax_output_lowering_to_core_maps_primitive_constructors_to_from_string_intrinsics() {
    let module = parse_module_as_syntax_output(
        "\
...
#[test]
fn syntax_output_lowering_canonicalizes_process_import_for_yield_intrinsic() {
    let module = parse_module_as_syntax_output(
...
#[test]
fn syntax_output_lowering_canonicalizes_process_send_int_transition() {
    let module = parse_module_as_syntax_output(
...
/// intrinsic namespace.
#[test]
fn syntax_output_lowering_does_not_promote_unimported_process_name() {
    let module = parse_module_as_syntax_output(
...
#[test]
fn syntax_output_lowering_to_core_maps_string_reverse_to_intrinsic() {
    let module = parse_module_as_syntax_output(
        "\
