...
#[test]
fn syntax_output_refines_where_guards_on_formal_path() {
    let diagnostics = check_syntax_output(
        "\
...
#[test]
fn syntax_output_rejects_non_bool_case_guard() {
    let diagnostics = check_syntax_output(
        "\
...
#[test]
fn syntax_output_rejects_non_bool_function_guard() {
    let diagnostics = check_syntax_output(
        "\
...
#[test]
fn syntax_output_rejects_impure_case_guard_assignment() {
    let diagnostics = check_syntax_output(
        "\
...
#[test]
fn syntax_output_rejects_impure_case_guard_template_call() {
    let diagnostics = check_syntax_output(
        "\
...
#[test]
fn syntax_output_rejects_impure_case_guard_file_exists_call() {
    let diagnostics = check_syntax_output_with_std_interfaces(
        "\
...
#[test]
fn syntax_output_accepts_inferred_pure_helper_case_guard() {
    let diagnostics = check_syntax_output(
        "\
...
#[test]
fn syntax_output_rejects_impure_function_guard_assignment() {
    let diagnostics = check_syntax_output(
        "\
...
#[test]
fn syntax_output_accepts_inferred_pure_helper_function_guard() {
    let diagnostics = check_syntax_output(
        "\
...
#[test]
fn syntax_output_rejects_impure_function_guard_console_println_call() {
    let diagnostics = check_syntax_output_with_std_interfaces(
        "\
...
#[test]
fn syntax_output_rejects_impure_function_guard_template_call() {
    let diagnostics = check_syntax_output(
        "\
