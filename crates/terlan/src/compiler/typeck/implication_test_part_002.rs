...
#[test]
fn syntax_output_rejects_wrong_structural_implication_field_type() {
...
#[test]
fn syntax_output_rejects_dynamic_structural_implication_evidence() {
    let diagnostics = check_syntax_output(
        r#"
...
#[test]
fn syntax_output_rejects_open_map_structural_implication_evidence() {
    let diagnostics = check_syntax_output(
        r#"
...
#[test]
fn syntax_output_rejects_unproven_forwarded_structural_implication() {
    let diagnostics = check_syntax_output(
        r#"
...
#[test]
fn syntax_output_rejects_field_outside_structural_implication_scope() {
    let diagnostics = check_syntax_output(
        r#"
...
#[test]
fn syntax_output_rejects_private_structural_implication_field() {
    let diagnostics = check_syntax_output(
        r#"
...
/// interface boundary.
#[test]
fn syntax_output_accepts_imported_structural_implication() {
...
#[test]
fn syntax_output_accepts_imported_generic_struct_structural_implication() {
    let diagnostics = check_syntax_output_with_interface(
        r#"
...
#[test]
fn syntax_output_rejects_unproven_imported_generic_struct_projection() {
    let diagnostics = check_syntax_output_with_interface(
        r#"
...
#[test]
fn syntax_output_accepts_imported_receiver_method_structural_implication() {
    let diagnostics = check_syntax_output_with_interface(
        r#"
...
#[test]
fn syntax_output_rejects_unproven_imported_receiver_method_structural_implication() {
    let diagnostics = check_syntax_output_with_interface(
        r#"
