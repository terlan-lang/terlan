...
use super::super::lower_syntax_module_output_to_core;

/// Verifies impl implications retain source metadata while semantic trait
/// arguments remain ordinary type variables.
#[test]
pub(super) fn syntax_output_preserves_generic_trait_impl_structural_implication() {
...
#[test]
pub(super) fn syntax_output_accepts_generic_trait_impl_structural_implication() {
    let source = r#"
...
#[test]
pub(super) fn syntax_output_rejects_unproven_generic_trait_impl_structural_implication() {
...
#[test]
pub(super) fn syntax_output_accepts_imported_generic_trait_impl_structural_implication() {
...
#[test]
pub(super) fn syntax_output_accepts_generic_struct_structural_implication() {
    let diagnostics = check_syntax_output(
        r#"
...
#[test]
pub(super) fn syntax_output_rejects_unproven_generic_struct_structural_implication() {
    let diagnostics = check_syntax_output(
        r#"
...
#[test]
pub(super) fn syntax_output_accepts_proven_type_alias_structural_implication() {
    let diagnostics = check_syntax_output(
        r#"
...
#[test]
pub(super) fn syntax_output_accepts_forwarded_type_alias_structural_implication() {
    let diagnostics = check_syntax_output(
        r#"
...
#[test]
pub(super) fn syntax_output_rejects_unproven_imported_type_alias_structural_implication() {
    let diagnostics = check_syntax_output_with_interface(
        r#"
...
#[test]
pub(super) fn syntax_output_accepts_proven_type_alias_in_struct_field() {
    let diagnostics = check_syntax_output(
        r#"
...
#[test]
pub(super) fn syntax_output_accepts_forwarded_type_alias_in_generic_struct_field() {
    let diagnostics = check_syntax_output(
        r#"
...
#[test]
pub(super) fn syntax_output_rejects_unproven_type_alias_in_struct_field() {
    let diagnostics = check_syntax_output(
        r#"
...
#[test]
pub(super) fn syntax_output_rejects_unproven_type_alias_in_alias_body() {
    let diagnostics = check_syntax_output(
        r#"
...
#[test]
pub(super) fn syntax_output_accepts_proven_type_alias_in_constructor_signature() {
    let diagnostics = check_syntax_output(
        r#"
...
#[test]
pub(super) fn syntax_output_rejects_unproven_type_alias_in_constructor_signature() {
    let diagnostics = check_syntax_output(
        r#"
...
#[test]
pub(super) fn syntax_output_rejects_unproven_type_alias_in_constructor_return() {
    let diagnostics = check_syntax_output(
        r#"
...
#[test]
pub(super) fn syntax_output_accepts_proven_type_alias_in_template_prop() {
    let diagnostics = check_syntax_output(
        r#"
...
#[test]
pub(super) fn syntax_output_rejects_unproven_type_alias_in_template_prop() {
    let diagnostics = check_syntax_output(
        r#"
...
#[test]
pub(super) fn syntax_output_accepts_proven_type_alias_in_trait_signature() {
    let diagnostics = check_syntax_output(
        r#"
...
#[test]
pub(super) fn syntax_output_rejects_unproven_type_alias_in_trait_parameter() {
    let diagnostics = check_syntax_output(
        r#"
...
#[test]
pub(super) fn syntax_output_rejects_unproven_type_alias_in_trait_return() {
    let diagnostics = check_syntax_output(
        r#"
...
#[test]
pub(super) fn syntax_output_accepts_forwarded_type_alias_in_generic_trait_method() {
    let diagnostics = check_syntax_output(
        r#"
...
#[test]
pub(super) fn syntax_output_rejects_unproven_type_alias_in_generic_trait_method() {
    let diagnostics = check_syntax_output(
        r#"
...
#[test]
pub(super) fn syntax_output_accepts_proven_type_alias_in_explicit_impl_signature() {
    let diagnostics = check_syntax_output(
        r#"
...
#[test]
pub(super) fn syntax_output_rejects_unproven_type_alias_in_explicit_impl_parameter() {
    let diagnostics = check_syntax_output(
        r#"
...
/// alias while specializing the implemented trait signature.
#[test]
pub(super) fn syntax_output_rejects_unproven_type_alias_in_explicit_impl_return() {
    let diagnostics = check_syntax_output(
        r#"
...
#[test]
pub(super) fn syntax_output_accepts_proven_structural_implication() {
    let diagnostics = check_syntax_output(
        r#"
...
#[test]
pub(super) fn syntax_output_accepts_nested_structural_implication() {
    let diagnostics = check_syntax_output(
        r#"
...
#[test]
pub(super) fn syntax_output_accepts_forwarded_structural_implication() {
    let diagnostics = check_syntax_output(
        r#"
...
#[test]
pub(super) fn syntax_output_accepts_receiver_method_structural_implication() {
    let diagnostics = check_syntax_output(
        r#"
...
#[test]
pub(super) fn syntax_output_rejects_unproven_receiver_method_structural_implication() {
    let diagnostics = check_syntax_output(
        r#"
...
#[test]
pub(super) fn syntax_output_rejects_missing_structural_implication_field() {
    let diagnostics = check_syntax_output(
        r#"
