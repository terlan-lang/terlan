...
#[test]
pub(super) fn syntax_output_lowering_to_core_pattern_coverage_includes_list_cons_payload() {
...
///   payloads.
#[test]
pub(super) fn syntax_output_lowering_to_core_pattern_coverage_requires_covered_tuple_children() {
    let pattern = SyntaxPatternOutput {
...
///   payloads.
#[test]
pub(super) fn syntax_output_lowering_to_core_pattern_coverage_requires_covered_list_children() {
    let pattern = SyntaxPatternOutput {
...
///   payloads.
#[test]
pub(super) fn syntax_output_lowering_to_core_pattern_coverage_requires_covered_constructor_args() {
    let pattern = SyntaxPatternOutput {
...
#[test]
pub(super) fn syntax_output_lowering_to_core_pattern_coverage_requires_map_field_payload() {
    let pattern = SyntaxPatternOutput {
...
#[test]
pub(super) fn syntax_output_lowering_to_core_pattern_coverage_includes_compat_wildcards() {
...
#[test]
pub(super) fn syntax_output_lowering_to_core_records_local_call_core_expr() {
...
#[test]
pub(super) fn syntax_output_lowering_to_core_records_function_value_call_core_expr() {
    let module = parse_module_as_syntax_output(
        "\
...
#[test]
pub(super) fn syntax_output_typechecks_pipe_into_function_value_call() {
...
#[test]
pub(super) fn syntax_output_lowering_to_core_records_compound_core_type_payloads() {
    assert_eq!(
...
#[test]
pub(super) fn syntax_output_lowering_to_core_records_type_decl_core_body_payloads() {
    let module = parse_module_as_syntax_output(
        "\
...
#[test]
pub(super) fn syntax_output_lowering_to_core_counts_summary_only_type_decl_payloads() {
    let module = parse_module_as_syntax_output(
        "\
...
#[test]
pub(super) fn syntax_output_lowering_to_core_records_constructor_call_candidate() {
