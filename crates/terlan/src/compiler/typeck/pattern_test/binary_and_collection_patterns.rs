...
#[test]
pub(super) fn syntax_output_accepts_typed_binary_layout_case_pattern() {
...
#[test]
pub(super) fn syntax_output_accepts_typed_binary_layout_function_head_pattern() {
    let diagnostics = check_syntax_output(
        "\
...
#[test]
pub(super) fn syntax_output_generic_comparator_callback_preserves_declared_return_type() {
    let diagnostics = check_syntax_output(
        "\
...
#[test]
pub(super) fn syntax_output_list_cons_patterns_are_valid_on_formal_path() {
    let diagnostics = check_syntax_output(
        "\
...
/// Verifies structural cases are not widened to unrelated generic unions.
///
/// Inputs:
/// - A visible three-parameter union alias whose variants are unconstrained.
/// - Exhaustive list and ordinary tuple cases over concrete structural types.
///
/// Output:
/// - Test passes without phantom `T0`, `T1`, or `T2` exhaustiveness errors.
///
/// Transformation:
/// - Keeps constructor-union recovery available for `Some`/`None` while
///   preventing generic alias probing from changing list and tuple scrutinees.
#[test]
pub(super) fn syntax_output_structural_cases_ignore_unrelated_generic_union_aliases() {
    let diagnostics = check_syntax_output(
        "\
module structural_case_generic_union_isolation.\n\
\n\
pub type Unrelated[T0, T1, T2] = T0 | T1 | T2.\n\
\n\
pub list_length(input: List[Int]): Int ->\n\
    case input {\n\
        [] -> 0;\n\
        [_head | tail] -> 1 + list_length(tail)\n\
    }.\n\
\n\
pub tuple_sum(input: {Int, Int}): Int ->\n\
    case input {\n\
...
#[test]
pub(super) fn syntax_output_binds_case_constructor_patterns_on_formal_path() {
    let diagnostics = check_syntax_output(
        "\
...
#[test]
pub(super) fn syntax_output_imported_generic_constructor_pattern_binds_payload_type() {
...
#[test]
pub(super) fn syntax_output_rejects_non_exhaustive_option_case() {
    let diagnostics = check_syntax_output_with_std_interfaces(
        "\
...
#[test]
pub(super) fn syntax_output_option_pattern_payload_survives_local_call_boundary() {
    let diagnostics = check_syntax_output_with_std_interfaces(
        "\
...
#[test]
pub(super) fn syntax_output_string_capture_pattern_binds_explicit_type() {
    let diagnostics = check_syntax_output(
        "\
...
#[test]
pub(super) fn syntax_output_string_capture_pattern_defaults_untyped_capture_to_string() {
    let diagnostics = check_syntax_output(
        "\
...
///   runtime matching.
#[test]
pub(super) fn syntax_output_string_capture_pattern_rejects_duplicate_capture_names() {
    let diagnostics = check_syntax_output(
        "\
...
#[test]
pub(super) fn syntax_output_string_capture_pattern_rejects_invalid_capture_annotation() {
    let diagnostics = check_syntax_output(
        "\
...
#[test]
pub(super) fn syntax_output_inline_option_constructor_case_scrutinee_typechecks() {
    let diagnostics = check_syntax_output_with_std_interfaces(
        "\
...
#[test]
pub(super) fn syntax_output_inline_result_constructor_case_scrutinee_typechecks() {
    let diagnostics = check_syntax_output_with_std_interfaces(
        "\
...
///   return type.
#[test]
pub(super) fn syntax_output_result_constructor_pattern_binds_payload_in_generic_helper() {
    let diagnostics = check_syntax_output_with_std_interfaces(
        "\
...
#[test]
pub(super) fn syntax_output_local_result_constructor_pattern_binds_payload_in_generic_helper() {
    let diagnostics = check_syntax_output(
        "\
...
///   runtime coercion.
#[test]
pub(super) fn syntax_output_function_head_tuple_pattern_refines_local_bindings() {
    let diagnostics = check_syntax_output(
        "\
...
#[test]
pub(super) fn syntax_output_recursive_vector_binary_search_typechecks() {
    let diagnostics = check_syntax_output_with_std_interfaces(
        "\
...
#[test]
pub(super) fn syntax_output_generic_lower_bound_with_comparator_typechecks() {
    let diagnostics = check_syntax_output_with_std_interfaces(
        "\
...
#[test]
pub(super) fn syntax_output_generic_is_sorted_with_comparator_typechecks() {
    let diagnostics = check_syntax_output_with_std_interfaces(
        "\
...
#[test]
pub(super) fn syntax_output_generic_selection_min_index_typechecks() {
    let diagnostics = check_syntax_output_with_std_interfaces(
        "\
...
#[test]
pub(super) fn syntax_output_generic_compare_and_swap_typechecks() {
    let diagnostics = check_syntax_output_with_std_interfaces(
        "\
