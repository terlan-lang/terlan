...
#[test]
pub(super) fn syntax_output_resolves_local_hkt_trait_impl_for_imported_constructor() {
...
#[test]
pub(super) fn syntax_output_resolves_hkt_monad_trait_hierarchy_on_formal_path() {
...
#[test]
pub(super) fn syntax_output_rejects_explicit_trait_impl_method_call_without_impl_on_formal_path() {
    let diagnostics = check_syntax_output(
        "\
...
#[test]
pub(super) fn syntax_output_implements_trait_methods_are_synthesized_for_calls() {
    let diagnostics = check_syntax_output(
        "\
...
#[test]
pub(super) fn syntax_output_accepts_short_imported_types_in_qualified_trait_impl() {
    let interface_source = "\
module provider_box.\n\
\n\
...
#[test]
pub(super) fn syntax_output_accepts_resolved_negative_trait_impl() {
    let diagnostics = check_syntax_output(
        "\
...
#[test]
pub(super) fn syntax_output_accepts_nested_negative_trait_impl_target() {
    let diagnostics = check_syntax_output(
...
#[test]
pub(super) fn syntax_output_rejects_unknown_negative_trait_impl() {
    let diagnostics = check_syntax_output(
...
#[test]
pub(super) fn syntax_output_rejects_unknown_negative_trait_impl_target() {
    let diagnostics = check_syntax_output(
...
#[test]
pub(super) fn syntax_output_accepts_imported_negative_trait_impl_target() {
    let diagnostics = check_syntax_output_with_interface(
...
#[test]
pub(super) fn syntax_output_rejects_positive_impl_conflicting_with_imported_negative_impl() {
    let diagnostics = check_syntax_output_with_interface(
...
#[test]
pub(super) fn syntax_output_accepts_positive_impl_when_imported_negative_impl_is_private() {
    let diagnostics = check_syntax_output_with_interface(
...
#[test]
pub(super) fn syntax_output_rejects_negative_impl_conflicting_with_imported_positive_impl() {
    let diagnostics = check_syntax_output_with_interface(
...
#[test]
pub(super) fn syntax_output_rejects_method_dispatch_from_imported_negative_impl() {
    let diagnostics = check_syntax_output_with_interface(
...
#[test]
pub(super) fn syntax_output_rejects_non_unary_negative_trait_impl() {
    let diagnostics = check_syntax_output(
...
#[test]
pub(super) fn syntax_output_rejects_duplicate_negative_trait_impl() {
    let diagnostics = check_syntax_output(
...
#[test]
pub(super) fn syntax_output_rejects_positive_negative_trait_impl_conflict() {
    let diagnostics = check_syntax_output(
