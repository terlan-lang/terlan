...
///   consume.
#[test]
pub(super) fn syntax_output_receiver_dispatch_signatures_preserve_mutable_marker() {
...
#[test]
pub(super) fn syntax_output_accepts_std_set_int_receiver_methods() {
...
#[test]
pub(super) fn syntax_output_accepts_std_map_from_entries_receiver_methods() {
    let diagnostics = check_syntax_output_with_std_interfaces(
        "\
...
///   `Result.with_default`.
#[test]
pub(super) fn syntax_output_accepts_imported_receiver_generic_despite_global_type_name_collision() {
    let diagnostics = check_syntax_output_with_std_interfaces(
        "\
...
#[test]
pub(super) fn syntax_output_rejects_receiver_methods_for_imported_owner_on_formal_path() {
