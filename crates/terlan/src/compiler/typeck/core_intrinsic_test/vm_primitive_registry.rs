...
///   CoreIR.
#[test]
pub(super) fn core_primitive_intrinsic_resolves_vm_library_primitives() {
    let cases = [
        (
            "std.vm.Bytes",
            "from_list",
...
#[test]
pub(super) fn core_primitive_intrinsic_resolves_persistent_map_take() {
...
#[test]
pub(super) fn vm_library_primitive_registry_keys_are_stable() {
...
#[test]
pub(super) fn vm_library_primitive_return_types_are_registered() {
    assert_eq!(
...
#[test]
pub(super) fn core_primitive_intrinsic_rejects_wrong_vm_primitive_arities() {
    assert_eq!(
...
#[test]
pub(super) fn vm_bitstring_intrinsics_have_closed_ids_and_return_types() {
...
#[test]
pub(super) fn syntax_output_lowering_to_core_maps_selected_float_alias_to_intrinsic() {
