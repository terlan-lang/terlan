...
#[test]
fn imported_trait_type_refs_qualify_nominal_types_but_preserve_primitives() {
...
#[test]
fn syntax_output_accepts_std_vm_gen_server_without_default_terminate() {
...
#[test]
fn syntax_output_resolves_explicit_trait_impl_receiver_calls_on_formal_path() {
    let diagnostics = check_syntax_output(
        "\
