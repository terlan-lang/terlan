...
#[test]
fn syntax_output_lowering_to_core_preserves_receiver_method_clauses() {
    let module = parse_module_as_syntax_output(
        "\
...
#[test]
fn syntax_output_lowering_to_core_preserves_compiler_native_operations() {
    let module = parse_module_as_syntax_output(
        "\
...
#[test]
fn syntax_output_lowering_to_core_pattern_coverage_includes_string_capture_payload() {
    let pattern = SyntaxPatternOutput {
