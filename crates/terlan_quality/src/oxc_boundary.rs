...
const FORBIDDEN_SOURCE_ROOTS: &[&str] = &[
    "crates/terlan_syntax",
    "crates/terlan_hir",
    "crates/terlan_typeck",
    "crates/terlan_erlang",
    "crates/terlan_html",
    "crates/terlan_lsp",
    "crates/terlan_safenative",
    "crates/terlan_cli/src/validation",
];

/// Cargo manifests allowed to depend on Oxc crates.
const APPROVED_OXC_DEP_CRATES: &[&str] = &["crates/terlan_cli/Cargo.toml"];
