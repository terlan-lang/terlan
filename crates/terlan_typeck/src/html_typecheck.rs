...
/// Converts a PascalCase component name to snake_case.
///
/// Inputs:
/// - `name`: component or parameter name.
///
/// Output:
/// - Snake-case equivalent.
///
/// Transformation:
/// - Inserts underscores at lower/digit to uppercase boundaries and lowercases
