//! Shared validation ownership and input binding used by the CLI and bootstrap.
#![forbid(unsafe_code)]
...
/// Runs the validation CLI without duplicating its implementation in the binary.
