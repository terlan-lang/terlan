...
fn syntax_module(source: &str) -> terlan_syntax::SyntaxModuleOutput {
...
fn page_template(source: &str) -> BTreeMap<String, terlan_html::HtmlTemplate> {
    BTreeMap::from([(
        "Page".to_string(),
        terlan_html::parse_template(source, Path::new("page.terl.html"))
