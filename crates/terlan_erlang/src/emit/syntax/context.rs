...
pub(in crate::emit) struct SyntaxLowerCtx {
    ...
    pub(super) markdown_imports: BTreeMap<String, terlan_html::MarkdownDocument>,
...
///   declaration order.
#[derive(Debug, Clone)]
pub(in crate::emit) struct SyntaxReceiverMethodTarget {
    pub(in crate::emit) mutable: bool,
...
impl SyntaxLowerCtx {
    ...
    pub(in crate::emit) fn receiver_method_target(
        &self,
        receiver_type: &str,
        method: &str,
        arity: usize,
