...
pub(super) fn lower_core_primitive_intrinsic_to_erlang(
    ...
    match intrinsic {
        ...
        CorePrimitiveIntrinsic::MapFromEntries => lower_core_map_from_entries(args),
        ...
        CorePrimitiveIntrinsic::SetFromList => lower_core_set_from_list(args),
        ...
        CorePrimitiveIntrinsic::BeamBytesFromList => lower_beam_bytes_from_list(args),
        CorePrimitiveIntrinsic::BeamBytesToList => lower_beam_bytes_to_list(args),
        CorePrimitiveIntrinsic::BeamBytesLength => lower_beam_bytes_length(args),
        CorePrimitiveIntrinsic::BeamBytesConcat => lower_beam_bytes_concat(args),
        CorePrimitiveIntrinsic::BeamTimeoutMilliseconds => lower_beam_timeout_milliseconds(args),
        CorePrimitiveIntrinsic::BeamTimeoutForever => lower_beam_timeout_forever(args),
        CorePrimitiveIntrinsic::BeamTcpConnect => lower_beam_tcp_connect(args),
        CorePrimitiveIntrinsic::BeamTcpSend => lower_beam_tcp_send(args),
        CorePrimitiveIntrinsic::BeamTcpReceive => lower_beam_tcp_receive(args),
        CorePrimitiveIntrinsic::BeamTcpClose => lower_beam_tcp_close(args),
        CorePrimitiveIntrinsic::BeamPortOpen => lower_beam_port_open(args),
